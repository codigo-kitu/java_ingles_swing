...
public class Funciones2 {	
	...
	public static Timestamp GetDateTime(ResultSet resultSet, String sNombreColumna,Connexion connexion) throws SQLException, ParseException {
		Date fechaResultado=new Date();
		
		if(!connexion.getDbType().equals(ParameterDbType.SQLITE)) {
			fechaResultado=new Date(resultSet.getDate(sNombreColumna).getTime());
			
		} else {
			String sDate1=resultSet.getString(sNombreColumna);  
			fechaResultado=new SimpleDateFormat("yyy-MM-dd").parse(sDate1);  
		}
		
		return new Timestamp(fechaResultado.getTime());
	}
	
	public static Date GetDate(ResultSet resultSet, String sNombreColumna,Connexion connexion) throws SQLException, ParseException {
		Date fechaResultado=new Date();
	...
	public static Date GetDate(ResultSet resultSet, String sNombreColumna) throws SQLException, ParseException {
		Date fechaResultado=new Date();
	...
	public static Integer Redondear(Integer dValor,Integer iNumeroDecimales) {
		Integer dResultado=0;
	...
	public static Long Redondear(Long dValor,Integer iNumeroDecimales) {
		Long dResultado=0L;
	...
	*/
	...
	public static void GenerarArchivoHtml(String sPath,String sHtml) {
		//BufferedWriter bufferedWriter = null;
		
		try {
						
			//file = fopen("webroot/files/ecuacioncontablesimple/ecuacioncontablesimple_todo_"+id_semestre+".html", "w") or die("Unable to open file!");
			
			//fwrite(file, sHtmlResumen);
