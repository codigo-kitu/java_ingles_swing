...
public class ConstantesCommon {
	public static /*EntityManagerFactory*/ Object JPAENTITYMANAGERFACTORY= null;//Persistence.createEntityManagerFactory("PersistenceUnitSeguridad"/*ConstantesCommon.SJPAPERSISTENCEUNITNAME*/);
