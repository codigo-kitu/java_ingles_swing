...
public class OrderBy {
	...
	public static OrderBy NewOrderBy(Boolean isSelected, String sNombre,String sNombreDB, Boolean esDesc,String sPrefijoSql) {
		//super();
		
		OrderBy orderBy=new OrderBy();
		
		orderBy.isSelected = isSelected;
		orderBy.sNombre = sNombre;
		orderBy.sNombreDB = sNombreDB;
		orderBy.esDesc = esDesc;
		orderBy.sPrefijoSql=sPrefijoSql;
