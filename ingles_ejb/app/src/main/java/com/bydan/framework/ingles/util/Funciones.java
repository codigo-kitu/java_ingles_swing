...
public class Funciones {	
	...
	*/
	...
	public static void manageException(Object logger,Exception e) throws Exception {
		try {
			//logger.error("Exception:" + e.getMessage());
	...
	public static void manageException(Logger logger,StringBuilder stringBuilder,String sPath,String sAmbito,String sNombreProceso) throws Exception {
		//org.apache.log4j.Logger
		try {
	...
	public static void logShowExceptionMessages(Logger logger,Exception e) throws Exception {
		//org.apache.log4j.Logger
		try {
