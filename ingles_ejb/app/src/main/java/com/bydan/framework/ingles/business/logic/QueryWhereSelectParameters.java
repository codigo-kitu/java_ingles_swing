package com.bydan.framework.ingles.business.logic;
...
public class QueryWhereSelectParameters implements Serializable {
	...
	public String getQueryWhereSelectParameters() {
		...
		if(!isAll){
			for(ParameterSelectionGeneral parameterSelectionGeneral:parametersSelectionGeneral) {
				...
				}  else if(dbType.equals(ParameterDbType.SQLITE)) {				
					query+=addSQLITEParameterQuery(parameterSelectionGeneral);
		...
		if(!isAll){
			for(ParameterSelectionGeneral parameterSelectionGeneral:parametersSelectionGeneral) {
				...
				if(dbType.equals(ParameterDbType.MYSQL)) {				
					...
					query+=addSQLITEParameterQueryJDBC(parameterSelectionGeneral);
	...
	public String addSQLITEParameterQuery(ParameterSelectionGeneral parameterSelectionGeneral) {
...
*/
	...
	public String addSQLITEParameterQueryJDBC(ParameterSelectionGeneral parameterSelectionGeneral) {
