...
public interface Grupo_dataI { //Grupo_dataAdditional,DataAccessHelper<Grupo>
	...
	/* public static ParametersMaintenance buildParametersMaintenance(ParameterDbType newDbType,ParametersType parametersType,Grupo grupo); */
