...
public interface Pais_dataI { //Pais_dataAdditional,DataAccessHelper<Pais>
	...
	/* public static ParametersMaintenance buildParametersMaintenance(ParameterDbType newDbType,ParametersType parametersType,Pais pais); */
