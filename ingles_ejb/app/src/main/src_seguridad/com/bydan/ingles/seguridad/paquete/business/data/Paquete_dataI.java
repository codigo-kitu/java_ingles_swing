...
public interface Paquete_dataI { //Paquete_dataAdditional,DataAccessHelper<Paquete>
	...
	/* public static ParametersMaintenance buildParametersMaintenance(ParameterDbType newDbType,ParametersType parametersType,Paquete paquete); */
