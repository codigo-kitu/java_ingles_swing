...
public class Grammar_form_window extends JInternalFrameBase {	
	...
	//public Grammar_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposGrammar=0;
	//protected Integer iYPanelCamposGrammar=0;
	
	//protected Integer iXPanelCamposOcultosGrammar=0;
	//protected Integer iYPanelCamposOcultosGrammar=0;
	...
	public Grammar_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleGrammar=new JMenuBar();
				this.jTtoolBarDetalleGrammar=new JToolBar();
				*/
	  		}
	...
	public Grammar_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Grammar_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Grammar_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grammar_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grammar_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesGrammar) {
		//this.jComboBoxTiposAccionesGrammar = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Grammar_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Grammar_util.LABEL_CODIGO+" : *","Codigo");
		FuncionesSwing.setLabelSize(this.lbl_codigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_codigo.setToolTipText(Grammar_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.grammar_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Grammar_util.LABEL_NOMBRE+" : *","Nombre");
		FuncionesSwing.setLabelSize(this.lbl_nombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_nombre.setToolTipText(Grammar_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+Grammar_util.LABEL_DESCRIPCION+" :","Descripcion");
		FuncionesSwing.setLabelSize(this.lbl_descripcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_descripcion.setToolTipText(Grammar_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_nivel,""+Grammar_util.LABEL_IDNIVEL+" : *","Nivel");
		FuncionesSwing.setLabelSize(this.lbl_id_nivel,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_nivel.setToolTipText(Grammar_util.LABEL_IDNIVEL);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelGrammar"));
		...
		cmb_id_nivel.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelGrammarUpdate"));



					
		this.lbl_id_tipo_grammar = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar,""+Grammar_util.LABEL_IDTIPOGRAMMAR+" : *","Tipo Grammar");
		FuncionesSwing.setLabelSize(this.lbl_id_tipo_grammar,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_tipo_grammar.setToolTipText(Grammar_util.LABEL_IDTIPOGRAMMAR);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_tipo_grammar.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammarGrammar"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammarGrammarUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Grammar_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Grammar DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.grammar_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.grammar_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Grammar_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Grammar_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Grammar_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesGrammar = new JComboBoxMe();
				//this.jComboBoxTiposAccionesGrammar.setText("Accion");
		//this.jComboBoxTiposAccionesGrammar.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesGrammar,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesGrammar, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(GrammarJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Grammar_controlJInternalFrameAdditional();//JInternalFrameBase("Grammar DATOS");
	        ...
	        //this.setTitle("[FOR] - Grammar DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Grammar Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Grammar_model grammarModel=new Grammar_model(this);
			
			//SI USARA CLASE INTERNA
			//GrammarModel.GrammarFocusTraversalPolicy grammarFocusTraversalPolicy = grammarModel.new GrammarFocusTraversalPolicy(this);
			
			//grammarFocusTraversalPolicy.setgrammarJInternalFrame(this);
			
			this.setFocusTraversalPolicy(grammarModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& grammar_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesGrammar.setVisible(false);
	...
	public void cargarSessionConBeanSwingJFrameGrammarDetalle(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.grammardetalle_session.getEsGuardarRelacionado()) {
				...
				GrammarDetalle_window.S_TIPO_TAMANIO_GENERAL=Grammar_window.S_TIPO_TAMANIO_GENERAL;
				GrammarDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=Grammar_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarGrammarDetalleBeanSwingJFrame(List<Grammar> grammars,Grammar grammar,GrammarDetalle_control_window grammardetalleBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					grammardetalleBeanSwingJFrame.getGrammarDetalleLogic().setConnexion(this.grammarLogic.getConnexion());

					grammardetalleBeanSwingJFrame.setgrammarsFK(grammars);
					grammardetalleBeanSwingJFrame.setgrammarFK(grammar);
					grammardetalleBeanSwingJFrame.grammardetalle_session.setisBusquedaDesdeFKSesionGrammar(true);
					grammardetalleBeanSwingJFrame.grammardetalle_session.setlidGrammarActual(grammar.getId());
					...
					grammardetalleBeanSwingJFrame.setVisibilidadBusquedasParaGrammar(true);
					grammardetalleBeanSwingJFrame.setid_grammarFK_IdGrammar(grammar.getId());

					if(!this.conCargarFormDetalle) {
						grammardetalleBeanSwingJFrame.inicializarFormDetalle();
					}

					grammardetalleBeanSwingJFrame.setSelectedItemCombosFrameGrammarFK(grammar,1,false,true,true);
					grammardetalleBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					grammardetalleBeanSwingJFrame.procesarBusqueda("FK_IdGrammar");
					grammardetalleBeanSwingJFrame.setsAccionBusqueda("FK_IdGrammar");
	...
	*/
	...
	public interface Grammar_form_windowI {	
