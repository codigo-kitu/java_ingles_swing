...
*/
package com.bydan.ingles.gramatica.expresiondetalle.presentation.swing.jinternalframes.window;
...
public class ExpresionDetalle_window extends JInternalFrameBase {	
	...
	public ExpresionDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public Expresion_control_window expresionBeanSwingJFrame;
	public String sFinalQueryGeneral_expresion="";
	...
	public JPanel pnl_FK_IdExpresion;
	public JButton btn_FK_IdExpresion;
	public JPanel pnl_FK_IdTipoGrammarDetalle;
	public JButton btn_FK_IdTipoGrammarDetalle;
	
	public JPanel pnlid_expresionFK_IdExpresion;
	public JLabel lbl_id_expresionFK_IdExpresion;
	public JComboBoxMe cmb_id_expresionFK_IdExpresion;
	public JButton btn_id_expresionFK_IdExpresion= new JButton();
	public JButton btn_id_expresionFK_IdExpresion_Update= new JButton();
	public JButton btn_id_expresionFK_IdExpresion_Busqueda= new JButton();
	...
	*/
	...
	public ExpresionDetalle_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ExpresionDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ExpresionDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<ExpresionDetalle> getexpresiondetallesAux() {
		return this.expresiondetallesAux;
	}

	public void setexpresiondetallesAux(List<ExpresionDetalle> expresiondetallesAux) {
		this.expresiondetallesAux = expresiondetallesAux;
	}
	
	public List<ExpresionDetalle> getexpresiondetallesEliminados() {
		return this.expresiondetallesEliminados;
	}

	public void setExpresionDetallesEliminados(List<ExpresionDetalle> expresiondetallesEliminados) {
		this.expresiondetallesEliminados = expresiondetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoExpresionDetalle) {
	//	this.jCheckBoxConGraficoDinamicoExpresionDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoExpresionDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.expresiondetalle_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=ExpresionDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=ExpresionDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		ExpresionDetalle_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		ExpresionDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		ExpresionDetalle_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Expresion Detalle MANTENIMIENTO"));
		...
		ExpresionDetalle_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdExpresion=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdExpresion.setToolTipText("Buscar Por Expresion ");
		this.btn_FK_IdExpresion= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdExpresion,"buscar_button","Buscar","Buscar Por Expresion ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdExpresion, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdExpresion, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_expresionFK_IdExpresion = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_expresionFK_IdExpresion,"Expresion :","Expresion");
		FuncionesSwing.setLabelSize(lbl_id_expresionFK_IdExpresion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_expresionFK_IdExpresion,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_expresionFK_IdExpresion,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_expresionFK_IdExpresion= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_expresionFK_IdExpresion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_expresionFK_IdExpresion,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new ExpresionDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Expresion Detalle DATOS");
			//_form
			this.jFrameDetalleForm = new ExpresionDetalle_form_window(jDesktopPane,this.expresiondetalle_session.getConGuardarRelaciones(),this.expresiondetalle_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new ExpresionDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//ExpresionDetalle
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipExpresionDetalle="";
		sToolTipExpresionDetalle=ExpresionDetalle_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipExpresionDetalle+="(Gramatica.ExpresionDetalle)";
		}
		
		if(!this.expresiondetalle_session.getEsGuardarRelacionado()) {
			sToolTipExpresionDetalle+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipExpresionDetalle);
		...
		this.sPath=" <---> Acceso: Expresion Detalle";
		
		if(!this.expresiondetalle_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Expresion Detalles" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByExpresionDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByExpresionDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"ExpresionDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.expresiondetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"ExpresionDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"ExpresionDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+ExpresionDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+ExpresionDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),ExpresionDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ExpresionDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),ExpresionDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ExpresionDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),ExpresionDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ExpresionDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosExpresionDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosExpresionDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoExpresionDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdExpresionExpresionDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdExpresionExpresionDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdExpresionExpresionDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdExpresionExpresionDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdExpresionExpresionDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdExpresion.setLayout(gridaBagLayoutFK_IdExpresionExpresionDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdExpresion.add(lbl_id_expresionFK_IdExpresion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdExpresion.add(cmb_id_expresionFK_IdExpresion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdExpresion.add(btn_FK_IdExpresion, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Expresion ", pnl_FK_IdExpresion);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammarDetalle.setLayout(gridaBagLayoutFK_IdTipoGrammarDetalleExpresionDetalle);
		...
		jTabbedPaneBusquedas.addTab("2.-Por Tipo Grammar Detalle ", pnl_FK_IdTipoGrammarDetalle);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.expresiondetalle_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.expresiondetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//ExpresionDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.expresiondetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > ExpresionDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=ExpresionDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < ExpresionDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=ExpresionDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > ExpresionDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=ExpresionDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < ExpresionDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=ExpresionDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<ExpresionDetalle> TraerBeans(List<ExpresionDetalle> expresiondetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(ExpresionDetalle expresiondetalle:expresiondetalles) {
					
				if(!(ExpresionDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || ExpresionDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					expresiondetalle.setsDetalleGeneralEntityReporte(ExpresionDetalle_util.getExpresionDetalleDescripcion(expresiondetalle));
					...
					//expresiondetalle.setsDetalleGeneralEntityReporte(expresiondetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//expresiondetallebeans.add(expresiondetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface ExpresionDetalle_windowI {	
