...
public class VocabularioDetalle_form_window extends JInternalFrameBase {	
	...
	//public VocabularioDetalle_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposVocabularioDetalle=0;
	//protected Integer iYPanelCamposVocabularioDetalle=0;
	
	//protected Integer iXPanelCamposOcultosVocabularioDetalle=0;
	//protected Integer iYPanelCamposOcultosVocabularioDetalle=0;
	...
	public JPanel pnl_id_vocabulario;
	public JLabel lbl_id_vocabulario;
	public JComboBoxMe cmb_id_vocabulario;
	public JButton btn_id_vocabulario= new JButton();
	public JButton btn_id_vocabulario_Update= new JButton();
	public JButton btn_id_vocabulario_Busqueda= new JButton();
	...
	public VocabularioDetalle_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleVocabularioDetalle=new JMenuBar();
				this.jTtoolBarDetalleVocabularioDetalle=new JToolBar();
				*/
	  		}
	...
	public VocabularioDetalle_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public VocabularioDetalle_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public VocabularioDetalle_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VocabularioDetalle_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VocabularioDetalle_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesVocabularioDetalle) {
		//this.jComboBoxTiposAccionesVocabularioDetalle = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(VocabularioDetalle_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_idea,""+VocabularioDetalle_util.LABEL_IDEA+" : *","Idea");
		...
		this.pnl_idea.setToolTipText(VocabularioDetalle_util.LABEL_IDEA);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.vocabulariodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_idea_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+VocabularioDetalle_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(VocabularioDetalle_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+VocabularioDetalle_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(VocabularioDetalle_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+VocabularioDetalle_util.LABEL_DESCRIPCION+" :","Descripcion");
		...
		this.pnl_descripcion.setToolTipText(VocabularioDetalle_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		this.lbl_id_vocabulario = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_vocabulario,""+VocabularioDetalle_util.LABEL_IDVOCABULARIO+" : *","Vocabulario");
		FuncionesSwing.setLabelSize(this.lbl_id_vocabulario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_vocabulario,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_vocabulario,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_vocabulario=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_vocabulario.setToolTipText(VocabularioDetalle_util.LABEL_IDVOCABULARIO);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_vocabulario.setLayout(this.gridaBagLayout);


		cmb_id_vocabulario= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_vocabulario,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_vocabulario,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_vocabulario= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_vocabulario,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_vocabulario.setText("Buscar");
		this.btn_id_vocabulario.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_vocabulario.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_vocabulario,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_vocabulario.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_vocabulario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_vocabularioVocabularioDetalle"));

		this.btn_id_vocabulario_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_vocabulario_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_vocabulario_Busqueda.setText("U");
		this.btn_id_vocabulario_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_vocabulario_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_vocabulario_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_vocabulario.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_vocabulario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_vocabulario_Busqueda"));

		if(this.vocabulariodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_vocabulario_Busqueda.setVisible(false);		}

		this.btn_id_vocabulario_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_vocabulario_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_vocabulario_Update.setText("U");
		this.btn_id_vocabulario_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_vocabulario_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_vocabulario_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_vocabulario.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_vocabulario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_vocabularioVocabularioDetalleUpdate"));



					
		this.lbl_id_tipo_grammar_detalle = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar_detalle,""+VocabularioDetalle_util.LABEL_IDTIPOGRAMMARDETALLE+" : *","Tipo Grammar Detalle");
		...
		this.pnl_id_tipo_grammar_detalle.setToolTipText(VocabularioDetalle_util.LABEL_IDTIPOGRAMMARDETALLE);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleVocabularioDetalle"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar_detalle.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleVocabularioDetalleUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new VocabularioDetalle_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Vocabulario Detalle DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.vocabulariodetalle_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.vocabulariodetalle_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=VocabularioDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=VocabularioDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=VocabularioDetalle_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesVocabularioDetalle = new JComboBoxMe();
				//this.jComboBoxTiposAccionesVocabularioDetalle.setText("Accion");
		//this.jComboBoxTiposAccionesVocabularioDetalle.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesVocabularioDetalle,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesVocabularioDetalle, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_vocabulario.add(lbl_id_vocabulario, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.pnl_id_vocabulario.add(btn_id_vocabulario_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.pnl_id_vocabulario.add(btn_id_vocabulario_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_vocabulario.add(cmb_id_vocabulario, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_vocabulario, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(VocabularioDetalleJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new VocabularioDetalle_controlJInternalFrameAdditional();//JInternalFrameBase("Vocabulario Detalle DATOS");
	        ...
	        //this.setTitle("[FOR] - Vocabulario Detalle DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Vocabulario Detalle Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			VocabularioDetalle_model vocabulariodetalleModel=new VocabularioDetalle_model(this);
			
			//SI USARA CLASE INTERNA
			//VocabularioDetalleModel.VocabularioDetalleFocusTraversalPolicy vocabulariodetalleFocusTraversalPolicy = vocabulariodetalleModel.new VocabularioDetalleFocusTraversalPolicy(this);
			
			//vocabulariodetalleFocusTraversalPolicy.setvocabulariodetalleJInternalFrame(this);
			
			this.setFocusTraversalPolicy(vocabulariodetalleModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& vocabulariodetalle_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesVocabularioDetalle.setVisible(false);
	...
	*/
	...
	public interface VocabularioDetalle_form_windowI {	
