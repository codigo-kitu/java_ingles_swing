...
*/
package com.bydan.ingles.gramatica.paisgeneral.presentation.web.jsf.sessionbean;
...
public class PaisGeneral_session  extends GeneralEntitySessionBean {
	...
	public PaisGeneral_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("PaisGeneral:Valor nulo no permitido en columna id");
					}
				}
