...
public class TipoGrammarDetalle_window extends JInternalFrameBase {	
	...
	public TipoGrammarDetalle_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public TipoGrammarDetalle_window() throws Exception {
	...
	public TipoGrammarDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoGrammarDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoGrammarDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoGrammarDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<TipoGrammarDetalle> gettipogrammardetalles() {
		return this.tipogrammardetalles;
	}

	public void settipogrammardetalles(List<TipoGrammarDetalle> tipogrammardetalles) {
		this.tipogrammardetalles = tipogrammardetalles;
	}
	
	public List<TipoGrammarDetalle> gettipogrammardetallesAux() {
		return this.tipogrammardetallesAux;
	}

	public void settipogrammardetallesAux(List<TipoGrammarDetalle> tipogrammardetallesAux) {
		this.tipogrammardetallesAux = tipogrammardetallesAux;
	}
	
	public List<TipoGrammarDetalle> gettipogrammardetallesEliminados() {
		return this.tipogrammardetallesEliminados;
	}

	public void setTipoGrammarDetallesEliminados(List<TipoGrammarDetalle> tipogrammardetallesEliminados) {
		this.tipogrammardetallesEliminados = tipogrammardetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoTipoGrammarDetalle) {
	//	this.jCheckBoxConGraficoDinamicoTipoGrammarDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoTipoGrammarDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=TipoGrammarDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=TipoGrammarDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new TipoGrammarDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Tipo Grammar Detalle DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new TipoGrammarDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//TipoGrammarDetalle
		...
		this.tableDatos.setToolTipText(sToolTipTipoGrammarDetalle);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipoGrammarDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipoGrammarDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"TipoGrammarDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.tipogrammardetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"TipoGrammarDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"TipoGrammarDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+TipoGrammarDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+TipoGrammarDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosTipoGrammarDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosTipoGrammarDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoTipoGrammarDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle= new GridBagLayout();
		gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombreTipoGrammarDetalle);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.tipogrammardetalle_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.tipogrammardetalle_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//TipoGrammarDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.tipogrammardetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > TipoGrammarDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=TipoGrammarDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < TipoGrammarDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=TipoGrammarDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > TipoGrammarDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=TipoGrammarDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < TipoGrammarDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=TipoGrammarDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<TipoGrammarDetalle> TraerBeans(List<TipoGrammarDetalle> tipogrammardetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(TipoGrammarDetalle tipogrammardetalle:tipogrammardetalles) {
					
				if(!(TipoGrammarDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || TipoGrammarDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					tipogrammardetalle.setsDetalleGeneralEntityReporte(TipoGrammarDetalle_util.getTipoGrammarDetalleDescripcion(tipogrammardetalle));
					...
					//tipogrammardetalle.setsDetalleGeneralEntityReporte(tipogrammardetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//tipogrammardetallebeans.add(tipogrammardetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface TipoGrammarDetalle_windowI {	
