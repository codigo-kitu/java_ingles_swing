...
*/
package com.bydan.ingles.gramatica.vocabulariodetalle.presentation.swing.jinternalframes.window;
...
public class VocabularioDetalle_window extends JInternalFrameBase {	
	...
	public VocabularioDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public Vocabulario_control_window vocabularioBeanSwingJFrame;
	public String sFinalQueryGeneral_vocabulario="";
	...
	public JPanel pnl_FK_IdVocabulario;
	public JButton btn_FK_IdVocabulario;
	...
	public JPanel pnlid_vocabularioFK_IdVocabulario;
	public JLabel lbl_id_vocabularioFK_IdVocabulario;
	public JComboBoxMe cmb_id_vocabularioFK_IdVocabulario;
	public JButton btn_id_vocabularioFK_IdVocabulario= new JButton();
	public JButton btn_id_vocabularioFK_IdVocabulario_Update= new JButton();
	public JButton btn_id_vocabularioFK_IdVocabulario_Busqueda= new JButton();
	...
	*/
	...
	public VocabularioDetalle_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VocabularioDetalle_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public VocabularioDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VocabularioDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VocabularioDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<VocabularioDetalle> getvocabulariodetallesAux() {
		return this.vocabulariodetallesAux;
	}

	public void setvocabulariodetallesAux(List<VocabularioDetalle> vocabulariodetallesAux) {
		this.vocabulariodetallesAux = vocabulariodetallesAux;
	}
	
	public List<VocabularioDetalle> getvocabulariodetallesEliminados() {
		return this.vocabulariodetallesEliminados;
	}

	public void setVocabularioDetallesEliminados(List<VocabularioDetalle> vocabulariodetallesEliminados) {
		this.vocabulariodetallesEliminados = vocabulariodetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoVocabularioDetalle) {
	//	this.jCheckBoxConGraficoDinamicoVocabularioDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoVocabularioDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.vocabulariodetalle_session.setConGuardarRelaciones(conGuardarRelaciones);
		this.vocabulariodetalle_session.setEsGuardarRelacionado(esGuardarRelacionado);
		
		
		this.conCargarMinimo=this.vocabulariodetalle_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		VocabularioDetalle_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Vocabulario Detalle MANTENIMIENTO"));
		...
		VocabularioDetalle_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdVocabulario=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdVocabulario.setToolTipText("Buscar Por Vocabulario ");
		this.btn_FK_IdVocabulario= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdVocabulario,"buscar_button","Buscar","Buscar Por Vocabulario ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdVocabulario, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdVocabulario, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_vocabularioFK_IdVocabulario = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_vocabularioFK_IdVocabulario,"Vocabulario :","Vocabulario");
		FuncionesSwing.setLabelSize(lbl_id_vocabularioFK_IdVocabulario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_vocabularioFK_IdVocabulario,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_vocabularioFK_IdVocabulario,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_vocabularioFK_IdVocabulario= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_vocabularioFK_IdVocabulario,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_vocabularioFK_IdVocabulario,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new VocabularioDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Vocabulario Detalle DATOS");
			//_form
			this.jFrameDetalleForm = new VocabularioDetalle_form_window(jDesktopPane,this.vocabulariodetalle_session.getConGuardarRelaciones(),this.vocabulariodetalle_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new VocabularioDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//VocabularioDetalle
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipVocabularioDetalle="";
		sToolTipVocabularioDetalle=VocabularioDetalle_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipVocabularioDetalle+="(Gramatica.VocabularioDetalle)";
		}
		
		if(!this.vocabulariodetalle_session.getEsGuardarRelacionado()) {
			sToolTipVocabularioDetalle+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipVocabularioDetalle);
		...
		this.sPath=" <---> Acceso: Vocabulario Detalle";
		
		if(!this.vocabulariodetalle_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Vocabulario Detalles" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVocabularioDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVocabularioDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"VocabularioDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.vocabulariodetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"VocabularioDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"VocabularioDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+VocabularioDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+VocabularioDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),VocabularioDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VocabularioDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),VocabularioDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VocabularioDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),VocabularioDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VocabularioDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosVocabularioDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosVocabularioDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoVocabularioDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammarDetalle.setLayout(gridaBagLayoutFK_IdTipoGrammarDetalleVocabularioDetalle);
		...
		jTabbedPaneBusquedas.addTab("1.-Por Tipo Grammar Detalle ", pnl_FK_IdTipoGrammarDetalle);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdVocabularioVocabularioDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdVocabularioVocabularioDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdVocabularioVocabularioDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdVocabularioVocabularioDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdVocabularioVocabularioDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdVocabulario.setLayout(gridaBagLayoutFK_IdVocabularioVocabularioDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdVocabulario.add(lbl_id_vocabularioFK_IdVocabulario, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdVocabulario.add(cmb_id_vocabularioFK_IdVocabulario, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdVocabulario.add(btn_FK_IdVocabulario, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Vocabulario ", pnl_FK_IdVocabulario);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.vocabulariodetalle_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(VocabularioDetalle_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.vocabulariodetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//VocabularioDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.vocabulariodetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > VocabularioDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VocabularioDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VocabularioDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VocabularioDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > VocabularioDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VocabularioDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VocabularioDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VocabularioDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<VocabularioDetalle> TraerBeans(List<VocabularioDetalle> vocabulariodetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(VocabularioDetalle vocabulariodetalle:vocabulariodetalles) {
					
				if(!(VocabularioDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || VocabularioDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					vocabulariodetalle.setsDetalleGeneralEntityReporte(VocabularioDetalle_util.getVocabularioDetalleDescripcion(vocabulariodetalle));
					...
					//vocabulariodetalle.setsDetalleGeneralEntityReporte(vocabulariodetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//vocabulariodetallebeans.add(vocabulariodetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface VocabularioDetalle_windowI {	
