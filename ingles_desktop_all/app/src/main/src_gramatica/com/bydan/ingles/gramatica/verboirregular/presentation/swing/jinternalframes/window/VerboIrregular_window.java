...
public class VerboIrregular_window extends JInternalFrameBase {	
	...
	public VerboIrregular_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_BusquedaPorInfinitivo;
	public JButton btn_BusquedaPorInfinitivo;
	...
	public JPanel pnlinfinitivoBusquedaPorInfinitivo;
	public JLabel lbl_infinitivoBusquedaPorInfinitivo;
	public JTextField txf_infinitivoBusquedaPorInfinitivo;
	public JButton btn_infinitivoBusquedaPorInfinitivo_Busqueda= new JButton();
	...
	*/
	...
	public VerboIrregular_window() throws Exception {
	...
	public VerboIrregular_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public VerboIrregular_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboIrregular No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboIrregular_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboIrregular No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<VerboIrregular> getverboirregularsAux() {
		return this.verboirregularsAux;
	}

	public void setverboirregularsAux(List<VerboIrregular> verboirregularsAux) {
		this.verboirregularsAux = verboirregularsAux;
	}
	
	public List<VerboIrregular> getverboirregularsEliminados() {
		return this.verboirregularsEliminados;
	}

	public void setVerboIrregularsEliminados(List<VerboIrregular> verboirregularsEliminados) {
		this.verboirregularsEliminados = verboirregularsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoVerboIrregular) {
	//	this.jCheckBoxConGraficoDinamicoVerboIrregular = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoVerboIrregular.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=VerboIrregular_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=VerboIrregular_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorInfinitivo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorInfinitivo.setToolTipText("Buscar Por Infinitivo ");
		this.btn_BusquedaPorInfinitivo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorInfinitivo,"buscar_button","Buscar","Buscar Por Infinitivo ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorInfinitivo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorInfinitivo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_infinitivoBusquedaPorInfinitivo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_infinitivoBusquedaPorInfinitivo,"Infinitivo :","Infinitivo");
		FuncionesSwing.setLabelSize(lbl_infinitivoBusquedaPorInfinitivo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_infinitivoBusquedaPorInfinitivo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_infinitivoBusquedaPorInfinitivo,this.sTipoTamanioGeneral,false,true,this);

		txf_infinitivoBusquedaPorInfinitivo= new JTextField();
		FuncionesSwing.setTextFieldSize(txf_infinitivoBusquedaPorInfinitivo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_infinitivoBusquedaPorInfinitivo,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new VerboIrregularDetalle_window(paginaTipo);//JInternalFrameBase("Verbo Irregular DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new VerboIrregular_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//VerboIrregular
		...
		this.tableDatos.setToolTipText(sToolTipVerboIrregular);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboIrregular,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboIrregular,true,this);
		...
		//VALORES PARA DISENO
		/*
		this.tableDatos.setMinimumSize(new Dimension(400,50));//1030
		this.tableDatos.setMaximumSize(new Dimension(400,50));//1030
		this.tableDatos.setPreferredSize(new Dimension(400,50));//1030
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"VerboIrregular",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.verboirregular_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"VerboIrregular",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"VerboIrregular",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+VerboIrregular_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+VerboIrregular_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),VerboIrregularBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),VerboIrregularBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),VerboIrregularBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosVerboIrregular = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosVerboIrregular);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoVerboIrregular, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorInfinitivoVerboIrregular= new GridBagLayout();
		gridaBagLayoutBusquedaPorInfinitivoVerboIrregular.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorInfinitivoVerboIrregular.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorInfinitivoVerboIrregular.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorInfinitivoVerboIrregular.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorInfinitivo.setLayout(gridaBagLayoutBusquedaPorInfinitivoVerboIrregular);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorInfinitivo.add(lbl_infinitivoBusquedaPorInfinitivo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorInfinitivo.add(txf_infinitivoBusquedaPorInfinitivo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorInfinitivo.add(btn_BusquedaPorInfinitivo, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Infinitivo ", pnl_BusquedaPorInfinitivo);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutBusquedaPorTraduccionVerboIrregular= new GridBagLayout();
		gridaBagLayoutBusquedaPorTraduccionVerboIrregular.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionVerboIrregular.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionVerboIrregular.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorTraduccionVerboIrregular.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorTraduccion.setLayout(gridaBagLayoutBusquedaPorTraduccionVerboIrregular);
		...
		GridBagLayout gridaBagLayoutFK_IdAreaVerboIrregular= new GridBagLayout();
		gridaBagLayoutFK_IdAreaVerboIrregular.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdAreaVerboIrregular.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdAreaVerboIrregular.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdAreaVerboIrregular.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdArea.setLayout(gridaBagLayoutFK_IdAreaVerboIrregular);
		...
		GridBagLayout gridaBagLayoutFK_IdNivelVerboIrregular= new GridBagLayout();
		gridaBagLayoutFK_IdNivelVerboIrregular.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdNivelVerboIrregular.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdNivelVerboIrregular.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdNivelVerboIrregular.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdNivel.setLayout(gridaBagLayoutFK_IdNivelVerboIrregular);
		...
		GridBagLayout gridaBagLayoutFK_IdSubAreaVerboIrregular= new GridBagLayout();
		gridaBagLayoutFK_IdSubAreaVerboIrregular.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdSubAreaVerboIrregular.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdSubAreaVerboIrregular.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdSubAreaVerboIrregular.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdSubArea.setLayout(gridaBagLayoutFK_IdSubAreaVerboIrregular);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.verboirregular_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.verboirregular_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//VerboIrregular_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.verboirregular_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > VerboIrregular_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboIrregular_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboIrregular_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboIrregular_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > VerboIrregular_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboIrregular_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboIrregular_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboIrregular_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<VerboIrregular> TraerBeans(List<VerboIrregular> verboirregulars,ArrayList<Classe> classes)throws Exception {
		try {
			for(VerboIrregular verboirregular:verboirregulars) {
					
				if(!(VerboIrregular_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || VerboIrregular_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					verboirregular.setsDetalleGeneralEntityReporte(VerboIrregular_util.getVerboIrregularDescripcion(verboirregular));
					...
					//verboirregular.setsDetalleGeneralEntityReporte(verboirregular.getsDetalleGeneralEntityReporte());
										
				}
				
				//verboirregularbeans.add(verboirregularbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface VerboIrregular_windowI {	
