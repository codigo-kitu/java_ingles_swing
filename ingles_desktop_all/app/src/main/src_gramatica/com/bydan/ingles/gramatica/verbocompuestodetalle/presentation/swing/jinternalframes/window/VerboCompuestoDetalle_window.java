...
*/
package com.bydan.ingles.gramatica.verbocompuestodetalle.presentation.swing.jinternalframes.window;
...
public class VerboCompuestoDetalle_window extends JInternalFrameBase {	
	...
	public VerboCompuestoDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public VerboCompuesto_control_window verbocompuestoBeanSwingJFrame;
	public String sFinalQueryGeneral_verbocompuesto="";
	...
	public JPanel pnl_FK_IdVerboCompuesto;
	public JButton btn_FK_IdVerboCompuesto;
	...
	public JPanel pnlid_verbo_compuestoFK_IdVerboCompuesto;
	public JLabel lbl_id_verbo_compuestoFK_IdVerboCompuesto;
	public JComboBoxMe cmb_id_verbo_compuestoFK_IdVerboCompuesto;
	public JButton btn_id_verbo_compuestoFK_IdVerboCompuesto= new JButton();
	public JButton btn_id_verbo_compuestoFK_IdVerboCompuesto_Update= new JButton();
	public JButton btn_id_verbo_compuestoFK_IdVerboCompuesto_Busqueda= new JButton();
	...
	*/
	...
	public VerboCompuestoDetalle_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboCompuestoDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboCompuestoDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<VerboCompuestoDetalle> getverbocompuestodetallesAux() {
		return this.verbocompuestodetallesAux;
	}

	public void setverbocompuestodetallesAux(List<VerboCompuestoDetalle> verbocompuestodetallesAux) {
		this.verbocompuestodetallesAux = verbocompuestodetallesAux;
	}
	
	public List<VerboCompuestoDetalle> getverbocompuestodetallesEliminados() {
		return this.verbocompuestodetallesEliminados;
	}

	public void setVerboCompuestoDetallesEliminados(List<VerboCompuestoDetalle> verbocompuestodetallesEliminados) {
		this.verbocompuestodetallesEliminados = verbocompuestodetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoVerboCompuestoDetalle) {
	//	this.jCheckBoxConGraficoDinamicoVerboCompuestoDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoVerboCompuestoDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.verbocompuestodetalle_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=VerboCompuestoDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=VerboCompuestoDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		VerboCompuestoDetalle_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		VerboCompuestoDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		VerboCompuestoDetalle_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Verbo Compuesto Detalle MANTENIMIENTO"));
		...
		VerboCompuestoDetalle_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdVerboCompuesto=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdVerboCompuesto.setToolTipText("Buscar Por Verbo Compuesto ");
		this.btn_FK_IdVerboCompuesto= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdVerboCompuesto,"buscar_button","Buscar","Buscar Por Verbo Compuesto ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdVerboCompuesto, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdVerboCompuesto, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_verbo_compuestoFK_IdVerboCompuesto = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_verbo_compuestoFK_IdVerboCompuesto,"Verbo Compuesto :","Verbo Compuesto");
		FuncionesSwing.setLabelSize(lbl_id_verbo_compuestoFK_IdVerboCompuesto,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL2);

		FuncionesSwing.setBoldLabel(lbl_id_verbo_compuestoFK_IdVerboCompuesto,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_verbo_compuestoFK_IdVerboCompuesto,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_verbo_compuestoFK_IdVerboCompuesto= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_verbo_compuestoFK_IdVerboCompuesto,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_verbo_compuestoFK_IdVerboCompuesto,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new VerboCompuestoDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Verbo Compuesto Detalle DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new VerboCompuestoDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//VerboCompuestoDetalle
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipVerboCompuestoDetalle="";
		sToolTipVerboCompuestoDetalle=VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipVerboCompuestoDetalle+="(Gramatica.VerboCompuestoDetalle)";
		}
		
		if(!this.verbocompuestodetalle_session.getEsGuardarRelacionado()) {
			sToolTipVerboCompuestoDetalle+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipVerboCompuestoDetalle);
		...
		this.sPath=" <---> Acceso: Verbo Compuesto Detalle";
		
		if(!this.verbocompuestodetalle_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Verbo Compuesto Detalles" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboCompuestoDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboCompuestoDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"VerboCompuestoDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.verbocompuestodetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"VerboCompuestoDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"VerboCompuestoDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosVerboCompuestoDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosVerboCompuestoDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoVerboCompuestoDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammarDetalle.setLayout(gridaBagLayoutFK_IdTipoGrammarDetalleVerboCompuestoDetalle);
		...
		GridBagLayout gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdVerboCompuesto.setLayout(gridaBagLayoutFK_IdVerboCompuestoVerboCompuestoDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdVerboCompuesto.add(lbl_id_verbo_compuestoFK_IdVerboCompuesto, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdVerboCompuesto.add(cmb_id_verbo_compuestoFK_IdVerboCompuesto, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdVerboCompuesto.add(btn_FK_IdVerboCompuesto, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Verbo Compuesto ", pnl_FK_IdVerboCompuesto);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.verbocompuestodetalle_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.verbocompuestodetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//VerboCompuestoDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.verbocompuestodetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > VerboCompuestoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboCompuestoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboCompuestoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboCompuestoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > VerboCompuestoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboCompuestoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboCompuestoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboCompuestoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<VerboCompuestoDetalle> TraerBeans(List<VerboCompuestoDetalle> verbocompuestodetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(VerboCompuestoDetalle verbocompuestodetalle:verbocompuestodetalles) {
					
				if(!(VerboCompuestoDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || VerboCompuestoDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					verbocompuestodetalle.setsDetalleGeneralEntityReporte(VerboCompuestoDetalle_util.getVerboCompuestoDetalleDescripcion(verbocompuestodetalle));
					...
					//verbocompuestodetalle.setsDetalleGeneralEntityReporte(verbocompuestodetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//verbocompuestodetallebeans.add(verbocompuestodetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface VerboCompuestoDetalle_windowI {	
