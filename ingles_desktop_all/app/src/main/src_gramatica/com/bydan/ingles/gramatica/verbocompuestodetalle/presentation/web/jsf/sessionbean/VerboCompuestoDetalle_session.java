...
*/
package com.bydan.ingles.gramatica.verbocompuestodetalle.presentation.web.jsf.sessionbean;
...
public class VerboCompuestoDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionVerboCompuesto=false;
	public Long lidVerboCompuestoActual=0L;
	...
	public VerboCompuestoDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionVerboCompuesto=false;
		//this.lidVerboCompuestoActual=0L;
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("VerboCompuestoDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionVerboCompuesto() {
		return isBusquedaDesdeFKSesionVerboCompuesto;
	}

	public void setisBusquedaDesdeFKSesionVerboCompuesto(
		Boolean isBusquedaDesdeFKSesionVerboCompuesto) {
		this.isBusquedaDesdeFKSesionVerboCompuesto = isBusquedaDesdeFKSesionVerboCompuesto;
	}

	public Long getlidVerboCompuestoActual() {
		return lidVerboCompuestoActual;
	}

	public void setlidVerboCompuestoActual(Long lidVerboCompuestoActual) {
		this.lidVerboCompuestoActual = lidVerboCompuestoActual;
	}
