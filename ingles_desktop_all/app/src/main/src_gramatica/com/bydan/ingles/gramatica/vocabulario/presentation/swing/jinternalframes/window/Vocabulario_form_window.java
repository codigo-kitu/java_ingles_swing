...
public class Vocabulario_form_window extends JInternalFrameBase {	
	...
	//public Vocabulario_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposVocabulario=0;
	//protected Integer iYPanelCamposVocabulario=0;
	
	//protected Integer iXPanelCamposOcultosVocabulario=0;
	//protected Integer iYPanelCamposOcultosVocabulario=0;
	...
	public Vocabulario_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleVocabulario=new JMenuBar();
				this.jTtoolBarDetalleVocabulario=new JToolBar();
				*/
	  		}
	...
	public Vocabulario_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Vocabulario_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Vocabulario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Vocabulario_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Vocabulario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Vocabulario_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Vocabulario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Vocabulario_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesVocabulario) {
		//this.jComboBoxTiposAccionesVocabulario = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Vocabulario_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Vocabulario_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(Vocabulario_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.vocabulario_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_nombre_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+Vocabulario_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(Vocabulario_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+Vocabulario_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(Vocabulario_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_area,""+Vocabulario_util.LABEL_IDAREA+" : *","Area");
		...
		this.pnl_id_area.setToolTipText(Vocabulario_util.LABEL_IDAREA);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_area.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_areaVocabulario"));
		...
		cmb_id_area.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_area.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_areaVocabularioUpdate"));



					
		this.lbl_id_sub_area = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_sub_area,""+Vocabulario_util.LABEL_IDSUBAREA+" : *","Sub Area");
		...
		this.pnl_id_sub_area.setToolTipText(Vocabulario_util.LABEL_IDSUBAREA);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_sub_area.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sub_areaVocabulario"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_sub_area.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_sub_area.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sub_areaVocabularioUpdate"));



					
		this.lbl_id_nivel = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_nivel,""+Vocabulario_util.LABEL_IDNIVEL+" : *","Nivel");
		...
		this.pnl_id_nivel.setToolTipText(Vocabulario_util.LABEL_IDNIVEL);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelVocabulario"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_nivel.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelVocabularioUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Vocabulario_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Vocabulario DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.vocabulario_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.vocabulario_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Vocabulario_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Vocabulario_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Vocabulario_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesVocabulario = new JComboBoxMe();
				//this.jComboBoxTiposAccionesVocabulario.setText("Accion");
		//this.jComboBoxTiposAccionesVocabulario.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesVocabulario,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesVocabulario, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(VocabularioJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Vocabulario_controlJInternalFrameAdditional();//JInternalFrameBase("Vocabulario DATOS");
	        ...
	        //this.setTitle("[FOR] - Vocabulario DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Vocabulario Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Vocabulario_model vocabularioModel=new Vocabulario_model(this);
			
			//SI USARA CLASE INTERNA
			//VocabularioModel.VocabularioFocusTraversalPolicy vocabularioFocusTraversalPolicy = vocabularioModel.new VocabularioFocusTraversalPolicy(this);
			
			//vocabularioFocusTraversalPolicy.setvocabularioJInternalFrame(this);
			
			this.setFocusTraversalPolicy(vocabularioModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& vocabulario_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesVocabulario.setVisible(false);
	...
	public void cargarSessionConBeanSwingJFrameVocabularioDetalle(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.vocabulariodetalle_session.getEsGuardarRelacionado()) {
				...
				VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL=Vocabulario_window.S_TIPO_TAMANIO_GENERAL;
				VocabularioDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=Vocabulario_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarVocabularioDetalleBeanSwingJFrame(List<Vocabulario> vocabularios,Vocabulario vocabulario,VocabularioDetalle_control_window vocabulariodetalleBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					vocabulariodetalleBeanSwingJFrame.getVocabularioDetalleLogic().setConnexion(this.vocabularioLogic.getConnexion());

					vocabulariodetalleBeanSwingJFrame.setvocabulariosFK(vocabularios);
					vocabulariodetalleBeanSwingJFrame.setvocabularioFK(vocabulario);
					vocabulariodetalleBeanSwingJFrame.vocabulariodetalle_session.setisBusquedaDesdeFKSesionVocabulario(true);
					vocabulariodetalleBeanSwingJFrame.vocabulariodetalle_session.setlidVocabularioActual(vocabulario.getId());
					...
					vocabulariodetalleBeanSwingJFrame.setVisibilidadBusquedasParaVocabulario(true);
					vocabulariodetalleBeanSwingJFrame.setid_vocabularioFK_IdVocabulario(vocabulario.getId());

					if(!this.conCargarFormDetalle) {
						vocabulariodetalleBeanSwingJFrame.inicializarFormDetalle();
					}

					vocabulariodetalleBeanSwingJFrame.setSelectedItemCombosFrameVocabularioFK(vocabulario,1,false,true,true);
					vocabulariodetalleBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					vocabulariodetalleBeanSwingJFrame.procesarBusqueda("FK_IdVocabulario");
					vocabulariodetalleBeanSwingJFrame.setsAccionBusqueda("FK_IdVocabulario");
	...
	*/
	...
	public interface Vocabulario_form_windowI {	
