...
*/
package com.bydan.ingles.gramatica.tipogrammar.presentation.swing.jinternalframes.window;
...
public class TipoGrammar_window extends JInternalFrameBase {	
	...
	public TipoGrammar_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public TipoGrammar_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("TipoGrammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoGrammar_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public TipoGrammar_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoGrammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoGrammar_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoGrammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<TipoGrammar> gettipogrammars() {
		return this.tipogrammars;
	}

	public void settipogrammars(List<TipoGrammar> tipogrammars) {
		this.tipogrammars = tipogrammars;
	}
	
	public List<TipoGrammar> gettipogrammarsAux() {
		return this.tipogrammarsAux;
	}

	public void settipogrammarsAux(List<TipoGrammar> tipogrammarsAux) {
		this.tipogrammarsAux = tipogrammarsAux;
	}
	
	public List<TipoGrammar> gettipogrammarsEliminados() {
		return this.tipogrammarsEliminados;
	}

	public void setTipoGrammarsEliminados(List<TipoGrammar> tipogrammarsEliminados) {
		this.tipogrammarsEliminados = tipogrammarsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoTipoGrammar) {
	//	this.jCheckBoxConGraficoDinamicoTipoGrammar = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoTipoGrammar.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.tipogrammar_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=TipoGrammar_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=TipoGrammar_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		TipoGrammar_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		TipoGrammar_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		TipoGrammar_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Tipo Grammar MANTENIMIENTO"));
		...
		TipoGrammar_window.ESTA_CARGADO_PORPARTE=true;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new TipoGrammarDetalle_window(paginaTipo);//JInternalFrameBase("Tipo Grammar DATOS");
			//_form
			this.jFrameDetalleForm = new TipoGrammar_form_window(jDesktopPane,this.tipogrammar_session.getConGuardarRelaciones(),this.tipogrammar_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new TipoGrammar_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//TipoGrammar
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipTipoGrammar="";
		sToolTipTipoGrammar=TipoGrammar_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipTipoGrammar+="(Gramatica.TipoGrammar)";
		}
		
		if(!this.tipogrammar_session.getEsGuardarRelacionado()) {
			sToolTipTipoGrammar+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipTipoGrammar);
		...
		this.sPath=" <---> Acceso: Tipo Grammar";
		
		if(!this.tipogrammar_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Tipo Grammares" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipoGrammar,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipoGrammar,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"TipoGrammar",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.tipogrammar_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"TipoGrammar",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"TipoGrammar",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+TipoGrammar_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+TipoGrammar_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),TipoGrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),TipoGrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),TipoGrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoGrammarBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosTipoGrammar = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosTipoGrammar);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoTipoGrammar, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorNombreTipoGrammar= new GridBagLayout();
		gridaBagLayoutBusquedaPorNombreTipoGrammar.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNombreTipoGrammar.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNombreTipoGrammar.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNombreTipoGrammar.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombreTipoGrammar);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.tipogrammar_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.tipogrammar_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//TipoGrammar_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.tipogrammar_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > TipoGrammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=TipoGrammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < TipoGrammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=TipoGrammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > TipoGrammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=TipoGrammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < TipoGrammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=TipoGrammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<TipoGrammar> TraerBeans(List<TipoGrammar> tipogrammars,ArrayList<Classe> classes)throws Exception {
		try {
			for(TipoGrammar tipogrammar:tipogrammars) {
					
				if(!(TipoGrammar_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || TipoGrammar_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					tipogrammar.setsDetalleGeneralEntityReporte(TipoGrammar_util.getTipoGrammarDescripcion(tipogrammar));
					...
					//tipogrammar.setsDetalleGeneralEntityReporte(tipogrammar.getsDetalleGeneralEntityReporte());
										
				}
				
				//tipogrammarbeans.add(tipogrammarbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface TipoGrammar_windowI {	
