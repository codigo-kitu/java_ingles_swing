...
*/
package com.bydan.ingles.gramatica.expresion.presentation.web.jsf.sessionbean;
...
public class Expresion_session  extends GeneralEntitySessionBean {
	...
	public Expresion_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Expresion:Valor nulo no permitido en columna id");
					}
				}
