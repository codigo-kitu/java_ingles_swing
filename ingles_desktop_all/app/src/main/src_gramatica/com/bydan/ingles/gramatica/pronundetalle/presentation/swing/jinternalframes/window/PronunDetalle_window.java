...
*/
package com.bydan.ingles.gramatica.pronundetalle.presentation.swing.jinternalframes.window;
...
public class PronunDetalle_window extends JInternalFrameBase {	
	...
	public PronunDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public Pronun_control_window pronunBeanSwingJFrame;
	public String sFinalQueryGeneral_pronun="";
	...
	public List<PronunDetalle> pronundetallesEliminados;	
	public List<PronunDetalle> pronundetallesAux;
	...
	public PronunDetalle_logic pronundetalleLogic;
	...
	public JPanel pnl_FK_IdPronun;
	public JButton btn_FK_IdPronun;
	public JPanel pnl_FK_IdTipoGrammarDetalle;
	public JButton btn_FK_IdTipoGrammarDetalle;
	
	public JPanel pnlid_pronunFK_IdPronun;
	public JLabel lbl_id_pronunFK_IdPronun;
	public JComboBoxMe cmb_id_pronunFK_IdPronun;
	public JButton btn_id_pronunFK_IdPronun= new JButton();
	public JButton btn_id_pronunFK_IdPronun_Update= new JButton();
	public JButton btn_id_pronunFK_IdPronun_Busqueda= new JButton();
	...
	*/
	...
	public PronunDetalle_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PronunDetalle_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public PronunDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PronunDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<PronunDetalle> getpronundetallesAux() {
		return this.pronundetallesAux;
	}

	public void setpronundetallesAux(List<PronunDetalle> pronundetallesAux) {
		this.pronundetallesAux = pronundetallesAux;
	}
	
	public List<PronunDetalle> getpronundetallesEliminados() {
		return this.pronundetallesEliminados;
	}

	public void setPronunDetallesEliminados(List<PronunDetalle> pronundetallesEliminados) {
		this.pronundetallesEliminados = pronundetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoPronunDetalle) {
	//	this.jCheckBoxConGraficoDinamicoPronunDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoPronunDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.pronundetalle_session.setConGuardarRelaciones(conGuardarRelaciones);
		this.pronundetalle_session.setEsGuardarRelacionado(esGuardarRelacionado);
		
		
		this.conCargarMinimo=this.pronundetalle_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=PronunDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PronunDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		PronunDetalle_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		PronunDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		PronunDetalle_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Pronun Detalle MANTENIMIENTO"));
		...
		PronunDetalle_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdPronun=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdPronun.setToolTipText("Buscar Por Pronun ");
		this.btn_FK_IdPronun= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdPronun,"buscar_button","Buscar","Buscar Por Pronun ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdPronun, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdPronun, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_pronunFK_IdPronun = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_pronunFK_IdPronun,"Pronun :","Pronun");
		FuncionesSwing.setLabelSize(lbl_id_pronunFK_IdPronun,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_pronunFK_IdPronun,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_pronunFK_IdPronun,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_pronunFK_IdPronun= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_pronunFK_IdPronun,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_pronunFK_IdPronun,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PronunDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Pronun Detalle DATOS");
			//_form
			this.jFrameDetalleForm = new PronunDetalle_form_window(jDesktopPane,this.pronundetalle_session.getConGuardarRelaciones(),this.pronundetalle_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new PronunDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PronunDetalle
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipPronunDetalle="";
		sToolTipPronunDetalle=PronunDetalle_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipPronunDetalle+="(Gramatica.PronunDetalle)";
		}
		
		if(!this.pronundetalle_session.getEsGuardarRelacionado()) {
			sToolTipPronunDetalle+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipPronunDetalle);
		...
		this.sPath=" <---> Acceso: Pronun Detalle";
		
		if(!this.pronundetalle_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Pronun Detalles" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronunDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronunDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PronunDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.pronundetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PronunDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PronunDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PronunDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PronunDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PronunDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PronunDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PronunDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosPronunDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPronunDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPronunDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdPronunPronunDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdPronunPronunDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdPronunPronunDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdPronunPronunDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdPronunPronunDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdPronun.setLayout(gridaBagLayoutFK_IdPronunPronunDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdPronun.add(lbl_id_pronunFK_IdPronun, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdPronun.add(cmb_id_pronunFK_IdPronun, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdPronun.add(btn_FK_IdPronun, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Pronun ", pnl_FK_IdPronun);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammarDetalle.setLayout(gridaBagLayoutFK_IdTipoGrammarDetallePronunDetalle);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.pronundetalle_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(PronunDetalle_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.pronundetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PronunDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.pronundetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PronunDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PronunDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PronunDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PronunDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PronunDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PronunDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PronunDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PronunDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PronunDetalle> TraerBeans(List<PronunDetalle> pronundetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(PronunDetalle pronundetalle:pronundetalles) {
					
				if(!(PronunDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PronunDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					pronundetalle.setsDetalleGeneralEntityReporte(PronunDetalle_util.getPronunDetalleDescripcion(pronundetalle));
					...
					//pronundetalle.setsDetalleGeneralEntityReporte(pronundetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//pronundetallebeans.add(pronundetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface PronunDetalle_windowI {	
