...
*/
package com.bydan.ingles.gramatica.paisgeneral.presentation.swing.jinternalframes.window;
...
public class PaisGeneral_window extends JInternalFrameBase {	
	...
	public PaisGeneral_form_window jFrameDetalleForm;//_form;		
	...
	public PaisGeneral_session paisgeneral_session;
	...
	*/
	...
	public PaisGeneral_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PaisGeneral_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public PaisGeneral_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PaisGeneral_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<PaisGeneral> getpaisgenerals() {
		return this.paisgenerals;
	}

	public void setpaisgenerals(List<PaisGeneral> paisgenerals) {
		this.paisgenerals = paisgenerals;
	}
	
	public List<PaisGeneral> getpaisgeneralsAux() {
		return this.paisgeneralsAux;
	}

	public void setpaisgeneralsAux(List<PaisGeneral> paisgeneralsAux) {
		this.paisgeneralsAux = paisgeneralsAux;
	}
	
	public List<PaisGeneral> getpaisgeneralsEliminados() {
		return this.paisgeneralsEliminados;
	}

	public void setPaisGeneralsEliminados(List<PaisGeneral> paisgeneralsEliminados) {
		this.paisgeneralsEliminados = paisgeneralsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoPaisGeneral) {
	//	this.jCheckBoxConGraficoDinamicoPaisGeneral = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoPaisGeneral.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.paisgeneral_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=PaisGeneral_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PaisGeneral_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		PaisGeneral_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		PaisGeneral_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		PaisGeneral_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Pais General MANTENIMIENTO"));
		...
		PaisGeneral_window.ESTA_CARGADO_PORPARTE=true;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PaisGeneralDetalle_window(paginaTipo);//JInternalFrameBase("Pais General DATOS");
			//_form
			this.jFrameDetalleForm = new PaisGeneral_form_window(jDesktopPane,this.paisgeneral_session.getConGuardarRelaciones(),this.paisgeneral_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new PaisGeneral_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PaisGeneral
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipPaisGeneral="";
		sToolTipPaisGeneral=PaisGeneral_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipPaisGeneral+="(Gramatica.PaisGeneral)";
		}
		
		if(!this.paisgeneral_session.getEsGuardarRelacionado()) {
			sToolTipPaisGeneral+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipPaisGeneral);
		...
		this.sPath=" <---> Acceso: Pais General";
		
		if(!this.paisgeneral_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Pais Generales" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPaisGeneral,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPaisGeneral,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PaisGeneral",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.paisgeneral_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PaisGeneral",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PaisGeneral",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PaisGeneral_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PaisGeneral_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PaisGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PaisGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PaisGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PaisGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PaisGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PaisGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosPaisGeneral = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPaisGeneral);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPaisGeneral, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorNombrePaisGeneral= new GridBagLayout();
		gridaBagLayoutBusquedaPorNombrePaisGeneral.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNombrePaisGeneral.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNombrePaisGeneral.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNombrePaisGeneral.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombrePaisGeneral);
		...
		GridBagLayout gridaBagLayoutBusquedaPorTraduccionPaisGeneral= new GridBagLayout();
		gridaBagLayoutBusquedaPorTraduccionPaisGeneral.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionPaisGeneral.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionPaisGeneral.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorTraduccionPaisGeneral.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorTraduccion.setLayout(gridaBagLayoutBusquedaPorTraduccionPaisGeneral);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.paisgeneral_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.paisgeneral_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PaisGeneral_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.paisgeneral_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PaisGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PaisGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PaisGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PaisGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PaisGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PaisGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PaisGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PaisGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PaisGeneral> TraerBeans(List<PaisGeneral> paisgenerals,ArrayList<Classe> classes)throws Exception {
		try {
			for(PaisGeneral paisgeneral:paisgenerals) {
					
				if(!(PaisGeneral_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PaisGeneral_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					paisgeneral.setsDetalleGeneralEntityReporte(PaisGeneral_util.getPaisGeneralDescripcion(paisgeneral));
					...
					//paisgeneral.setsDetalleGeneralEntityReporte(paisgeneral.getsDetalleGeneralEntityReporte());
										
				}
				
				//paisgeneralbeans.add(paisgeneralbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface PaisGeneral_windowI {	
