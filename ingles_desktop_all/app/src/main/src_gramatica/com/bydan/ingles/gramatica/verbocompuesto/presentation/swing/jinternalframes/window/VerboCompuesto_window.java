...
public class VerboCompuesto_window extends JInternalFrameBase {	
	...
	public VerboCompuesto_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public VerboCompuesto_window() throws Exception {
	...
	public VerboCompuesto_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public VerboCompuesto_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuesto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboCompuesto_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuesto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<VerboCompuesto> getverbocompuestosAux() {
		return this.verbocompuestosAux;
	}

	public void setverbocompuestosAux(List<VerboCompuesto> verbocompuestosAux) {
		this.verbocompuestosAux = verbocompuestosAux;
	}
	
	public List<VerboCompuesto> getverbocompuestosEliminados() {
		return this.verbocompuestosEliminados;
	}

	public void setVerboCompuestosEliminados(List<VerboCompuesto> verbocompuestosEliminados) {
		this.verbocompuestosEliminados = verbocompuestosEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoVerboCompuesto) {
	//	this.jCheckBoxConGraficoDinamicoVerboCompuesto = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoVerboCompuesto.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=VerboCompuesto_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=VerboCompuesto_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new VerboCompuestoDetalle_window(paginaTipo);//JInternalFrameBase("Verbo Compuesto DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new VerboCompuesto_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//VerboCompuesto
		...
		this.tableDatos.setToolTipText(sToolTipVerboCompuesto);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboCompuesto,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboCompuesto,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"VerboCompuesto",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.verbocompuesto_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"VerboCompuesto",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"VerboCompuesto",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+VerboCompuesto_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+VerboCompuesto_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),VerboCompuestoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),VerboCompuestoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),VerboCompuestoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboCompuestoBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosVerboCompuesto = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosVerboCompuesto);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoVerboCompuesto, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto= new GridBagLayout();
		gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorInfinitivo.setLayout(gridaBagLayoutBusquedaPorInfinitivoVerboCompuesto);
		...
		GridBagLayout gridaBagLayoutBusquedaPorTraduccionVerboCompuesto= new GridBagLayout();
		gridaBagLayoutBusquedaPorTraduccionVerboCompuesto.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionVerboCompuesto.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorTraduccionVerboCompuesto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorTraduccionVerboCompuesto.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorTraduccion.setLayout(gridaBagLayoutBusquedaPorTraduccionVerboCompuesto);
		...
		GridBagLayout gridaBagLayoutFK_IdAreaVerboCompuesto= new GridBagLayout();
		gridaBagLayoutFK_IdAreaVerboCompuesto.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdAreaVerboCompuesto.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdAreaVerboCompuesto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdAreaVerboCompuesto.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdArea.setLayout(gridaBagLayoutFK_IdAreaVerboCompuesto);
		...
		GridBagLayout gridaBagLayoutFK_IdNivelVerboCompuesto= new GridBagLayout();
		gridaBagLayoutFK_IdNivelVerboCompuesto.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdNivelVerboCompuesto.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdNivelVerboCompuesto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdNivelVerboCompuesto.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdNivel.setLayout(gridaBagLayoutFK_IdNivelVerboCompuesto);
		...
		GridBagLayout gridaBagLayoutFK_IdSubAreaVerboCompuesto= new GridBagLayout();
		gridaBagLayoutFK_IdSubAreaVerboCompuesto.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdSubAreaVerboCompuesto.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdSubAreaVerboCompuesto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdSubAreaVerboCompuesto.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdSubArea.setLayout(gridaBagLayoutFK_IdSubAreaVerboCompuesto);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.verbocompuesto_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//VerboCompuesto_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.verbocompuesto_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > VerboCompuesto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboCompuesto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboCompuesto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboCompuesto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > VerboCompuesto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboCompuesto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboCompuesto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboCompuesto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<VerboCompuesto> TraerBeans(List<VerboCompuesto> verbocompuestos,ArrayList<Classe> classes)throws Exception {
		try {
			for(VerboCompuesto verbocompuesto:verbocompuestos) {
					
				if(!(VerboCompuesto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || VerboCompuesto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					verbocompuesto.setsDetalleGeneralEntityReporte(VerboCompuesto_util.getVerboCompuestoDescripcion(verbocompuesto));
					...
					//verbocompuesto.setsDetalleGeneralEntityReporte(verbocompuesto.getsDetalleGeneralEntityReporte());
										
				}
				
				//verbocompuestobeans.add(verbocompuestobean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface VerboCompuesto_windowI {	
