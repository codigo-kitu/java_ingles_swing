...
*/
package com.bydan.ingles.gramatica.grammar.presentation.swing.jinternalframes.window;
...
public class Grammar_window extends JInternalFrameBase {	
	...
	public Grammar_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_FK_IdTipoGrammar;
	public JButton btn_FK_IdTipoGrammar;
	...
	public JPanel pnlid_tipo_grammarFK_IdTipoGrammar;
	public JLabel lbl_id_tipo_grammarFK_IdTipoGrammar;
	public JComboBoxMe cmb_id_tipo_grammarFK_IdTipoGrammar;
	public JButton btn_id_tipo_grammarFK_IdTipoGrammar= new JButton();
	public JButton btn_id_tipo_grammarFK_IdTipoGrammar_Update= new JButton();
	public JButton btn_id_tipo_grammarFK_IdTipoGrammar_Busqueda= new JButton();
	...
	*/
	...
	public Grammar_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grammar_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Grammar_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grammar_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grammar No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<Grammar> getgrammarsAux() {
		return this.grammarsAux;
	}

	public void setgrammarsAux(List<Grammar> grammarsAux) {
		this.grammarsAux = grammarsAux;
	}
	
	public List<Grammar> getgrammarsEliminados() {
		return this.grammarsEliminados;
	}

	public void setGrammarsEliminados(List<Grammar> grammarsEliminados) {
		this.grammarsEliminados = grammarsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoGrammar) {
	//	this.jCheckBoxConGraficoDinamicoGrammar = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoGrammar.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.grammar_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=Grammar_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Grammar_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		Grammar_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Grammar_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Grammar_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Grammar MANTENIMIENTO"));
		...
		Grammar_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		FuncionesSwing.setLabelSize(lbl_nombreBusquedaPorNombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		FuncionesSwing.setLabelSize(lbl_id_nivelFK_IdNivel,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		this.pnl_FK_IdTipoGrammar=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdTipoGrammar.setToolTipText("Buscar Por Tipo Grammar ");
		this.btn_FK_IdTipoGrammar= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdTipoGrammar,"buscar_button","Buscar","Buscar Por Tipo Grammar ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdTipoGrammar, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdTipoGrammar, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_tipo_grammarFK_IdTipoGrammar = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_tipo_grammarFK_IdTipoGrammar,"Tipo Grammar :","Tipo Grammar");
		FuncionesSwing.setLabelSize(lbl_id_tipo_grammarFK_IdTipoGrammar,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_tipo_grammarFK_IdTipoGrammar,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_tipo_grammarFK_IdTipoGrammar,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_tipo_grammarFK_IdTipoGrammar= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_tipo_grammarFK_IdTipoGrammar,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_tipo_grammarFK_IdTipoGrammar,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new GrammarDetalle_window(paginaTipo);//JInternalFrameBase("Grammar DATOS");
			//_form
			this.jFrameDetalleForm = new Grammar_form_window(jDesktopPane,this.grammar_session.getConGuardarRelaciones(),this.grammar_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Grammar_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Grammar
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipGrammar="";
		sToolTipGrammar=Grammar_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipGrammar+="(Gramatica.Grammar)";
		}
		
		if(!this.grammar_session.getEsGuardarRelacionado()) {
			sToolTipGrammar+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipGrammar);
		...
		this.sPath=" <---> Acceso: Grammar";
		
		if(!this.grammar_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Grammares" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByGrammar,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByGrammar,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Grammar",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.grammar_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Grammar",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Grammar",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Grammar_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Grammar_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),GrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(GrammarBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),GrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(GrammarBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),GrammarBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(GrammarBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosGrammar = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosGrammar);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoGrammar, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorNombreGrammar= new GridBagLayout();
		gridaBagLayoutBusquedaPorNombreGrammar.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNombreGrammar.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNombreGrammar.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNombreGrammar.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombreGrammar);
		...
		GridBagLayout gridaBagLayoutFK_IdNivelGrammar= new GridBagLayout();
		gridaBagLayoutFK_IdNivelGrammar.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdNivelGrammar.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdNivelGrammar.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdNivelGrammar.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdNivel.setLayout(gridaBagLayoutFK_IdNivelGrammar);
		...
		jTabbedPaneBusquedas.addTab("2.-Por Nivel ", pnl_FK_IdNivel);
		jTabbedPaneBusquedas.setMnemonicAt(1, KeyEvent.VK_2);

		GridBagLayout gridaBagLayoutFK_IdTipoGrammarGrammar= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarGrammar.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarGrammar.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarGrammar.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarGrammar.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammar.setLayout(gridaBagLayoutFK_IdTipoGrammarGrammar);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdTipoGrammar.add(lbl_id_tipo_grammarFK_IdTipoGrammar, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdTipoGrammar.add(cmb_id_tipo_grammarFK_IdTipoGrammar, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdTipoGrammar.add(btn_FK_IdTipoGrammar, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("3.-Por Tipo Grammar ", pnl_FK_IdTipoGrammar);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.grammar_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.grammar_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Grammar_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.grammar_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Grammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Grammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Grammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Grammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Grammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Grammar_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Grammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Grammar_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Grammar> TraerBeans(List<Grammar> grammars,ArrayList<Classe> classes)throws Exception {
		try {
			for(Grammar grammar:grammars) {
					
				if(!(Grammar_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Grammar_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					grammar.setsDetalleGeneralEntityReporte(Grammar_util.getGrammarDescripcion(grammar));
					...
					//grammar.setsDetalleGeneralEntityReporte(grammar.getsDetalleGeneralEntityReporte());
										
				}
				
				//grammarbeans.add(grammarbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface Grammar_windowI {	
