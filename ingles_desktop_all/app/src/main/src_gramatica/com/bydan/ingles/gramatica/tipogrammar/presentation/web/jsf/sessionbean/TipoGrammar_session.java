...
*/
package com.bydan.ingles.gramatica.tipogrammar.presentation.web.jsf.sessionbean;
...
public class TipoGrammar_session  extends GeneralEntitySessionBean {
	...
	public TipoGrammar_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("TipoGrammar:Valor nulo no permitido en columna id");
					}
				}
