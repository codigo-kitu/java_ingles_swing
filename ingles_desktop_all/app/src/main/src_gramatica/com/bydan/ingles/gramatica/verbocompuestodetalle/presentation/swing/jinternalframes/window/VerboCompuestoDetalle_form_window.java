...
public class VerboCompuestoDetalle_form_window extends JInternalFrameBase {	
	...
	//public VerboCompuestoDetalle_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposVerboCompuestoDetalle=0;
	//protected Integer iYPanelCamposVerboCompuestoDetalle=0;
	
	//protected Integer iXPanelCamposOcultosVerboCompuestoDetalle=0;
	//protected Integer iYPanelCamposOcultosVerboCompuestoDetalle=0;
	...
	public JPanel pnl_id_verbo_compuesto;
	public JLabel lbl_id_verbo_compuesto;
	public JComboBoxMe cmb_id_verbo_compuesto;
	public JButton btn_id_verbo_compuesto= new JButton();
	public JButton btn_id_verbo_compuesto_Update= new JButton();
	public JButton btn_id_verbo_compuesto_Busqueda= new JButton();
	...
	public VerboCompuestoDetalle_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleVerboCompuestoDetalle=new JMenuBar();
				this.jTtoolBarDetalleVerboCompuestoDetalle=new JToolBar();
				*/
	  		}
	...
	public VerboCompuestoDetalle_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public VerboCompuestoDetalle_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public VerboCompuestoDetalle_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboCompuestoDetalle_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboCompuestoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboCompuestoDetalle_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesVerboCompuestoDetalle) {
		//this.jComboBoxTiposAccionesVerboCompuestoDetalle = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(VerboCompuestoDetalle_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_idea,""+VerboCompuestoDetalle_util.LABEL_IDEA+" : *","Idea");
		...
		this.pnl_idea.setToolTipText(VerboCompuestoDetalle_util.LABEL_IDEA);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.verbocompuestodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_idea_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+VerboCompuestoDetalle_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(VerboCompuestoDetalle_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+VerboCompuestoDetalle_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(VerboCompuestoDetalle_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+VerboCompuestoDetalle_util.LABEL_DESCRIPCION+" :","Descripcion");
		...
		this.pnl_descripcion.setToolTipText(VerboCompuestoDetalle_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		this.lbl_id_verbo_compuesto = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_verbo_compuesto,""+VerboCompuestoDetalle_util.LABEL_IDVERBOCOMPUESTO+" : *","Verbo Compuesto");
		FuncionesSwing.setLabelSize(this.lbl_id_verbo_compuesto,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL2 + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL2,0));

		FuncionesSwing.setBoldLabel(lbl_id_verbo_compuesto,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_verbo_compuesto,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_verbo_compuesto=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_verbo_compuesto.setToolTipText(VerboCompuestoDetalle_util.LABEL_IDVERBOCOMPUESTO);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_verbo_compuesto.setLayout(this.gridaBagLayout);


		cmb_id_verbo_compuesto= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_verbo_compuesto,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_verbo_compuesto,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_verbo_compuesto= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_verbo_compuesto,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_verbo_compuesto.setText("Buscar");
		this.btn_id_verbo_compuesto.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_verbo_compuesto.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_verbo_compuesto,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_verbo_compuesto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_verbo_compuesto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_verbo_compuestoVerboCompuestoDetalle"));

		this.btn_id_verbo_compuesto_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_verbo_compuesto_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_verbo_compuesto_Busqueda.setText("U");
		this.btn_id_verbo_compuesto_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_verbo_compuesto_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_verbo_compuesto_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_verbo_compuesto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_verbo_compuesto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_verbo_compuesto_Busqueda"));

		if(this.verbocompuestodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_verbo_compuesto_Busqueda.setVisible(false);		}

		this.btn_id_verbo_compuesto_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_verbo_compuesto_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_verbo_compuesto_Update.setText("U");
		this.btn_id_verbo_compuesto_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_verbo_compuesto_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_verbo_compuesto_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_verbo_compuesto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_verbo_compuesto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_verbo_compuestoVerboCompuestoDetalleUpdate"));



					
		this.lbl_id_tipo_grammar_detalle = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar_detalle,""+VerboCompuestoDetalle_util.LABEL_IDTIPOGRAMMARDETALLE+" : *","Tipo Grammar Detalle");
		...
		this.pnl_id_tipo_grammar_detalle.setToolTipText(VerboCompuestoDetalle_util.LABEL_IDTIPOGRAMMARDETALLE);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleVerboCompuestoDetalle"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar_detalle.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleVerboCompuestoDetalleUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new VerboCompuestoDetalle_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Verbo Compuesto Detalle DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.verbocompuestodetalle_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.verbocompuestodetalle_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=VerboCompuestoDetalle_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesVerboCompuestoDetalle = new JComboBoxMe();
				//this.jComboBoxTiposAccionesVerboCompuestoDetalle.setText("Accion");
		//this.jComboBoxTiposAccionesVerboCompuestoDetalle.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesVerboCompuestoDetalle,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesVerboCompuestoDetalle, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_verbo_compuesto.add(lbl_id_verbo_compuesto, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.pnl_id_verbo_compuesto.add(btn_id_verbo_compuesto_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.pnl_id_verbo_compuesto.add(btn_id_verbo_compuesto_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_verbo_compuesto.add(cmb_id_verbo_compuesto, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_verbo_compuesto, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(VerboCompuestoDetalleJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new VerboCompuestoDetalle_controlJInternalFrameAdditional();//JInternalFrameBase("Verbo Compuesto Detalle DATOS");
	        ...
	        //this.setTitle("[FOR] - Verbo Compuesto Detalle DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Verbo Compuesto Detalle Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			VerboCompuestoDetalle_model verbocompuestodetalleModel=new VerboCompuestoDetalle_model(this);
			
			//SI USARA CLASE INTERNA
			//VerboCompuestoDetalleModel.VerboCompuestoDetalleFocusTraversalPolicy verbocompuestodetalleFocusTraversalPolicy = verbocompuestodetalleModel.new VerboCompuestoDetalleFocusTraversalPolicy(this);
			
			//verbocompuestodetalleFocusTraversalPolicy.setverbocompuestodetalleJInternalFrame(this);
			
			this.setFocusTraversalPolicy(verbocompuestodetalleModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& verbocompuestodetalle_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesVerboCompuestoDetalle.setVisible(false);
	...
	*/
	...
	public interface VerboCompuestoDetalle_form_windowI {	
