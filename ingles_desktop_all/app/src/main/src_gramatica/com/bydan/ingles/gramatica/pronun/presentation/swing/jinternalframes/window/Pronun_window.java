...
public class Pronun_window extends JInternalFrameBase {	
	...
	public Pronun_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public Pronun_window() throws Exception {
	...
	public Pronun_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Pronun_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Pronun_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<Pronun> getpronunsAux() {
		return this.pronunsAux;
	}

	public void setpronunsAux(List<Pronun> pronunsAux) {
		this.pronunsAux = pronunsAux;
	}
	
	public List<Pronun> getpronunsEliminados() {
		return this.pronunsEliminados;
	}

	public void setPronunsEliminados(List<Pronun> pronunsEliminados) {
		this.pronunsEliminados = pronunsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoPronun) {
	//	this.jCheckBoxConGraficoDinamicoPronun = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoPronun.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=Pronun_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Pronun_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		FuncionesSwing.setLabelSize(lbl_id_tipo_grammarFK_IdTipoGrammar,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PronunDetalle_window(paginaTipo);//JInternalFrameBase("Pronun DATOS");
			//_form
			this.jFrameDetalleForm = new Pronun_form_window(jDesktopPane,this.pronun_session.getConGuardarRelaciones(),this.pronun_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Pronun_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Pronun
		...
		this.tableDatos.setToolTipText(sToolTipPronun);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronun,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronun,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Pronun",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.pronun_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Pronun",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Pronun",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Pronun_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Pronun_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PronunBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PronunBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PronunBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronunBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosPronun = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPronun);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPronun, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdNivelPronun= new GridBagLayout();
		gridaBagLayoutFK_IdNivelPronun.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdNivelPronun.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdNivelPronun.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdNivelPronun.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdNivel.setLayout(gridaBagLayoutFK_IdNivelPronun);
		...
		jTabbedPaneBusquedas.addTab("1.-Por Nivel ", pnl_FK_IdNivel);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdTipoGrammarPronun= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarPronun.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarPronun.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarPronun.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarPronun.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammar.setLayout(gridaBagLayoutFK_IdTipoGrammarPronun);
		...
		jTabbedPaneBusquedas.addTab("2.-Por Tipo Grammar ", pnl_FK_IdTipoGrammar);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.pronun_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.pronun_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Pronun_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.pronun_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Pronun_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Pronun_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Pronun_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Pronun_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Pronun_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Pronun_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Pronun_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Pronun_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Pronun> TraerBeans(List<Pronun> pronuns,ArrayList<Classe> classes)throws Exception {
		try {
			for(Pronun pronun:pronuns) {
					
				if(!(Pronun_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Pronun_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					pronun.setsDetalleGeneralEntityReporte(Pronun_util.getPronunDescripcion(pronun));
					...
					//pronun.setsDetalleGeneralEntityReporte(pronun.getsDetalleGeneralEntityReporte());
										
				}
				
				//pronunbeans.add(pronunbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface Pronun_windowI {	
