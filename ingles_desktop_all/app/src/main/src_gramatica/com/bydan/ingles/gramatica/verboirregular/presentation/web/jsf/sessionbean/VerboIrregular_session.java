...
*/
package com.bydan.ingles.gramatica.verboirregular.presentation.web.jsf.sessionbean;
...
public class VerboIrregular_session  extends GeneralEntitySessionBean {
	...
	public VerboIrregular_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("VerboIrregular:Valor nulo no permitido en columna id");
					}
				}
