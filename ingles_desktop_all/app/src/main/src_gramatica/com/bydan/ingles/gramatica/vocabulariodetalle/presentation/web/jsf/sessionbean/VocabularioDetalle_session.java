...
*/
package com.bydan.ingles.gramatica.vocabulariodetalle.presentation.web.jsf.sessionbean;
...
public class VocabularioDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionVocabulario=false;
	public Long lidVocabularioActual=0L;
	...
	public VocabularioDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionVocabulario=false;
		//this.lidVocabularioActual=0L;
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("VocabularioDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionVocabulario() {
		return isBusquedaDesdeFKSesionVocabulario;
	}

	public void setisBusquedaDesdeFKSesionVocabulario(
		Boolean isBusquedaDesdeFKSesionVocabulario) {
		this.isBusquedaDesdeFKSesionVocabulario = isBusquedaDesdeFKSesionVocabulario;
	}

	public Long getlidVocabularioActual() {
		return lidVocabularioActual;
	}

	public void setlidVocabularioActual(Long lidVocabularioActual) {
		this.lidVocabularioActual = lidVocabularioActual;
	}
