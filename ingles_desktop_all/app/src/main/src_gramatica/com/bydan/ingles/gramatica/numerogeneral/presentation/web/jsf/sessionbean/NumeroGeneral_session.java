...
*/
package com.bydan.ingles.gramatica.numerogeneral.presentation.web.jsf.sessionbean;
...
public class NumeroGeneral_session  extends GeneralEntitySessionBean {
	...
	public NumeroGeneral_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("NumeroGeneral:Valor nulo no permitido en columna id");
					}
				}
