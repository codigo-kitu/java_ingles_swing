...
*/
package com.bydan.ingles.gramatica.pronun.presentation.swing.jinternalframes.window;
...
public class Pronun_form_window extends JInternalFrameBase {	
	...
	//public Pronun_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public TipoGrammar_control_window tipogrammarBeanSwingJFrame;
	public String sFinalQueryGeneral_tipogrammar="";
	...
	public TipoGrammar_session tipogrammar_session;	
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposPronun=0;
	//protected Integer iYPanelCamposPronun=0;
	
	//protected Integer iXPanelCamposOcultosPronun=0;
	//protected Integer iYPanelCamposOcultosPronun=0;
	...
	public JPanel pnl_id_tipo_grammar;
	public JLabel lbl_id_tipo_grammar;
	public JComboBoxMe cmb_id_tipo_grammar;
	public JButton btn_id_tipo_grammar= new JButton();
	public JButton btn_id_tipo_grammar_Update= new JButton();
	public JButton btn_id_tipo_grammar_Busqueda= new JButton();
	...
	public Pronun_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetallePronun=new JMenuBar();
				this.jTtoolBarDetallePronun=new JToolBar();
				*/
	  		}
	...
	public Pronun_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
		
		//super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Pronun_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Pronun_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Pronun_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Pronun No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Pronun_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPronun) {
		//this.jComboBoxTiposAccionesPronun = jComboBoxTiposAcciones;
	//}		
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.pronun_session.getEsGuardarRelacionado();				
		...
		Pronun_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Pronun_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Pronun_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Pronun MANTENIMIENTO"));
		...
		Pronun_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Pronun_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Pronun_util.LABEL_CODIGO+" : *","Codigo");
		FuncionesSwing.setLabelSize(this.lbl_codigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_codigo.setToolTipText(Pronun_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.pronun_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Pronun_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(Pronun_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+Pronun_util.LABEL_PRONUNCIACION+" : *","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(Pronun_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+Pronun_util.LABEL_DESCRIPCION+" :","Descripcion");
		FuncionesSwing.setLabelSize(this.lbl_descripcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_descripcion.setToolTipText(Pronun_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setTextAreaSize(txa_descripcion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		...
		FuncionesSwing.setScrollPaneSize(jscrollPane_descripcion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70);
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_nivel,""+Pronun_util.LABEL_IDNIVEL+" : *","Nivel");
		...
		this.pnl_id_nivel.setToolTipText(Pronun_util.LABEL_IDNIVEL);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelPronun"));
		...
		cmb_id_nivel.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_nivel.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_nivelPronunUpdate"));



					
		this.lbl_id_tipo_grammar = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar,""+Pronun_util.LABEL_IDTIPOGRAMMAR+" : *","Tipo Grammar");
		FuncionesSwing.setLabelSize(this.lbl_id_tipo_grammar,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_tipo_grammar,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_tipo_grammar,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_tipo_grammar=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_tipo_grammar.setToolTipText(Pronun_util.LABEL_IDTIPOGRAMMAR);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_tipo_grammar.setLayout(this.gridaBagLayout);


		cmb_id_tipo_grammar= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_tipo_grammar,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_tipo_grammar,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_tipo_grammar= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_grammar,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_tipo_grammar.setText("Buscar");
		this.btn_id_tipo_grammar.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_tipo_grammar.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_grammar,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_tipo_grammar.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammarPronun"));

		this.btn_id_tipo_grammar_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_grammar_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_tipo_grammar_Busqueda.setText("U");
		this.btn_id_tipo_grammar_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_tipo_grammar_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_grammar_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_tipo_grammar.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_Busqueda"));

		if(this.pronun_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_tipo_grammar_Busqueda.setVisible(false);		}

		this.btn_id_tipo_grammar_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_grammar_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_tipo_grammar_Update.setText("U");
		this.btn_id_tipo_grammar_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_tipo_grammar_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_grammar_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammarPronunUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Pronun_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Pronun DATOS");
		...
		String sToolTipPronun="";
		sToolTipPronun=Pronun_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipPronun+="(Gramatica.Pronun)";
		}
		
		if(!this.pronun_session.getEsGuardarRelacionado()) {
			sToolTipPronun+="_"+this.opcionActual.getId();
		}
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.pronun_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.pronun_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Pronun_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Pronun_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Pronun_util.S_CLASS_WEB_TITULO;
		...
		this.sPath=" <---> Acceso: Pronun";
		
		if(!this.pronun_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Pronunes" + this.sPath));
		} else {
		...
		*/
		...
		//this.jComboBoxTiposAccionesPronun = new JComboBoxMe();
				//this.jComboBoxTiposAccionesPronun.setText("Accion");
		//this.jComboBoxTiposAccionesPronun.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPronun,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPronun, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_tipo_grammar.add(lbl_id_tipo_grammar, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_id_tipo_grammar.add(btn_id_tipo_grammar_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,3,0,0,0);
		this.pnl_id_tipo_grammar.add(btn_id_tipo_grammar_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_tipo_grammar.add(cmb_id_tipo_grammar, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_tipo_grammar, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.pronun_session.getEsGuardarRelacionado()) {			
		...
		//if(PronunJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Pronun_controlJInternalFrameAdditional();//JInternalFrameBase("Pronun DATOS");
	        ...
	        //this.setTitle("[FOR] - Pronun DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Pronun Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Pronun_model pronunModel=new Pronun_model(this);
			
			//SI USARA CLASE INTERNA
			//PronunModel.PronunFocusTraversalPolicy pronunFocusTraversalPolicy = pronunModel.new PronunFocusTraversalPolicy(this);
			
			//pronunFocusTraversalPolicy.setpronunJInternalFrame(this);
			
			this.setFocusTraversalPolicy(pronunModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& pronun_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesPronun.setVisible(false);
	...
	public void cargarSessionConBeanSwingJFramePronunDetalle(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.pronundetalle_session.getEsGuardarRelacionado()) {
				...
				PronunDetalle_window.S_TIPO_TAMANIO_GENERAL=Pronun_window.S_TIPO_TAMANIO_GENERAL;
				PronunDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=Pronun_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarPronunDetalleBeanSwingJFrame(List<Pronun> pronuns,Pronun pronun,PronunDetalle_control_window pronundetalleBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					pronundetalleBeanSwingJFrame.getPronunDetalleLogic().setConnexion(this.pronunLogic.getConnexion());

					pronundetalleBeanSwingJFrame.setpronunsFK(pronuns);
					pronundetalleBeanSwingJFrame.setpronunFK(pronun);
					pronundetalleBeanSwingJFrame.pronundetalle_session.setisBusquedaDesdeFKSesionPronun(true);
					pronundetalleBeanSwingJFrame.pronundetalle_session.setlidPronunActual(pronun.getId());
					...
					pronundetalleBeanSwingJFrame.setVisibilidadBusquedasParaPronun(true);
					pronundetalleBeanSwingJFrame.setid_pronunFK_IdPronun(pronun.getId());

					if(!this.conCargarFormDetalle) {
						pronundetalleBeanSwingJFrame.inicializarFormDetalle();
					}

					pronundetalleBeanSwingJFrame.setSelectedItemCombosFramePronunFK(pronun,1,false,true,true);
					pronundetalleBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					pronundetalleBeanSwingJFrame.procesarBusqueda("FK_IdPronun");
					pronundetalleBeanSwingJFrame.setsAccionBusqueda("FK_IdPronun");
	...
	*/
	...
	public interface Pronun_form_windowI {	
