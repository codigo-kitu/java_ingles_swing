...
*/
package com.bydan.ingles.gramatica.grammardetalle.presentation.web.jsf.sessionbean;
...
public class GrammarDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionGrammar=false;
	public Long lidGrammarActual=0L;
	...
	public GrammarDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionGrammar=false;
		//this.lidGrammarActual=0L;
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("GrammarDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionGrammar() {
		return isBusquedaDesdeFKSesionGrammar;
	}

	public void setisBusquedaDesdeFKSesionGrammar(
		Boolean isBusquedaDesdeFKSesionGrammar) {
		this.isBusquedaDesdeFKSesionGrammar = isBusquedaDesdeFKSesionGrammar;
	}

	public Long getlidGrammarActual() {
		return lidGrammarActual;
	}

	public void setlidGrammarActual(Long lidGrammarActual) {
		this.lidGrammarActual = lidGrammarActual;
	}
