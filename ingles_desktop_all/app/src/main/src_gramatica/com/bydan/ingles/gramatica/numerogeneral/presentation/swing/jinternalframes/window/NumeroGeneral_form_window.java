...
public class NumeroGeneral_form_window extends JInternalFrameBase {	
	...
	//public NumeroGeneral_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposNumeroGeneral=0;
	//protected Integer iYPanelCamposNumeroGeneral=0;
	
	//protected Integer iXPanelCamposOcultosNumeroGeneral=0;
	//protected Integer iYPanelCamposOcultosNumeroGeneral=0;
	...
	public JPanel pnl_numero;
	public JLabel lbl_numero;
	public JTextField txf_numero;
	public JButton btn_numero_Busqueda= new JButton();
	...
	public JTextArea txa_pronunciacion;
	public JScrollPane jscrollPane_pronunciacion;
	...
	public NumeroGeneral_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleNumeroGeneral=new JMenuBar();
				this.jTtoolBarDetalleNumeroGeneral=new JToolBar();
				*/
	  		}
	...
	public NumeroGeneral_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public NumeroGeneral_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public NumeroGeneral_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public NumeroGeneral_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public NumeroGeneral_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesNumeroGeneral) {
		//this.jComboBoxTiposAccionesNumeroGeneral = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(NumeroGeneral_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_numero,""+NumeroGeneral_util.LABEL_NUMERO+" : *","Numero");
		FuncionesSwing.setLabelSize(this.lbl_numero,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_numero,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_numero,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_numero=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_numero.setToolTipText(NumeroGeneral_util.LABEL_NUMERO);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_numero.setLayout(this.gridaBagLayout);


		txf_numero= new JTextField();

		txf_numero.setEnabled(false);
		FuncionesSwing.setTextFieldSize(txf_numero,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_numero,this.sTipoTamanioGeneral,false,false,this);

		this.btn_numero_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_numero_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_numero_Busqueda.setText("U");
		this.btn_numero_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_numero_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_numero_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		txf_numero.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		txf_numero.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"numero_Busqueda"));

		if(this.numerogeneral_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_numero_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+NumeroGeneral_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(NumeroGeneral_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+NumeroGeneral_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(NumeroGeneral_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+NumeroGeneral_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(NumeroGeneral_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_pronunciacion.setLayout(this.gridaBagLayout);


		txa_pronunciacion= new JTextArea();
		txa_pronunciacion.setEnabled(false);
		FuncionesSwing.setTextAreaSize(txa_pronunciacion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		txa_pronunciacion.setLineWrap(true);
		txa_pronunciacion.setWrapStyleWord(true);
		txa_pronunciacion.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
		txa_pronunciacion.setRows(3);

		FuncionesSwing.setBoldTextArea(txa_pronunciacion,this.sTipoTamanioGeneral,false,false,this);

		jscrollPane_pronunciacion = new JScrollPane(txa_pronunciacion);
		FuncionesSwing.setScrollPaneSize(jscrollPane_pronunciacion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70);
		...
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		txa_pronunciacion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		txa_pronunciacion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"pronunciacion_Busqueda"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new NumeroGeneral_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Numero General DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.numerogeneral_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.numerogeneral_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=NumeroGeneral_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=NumeroGeneral_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=NumeroGeneral_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesNumeroGeneral = new JComboBoxMe();
				//this.jComboBoxTiposAccionesNumeroGeneral.setText("Accion");
		//this.jComboBoxTiposAccionesNumeroGeneral.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesNumeroGeneral,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesNumeroGeneral, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_numero.add(lbl_numero, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Boton_Busqueda
		...
		this.pnl_numero.add(btn_numero_Busqueda, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_numero.add(txf_numero, this.gridBagConstraints);
	...
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_pronunciacion.add(jscrollPane_pronunciacion, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_numero, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(NumeroGeneralJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new NumeroGeneral_controlJInternalFrameAdditional();//JInternalFrameBase("Numero General DATOS");
	        ...
	        //this.setTitle("[FOR] - Numero General DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Numero General Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			NumeroGeneral_model numerogeneralModel=new NumeroGeneral_model(this);
			
			//SI USARA CLASE INTERNA
			//NumeroGeneralModel.NumeroGeneralFocusTraversalPolicy numerogeneralFocusTraversalPolicy = numerogeneralModel.new NumeroGeneralFocusTraversalPolicy(this);
			
			//numerogeneralFocusTraversalPolicy.setnumerogeneralJInternalFrame(this);
			
			this.setFocusTraversalPolicy(numerogeneralModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& numerogeneral_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesNumeroGeneral.setVisible(false);
	...
	*/
	...
	public interface NumeroGeneral_form_windowI {	
