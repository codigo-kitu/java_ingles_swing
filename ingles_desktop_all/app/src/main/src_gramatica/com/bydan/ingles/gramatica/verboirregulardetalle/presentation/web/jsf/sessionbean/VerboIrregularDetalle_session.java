...
*/
package com.bydan.ingles.gramatica.verboirregulardetalle.presentation.web.jsf.sessionbean;
...
public class VerboIrregularDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionVerboIrregular=false;
	public Long lidVerboIrregularActual=0L;
	...
	public VerboIrregularDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionVerboIrregular=false;
		//this.lidVerboIrregularActual=0L;
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("VerboIrregularDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionVerboIrregular() {
		return isBusquedaDesdeFKSesionVerboIrregular;
	}

	public void setisBusquedaDesdeFKSesionVerboIrregular(
		Boolean isBusquedaDesdeFKSesionVerboIrregular) {
		this.isBusquedaDesdeFKSesionVerboIrregular = isBusquedaDesdeFKSesionVerboIrregular;
	}

	public Long getlidVerboIrregularActual() {
		return lidVerboIrregularActual;
	}

	public void setlidVerboIrregularActual(Long lidVerboIrregularActual) {
		this.lidVerboIrregularActual = lidVerboIrregularActual;
	}
