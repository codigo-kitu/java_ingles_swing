...
public class VerboIrregularDetalle_window extends JInternalFrameBase {	
	...
	public VerboIrregularDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_FK_IdVerboIrregular;
	public JButton btn_FK_IdVerboIrregular;
	...
	public JPanel pnlid_verbo_irregularFK_IdVerboIrregular;
	public JLabel lbl_id_verbo_irregularFK_IdVerboIrregular;
	public JComboBoxMe cmb_id_verbo_irregularFK_IdVerboIrregular;
	public JButton btn_id_verbo_irregularFK_IdVerboIrregular= new JButton();
	public JButton btn_id_verbo_irregularFK_IdVerboIrregular_Update= new JButton();
	public JButton btn_id_verbo_irregularFK_IdVerboIrregular_Busqueda= new JButton();
	...
	*/
	...
	public VerboIrregularDetalle_window() throws Exception {
	...
	public VerboIrregularDetalle_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public VerboIrregularDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboIrregularDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public VerboIrregularDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("VerboIrregularDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<VerboIrregularDetalle> getverboirregulardetallesAux() {
		return this.verboirregulardetallesAux;
	}

	public void setverboirregulardetallesAux(List<VerboIrregularDetalle> verboirregulardetallesAux) {
		this.verboirregulardetallesAux = verboirregulardetallesAux;
	}
	
	public List<VerboIrregularDetalle> getverboirregulardetallesEliminados() {
		return this.verboirregulardetallesEliminados;
	}

	public void setVerboIrregularDetallesEliminados(List<VerboIrregularDetalle> verboirregulardetallesEliminados) {
		this.verboirregulardetallesEliminados = verboirregulardetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoVerboIrregularDetalle) {
	//	this.jCheckBoxConGraficoDinamicoVerboIrregularDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoVerboIrregularDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=VerboIrregularDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=VerboIrregularDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdVerboIrregular=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdVerboIrregular.setToolTipText("Buscar Por Verbo Irregular ");
		this.btn_FK_IdVerboIrregular= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdVerboIrregular,"buscar_button","Buscar","Buscar Por Verbo Irregular ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdVerboIrregular, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdVerboIrregular, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_verbo_irregularFK_IdVerboIrregular = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_verbo_irregularFK_IdVerboIrregular,"Verbo Irregular :","Verbo Irregular");
		FuncionesSwing.setLabelSize(lbl_id_verbo_irregularFK_IdVerboIrregular,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL2);

		FuncionesSwing.setBoldLabel(lbl_id_verbo_irregularFK_IdVerboIrregular,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_verbo_irregularFK_IdVerboIrregular,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_verbo_irregularFK_IdVerboIrregular= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_verbo_irregularFK_IdVerboIrregular,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_verbo_irregularFK_IdVerboIrregular,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new VerboIrregularDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Verbo Irregular Detalle DATOS");
			//_form
			this.jFrameDetalleForm = new VerboIrregularDetalle_form_window(jDesktopPane,this.verboirregulardetalle_session.getConGuardarRelaciones(),this.verboirregulardetalle_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new VerboIrregularDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//VerboIrregularDetalle
		...
		this.tableDatos.setToolTipText(sToolTipVerboIrregularDetalle);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboIrregularDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByVerboIrregularDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"VerboIrregularDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.verboirregulardetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"VerboIrregularDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"VerboIrregularDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+VerboIrregularDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+VerboIrregularDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(VerboIrregularDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosVerboIrregularDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosVerboIrregularDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoVerboIrregularDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipoGrammarDetalle.setLayout(gridaBagLayoutFK_IdTipoGrammarDetalleVerboIrregularDetalle);
		...
		GridBagLayout gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdVerboIrregular.setLayout(gridaBagLayoutFK_IdVerboIrregularVerboIrregularDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdVerboIrregular.add(lbl_id_verbo_irregularFK_IdVerboIrregular, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdVerboIrregular.add(cmb_id_verbo_irregularFK_IdVerboIrregular, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdVerboIrregular.add(btn_FK_IdVerboIrregular, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Verbo Irregular ", pnl_FK_IdVerboIrregular);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.verboirregulardetalle_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.verboirregulardetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//VerboIrregularDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.verboirregulardetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > VerboIrregularDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboIrregularDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboIrregularDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboIrregularDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > VerboIrregularDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=VerboIrregularDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < VerboIrregularDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=VerboIrregularDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<VerboIrregularDetalle> TraerBeans(List<VerboIrregularDetalle> verboirregulardetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(VerboIrregularDetalle verboirregulardetalle:verboirregulardetalles) {
					
				if(!(VerboIrregularDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || VerboIrregularDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					verboirregulardetalle.setsDetalleGeneralEntityReporte(VerboIrregularDetalle_util.getVerboIrregularDetalleDescripcion(verboirregulardetalle));
					...
					//verboirregulardetalle.setsDetalleGeneralEntityReporte(verboirregulardetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//verboirregulardetallebeans.add(verboirregulardetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface VerboIrregularDetalle_windowI {	
