...
public class PronunDetalle_form_window extends JInternalFrameBase {	
	...
	//public PronunDetalle_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposPronunDetalle=0;
	//protected Integer iYPanelCamposPronunDetalle=0;
	
	//protected Integer iXPanelCamposOcultosPronunDetalle=0;
	//protected Integer iYPanelCamposOcultosPronunDetalle=0;
	...
	public JPanel pnl_id_pronun;
	public JLabel lbl_id_pronun;
	public JComboBoxMe cmb_id_pronun;
	public JButton btn_id_pronun= new JButton();
	public JButton btn_id_pronun_Update= new JButton();
	public JButton btn_id_pronun_Busqueda= new JButton();
	...
	public PronunDetalle_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetallePronunDetalle=new JMenuBar();
				this.jTtoolBarDetallePronunDetalle=new JToolBar();
				*/
	  		}
	...
	public PronunDetalle_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public PronunDetalle_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public PronunDetalle_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PronunDetalle_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronunDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PronunDetalle_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPronunDetalle) {
		//this.jComboBoxTiposAccionesPronunDetalle = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(PronunDetalle_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_idea,""+PronunDetalle_util.LABEL_IDEA+" : *","Idea");
		...
		this.pnl_idea.setToolTipText(PronunDetalle_util.LABEL_IDEA);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.pronundetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_idea_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+PronunDetalle_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(PronunDetalle_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+PronunDetalle_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(PronunDetalle_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+PronunDetalle_util.LABEL_DESCRIPCION+" :","Descripcion");
		...
		this.pnl_descripcion.setToolTipText(PronunDetalle_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		this.lbl_id_pronun = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_pronun,""+PronunDetalle_util.LABEL_IDPRONUN+" : *","Pronun");
		FuncionesSwing.setLabelSize(this.lbl_id_pronun,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_pronun,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_pronun,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_pronun=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_pronun.setToolTipText(PronunDetalle_util.LABEL_IDPRONUN);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_pronun.setLayout(this.gridaBagLayout);


		cmb_id_pronun= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_pronun,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_pronun,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_pronun= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_pronun,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_pronun.setText("Buscar");
		this.btn_id_pronun.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_pronun.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_pronun,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_pronun.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_pronun.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_pronunPronunDetalle"));

		this.btn_id_pronun_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_pronun_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_pronun_Busqueda.setText("U");
		this.btn_id_pronun_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_pronun_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_pronun_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_pronun.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_pronun.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_pronun_Busqueda"));

		if(this.pronundetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_pronun_Busqueda.setVisible(false);		}

		this.btn_id_pronun_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_pronun_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_pronun_Update.setText("U");
		this.btn_id_pronun_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_pronun_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_pronun_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_pronun.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_pronun.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_pronunPronunDetalleUpdate"));



					
		this.lbl_id_tipo_grammar_detalle = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar_detalle,""+PronunDetalle_util.LABEL_IDTIPOGRAMMARDETALLE+" : *","Tipo Grammar Detalle");
		...
		this.pnl_id_tipo_grammar_detalle.setToolTipText(PronunDetalle_util.LABEL_IDTIPOGRAMMARDETALLE);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detallePronunDetalle"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar_detalle.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detallePronunDetalleUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new PronunDetalle_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Pronun Detalle DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.pronundetalle_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.pronundetalle_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=PronunDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=PronunDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=PronunDetalle_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesPronunDetalle = new JComboBoxMe();
				//this.jComboBoxTiposAccionesPronunDetalle.setText("Accion");
		//this.jComboBoxTiposAccionesPronunDetalle.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPronunDetalle,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPronunDetalle, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_pronun.add(lbl_id_pronun, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.pnl_id_pronun.add(btn_id_pronun_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.pnl_id_pronun.add(btn_id_pronun_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_pronun.add(cmb_id_pronun, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_pronun, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(PronunDetalleJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new PronunDetalle_controlJInternalFrameAdditional();//JInternalFrameBase("Pronun Detalle DATOS");
	        ...
	        //this.setTitle("[FOR] - Pronun Detalle DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Pronun Detalle Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			PronunDetalle_model pronundetalleModel=new PronunDetalle_model(this);
			
			//SI USARA CLASE INTERNA
			//PronunDetalleModel.PronunDetalleFocusTraversalPolicy pronundetalleFocusTraversalPolicy = pronundetalleModel.new PronunDetalleFocusTraversalPolicy(this);
			
			//pronundetalleFocusTraversalPolicy.setpronundetalleJInternalFrame(this);
			
			this.setFocusTraversalPolicy(pronundetalleModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& pronundetalle_session.getConGuardarRelaciones()
						) {
					//paraCargarPorParte es false por defecto(y ejecuta funcion normal cargando detalle en tab panel), si se utiliza funcionalidad es true y carga tab panel auxiliar temporal
					
					
					if(this.pronundetalle_session.getConGuardarRelaciones()) {
						this.gridBagConstraints= new GridBagConstraints();
						GridXy.SetGridBagProp(this.gridBagConstraints,0,gxy.iGridyRelaciones++);
					...
					;
						...
						//this.jButtonNuevoRelacionesPronunDetalle.setVisible(false);
	...
	*/
	...
	public interface PronunDetalle_form_windowI {	
