...
public class PaisGeneral_form_window extends JInternalFrameBase {	
	...
	//public PaisGeneral_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposPaisGeneral=0;
	//protected Integer iYPanelCamposPaisGeneral=0;
	
	//protected Integer iXPanelCamposOcultosPaisGeneral=0;
	//protected Integer iYPanelCamposOcultosPaisGeneral=0;
	...
	public JPanel pnl_nacionalidad;
	public JLabel lbl_nacionalidad;
	public JTextField txf_nacionalidad;
	public JButton btn_nacionalidad_Busqueda= new JButton();
	...
	public PaisGeneral_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetallePaisGeneral=new JMenuBar();
				this.jTtoolBarDetallePaisGeneral=new JToolBar();
				*/
	  		}
	...
	public PaisGeneral_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public PaisGeneral_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public PaisGeneral_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PaisGeneral_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PaisGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPaisGeneral) {
		//this.jComboBoxTiposAccionesPaisGeneral = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(PaisGeneral_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+PaisGeneral_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(PaisGeneral_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.paisgeneral_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_nombre_Busqueda.setVisible(false);		}


					
		this.lbl_nacionalidad = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nacionalidad,""+PaisGeneral_util.LABEL_NACIONALIDAD+" : *","Nacionalidad");
		FuncionesSwing.setLabelSize(this.lbl_nacionalidad,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_nacionalidad,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_nacionalidad,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_nacionalidad=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_nacionalidad.setToolTipText(PaisGeneral_util.LABEL_NACIONALIDAD);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_nacionalidad.setLayout(this.gridaBagLayout);


		txf_nacionalidad= new JTextField();

		txf_nacionalidad.setEnabled(false);
		FuncionesSwing.setTextFieldSize(txf_nacionalidad,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_nacionalidad,this.sTipoTamanioGeneral,false,false,this);

		this.btn_nacionalidad_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_nacionalidad_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_nacionalidad_Busqueda.setText("U");
		this.btn_nacionalidad_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_nacionalidad_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_nacionalidad_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		txf_nacionalidad.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		txf_nacionalidad.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"nacionalidad_Busqueda"));

		if(this.paisgeneral_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_nacionalidad_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+PaisGeneral_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(PaisGeneral_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+PaisGeneral_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(PaisGeneral_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new PaisGeneral_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Pais General DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.paisgeneral_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.paisgeneral_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=PaisGeneral_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=PaisGeneral_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=PaisGeneral_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesPaisGeneral = new JComboBoxMe();
				//this.jComboBoxTiposAccionesPaisGeneral.setText("Accion");
		//this.jComboBoxTiposAccionesPaisGeneral.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPaisGeneral,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPaisGeneral, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_nacionalidad.add(lbl_nacionalidad, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Boton_Busqueda
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_nacionalidad.add(btn_nacionalidad_Busqueda, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_nacionalidad.add(txf_nacionalidad, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_nacionalidad, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(PaisGeneralJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new PaisGeneral_controlJInternalFrameAdditional();//JInternalFrameBase("Pais General DATOS");
	        ...
	        //this.setTitle("[FOR] - Pais General DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Pais General Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			PaisGeneral_model paisgeneralModel=new PaisGeneral_model(this);
			
			//SI USARA CLASE INTERNA
			//PaisGeneralModel.PaisGeneralFocusTraversalPolicy paisgeneralFocusTraversalPolicy = paisgeneralModel.new PaisGeneralFocusTraversalPolicy(this);
			
			//paisgeneralFocusTraversalPolicy.setpaisgeneralJInternalFrame(this);
			
			this.setFocusTraversalPolicy(paisgeneralModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& paisgeneral_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesPaisGeneral.setVisible(false);
	...
	*/
	...
	public interface PaisGeneral_form_windowI {	
