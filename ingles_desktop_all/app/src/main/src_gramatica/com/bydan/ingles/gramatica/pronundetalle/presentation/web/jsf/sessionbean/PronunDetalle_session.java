...
*/
package com.bydan.ingles.gramatica.pronundetalle.presentation.web.jsf.sessionbean;
...
public class PronunDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionPronun=false;
	public Long lidPronunActual=0L;
	...
	public PronunDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionPronun=false;
		//this.lidPronunActual=0L;
	...
	public PronunDetalle getPronunDetalle() {
		return this.pronundetalle;	
	}
	
	public void setPronunDetalle(PronunDetalle pronundetalle) {
		this.pronundetalle=pronundetalle;	
	}
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("PronunDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionPronun() {
		return isBusquedaDesdeFKSesionPronun;
	}

	public void setisBusquedaDesdeFKSesionPronun(
		Boolean isBusquedaDesdeFKSesionPronun) {
		this.isBusquedaDesdeFKSesionPronun = isBusquedaDesdeFKSesionPronun;
	}

	public Long getlidPronunActual() {
		return lidPronunActual;
	}

	public void setlidPronunActual(Long lidPronunActual) {
		this.lidPronunActual = lidPronunActual;
	}
