...
*/
package com.bydan.ingles.gramatica.grammar.presentation.web.jsf.sessionbean;
...
public class Grammar_session  extends GeneralEntitySessionBean {
	...
	public Grammar_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Grammar:Valor nulo no permitido en columna id");
					}
				}
