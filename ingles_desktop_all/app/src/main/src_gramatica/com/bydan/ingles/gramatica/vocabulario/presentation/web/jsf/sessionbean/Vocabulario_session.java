...
*/
package com.bydan.ingles.gramatica.vocabulario.presentation.web.jsf.sessionbean;
...
public class Vocabulario_session  extends GeneralEntitySessionBean {
	...
	public Vocabulario_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Vocabulario:Valor nulo no permitido en columna id");
					}
				}
