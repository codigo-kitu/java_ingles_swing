...
public class PronombreObjeto_window extends JInternalFrameBase {	
	...
	public PronombreObjeto_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public PronombreObjeto_window() throws Exception {
	...
	public PronombreObjeto_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public PronombreObjeto_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronombreObjeto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PronombreObjeto_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PronombreObjeto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<PronombreObjeto> getpronombreobjetos() {
		return this.pronombreobjetos;
	}

	public void setpronombreobjetos(List<PronombreObjeto> pronombreobjetos) {
		this.pronombreobjetos = pronombreobjetos;
	}
	
	public List<PronombreObjeto> getpronombreobjetosAux() {
		return this.pronombreobjetosAux;
	}

	public void setpronombreobjetosAux(List<PronombreObjeto> pronombreobjetosAux) {
		this.pronombreobjetosAux = pronombreobjetosAux;
	}
	
	public List<PronombreObjeto> getpronombreobjetosEliminados() {
		return this.pronombreobjetosEliminados;
	}

	public void setPronombreObjetosEliminados(List<PronombreObjeto> pronombreobjetosEliminados) {
		this.pronombreobjetosEliminados = pronombreobjetosEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoPronombreObjeto) {
	//	this.jCheckBoxConGraficoDinamicoPronombreObjeto = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoPronombreObjeto.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=PronombreObjeto_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PronombreObjeto_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PronombreObjetoDetalle_window(paginaTipo);//JInternalFrameBase("Pronombre Objeto DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new PronombreObjeto_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PronombreObjeto
		...
		this.tableDatos.setToolTipText(sToolTipPronombreObjeto);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronombreObjeto,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPronombreObjeto,true,this);
		...
		//VALORES PARA DISENO
		/*
		this.tableDatos.setMinimumSize(new Dimension(400,50));//2330
		this.tableDatos.setMaximumSize(new Dimension(400,50));//2330
		this.tableDatos.setPreferredSize(new Dimension(400,50));//2330
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PronombreObjeto",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.pronombreobjeto_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PronombreObjeto",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PronombreObjeto",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PronombreObjeto_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PronombreObjeto_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PronombreObjetoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronombreObjetoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PronombreObjetoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronombreObjetoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PronombreObjetoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PronombreObjetoBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosPronombreObjeto = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPronombreObjeto);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPronombreObjeto, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.pronombreobjeto_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.pronombreobjeto_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PronombreObjeto_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.pronombreobjeto_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PronombreObjeto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PronombreObjeto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PronombreObjeto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PronombreObjeto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PronombreObjeto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PronombreObjeto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PronombreObjeto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PronombreObjeto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PronombreObjeto> TraerBeans(List<PronombreObjeto> pronombreobjetos,ArrayList<Classe> classes)throws Exception {
		try {
			for(PronombreObjeto pronombreobjeto:pronombreobjetos) {
					
				if(!(PronombreObjeto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PronombreObjeto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					pronombreobjeto.setsDetalleGeneralEntityReporte(PronombreObjeto_util.getPronombreObjetoDescripcion(pronombreobjeto));
					...
					//pronombreobjeto.setsDetalleGeneralEntityReporte(pronombreobjeto.getsDetalleGeneralEntityReporte());
										
				}
				
				//pronombreobjetobeans.add(pronombreobjetobean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface PronombreObjeto_windowI {	
