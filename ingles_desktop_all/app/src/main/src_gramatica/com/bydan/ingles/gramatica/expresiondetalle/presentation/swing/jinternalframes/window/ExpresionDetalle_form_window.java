...
public class ExpresionDetalle_form_window extends JInternalFrameBase {	
	...
	//public ExpresionDetalle_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposExpresionDetalle=0;
	//protected Integer iYPanelCamposExpresionDetalle=0;
	
	//protected Integer iXPanelCamposOcultosExpresionDetalle=0;
	//protected Integer iYPanelCamposOcultosExpresionDetalle=0;
	...
	public JPanel pnl_id_expresion;
	public JLabel lbl_id_expresion;
	public JComboBoxMe cmb_id_expresion;
	public JButton btn_id_expresion= new JButton();
	public JButton btn_id_expresion_Update= new JButton();
	public JButton btn_id_expresion_Busqueda= new JButton();
	...
	public ExpresionDetalle_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleExpresionDetalle=new JMenuBar();
				this.jTtoolBarDetalleExpresionDetalle=new JToolBar();
				*/
	  		}
	...
	public ExpresionDetalle_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public ExpresionDetalle_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public ExpresionDetalle_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ExpresionDetalle_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ExpresionDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ExpresionDetalle_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesExpresionDetalle) {
		//this.jComboBoxTiposAccionesExpresionDetalle = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(ExpresionDetalle_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_idea,""+ExpresionDetalle_util.LABEL_IDEA+" : *","Idea");
		...
		this.pnl_idea.setToolTipText(ExpresionDetalle_util.LABEL_IDEA);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.expresiondetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_idea_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+ExpresionDetalle_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(ExpresionDetalle_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+ExpresionDetalle_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(ExpresionDetalle_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+ExpresionDetalle_util.LABEL_DESCRIPCION+" :","Descripcion");
		...
		this.pnl_descripcion.setToolTipText(ExpresionDetalle_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		this.lbl_id_expresion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_expresion,""+ExpresionDetalle_util.LABEL_IDEXPRESION+" : *","Expresion");
		FuncionesSwing.setLabelSize(this.lbl_id_expresion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-4),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_expresion,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_expresion,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_expresion=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_expresion.setToolTipText(ExpresionDetalle_util.LABEL_IDEXPRESION);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_expresion.setLayout(this.gridaBagLayout);


		cmb_id_expresion= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_expresion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_expresion,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_expresion= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_expresion,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_expresion.setText("Buscar");
		this.btn_id_expresion.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_expresion.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_expresion,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_expresion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_expresion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_expresionExpresionDetalle"));

		this.btn_id_expresion_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_expresion_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_expresion_Busqueda.setText("U");
		this.btn_id_expresion_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_expresion_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_expresion_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_expresion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_expresion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_expresion_Busqueda"));

		if(this.expresiondetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_expresion_Busqueda.setVisible(false);		}

		this.btn_id_expresion_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_expresion_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_expresion_Update.setText("U");
		this.btn_id_expresion_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_expresion_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_expresion_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_expresion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_expresion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_expresionExpresionDetalleUpdate"));



					
		this.lbl_id_tipo_grammar_detalle = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_grammar_detalle,""+ExpresionDetalle_util.LABEL_IDTIPOGRAMMARDETALLE+" : *","Tipo Grammar Detalle");
		...
		this.pnl_id_tipo_grammar_detalle.setToolTipText(ExpresionDetalle_util.LABEL_IDTIPOGRAMMARDETALLE);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleExpresionDetalle"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_grammar_detalle.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_grammar_detalle.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_grammar_detalleExpresionDetalleUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new ExpresionDetalle_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Expresion Detalle DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.expresiondetalle_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.expresiondetalle_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=ExpresionDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=ExpresionDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=ExpresionDetalle_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesExpresionDetalle = new JComboBoxMe();
				//this.jComboBoxTiposAccionesExpresionDetalle.setText("Accion");
		//this.jComboBoxTiposAccionesExpresionDetalle.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesExpresionDetalle,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesExpresionDetalle, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_expresion.add(lbl_id_expresion, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.pnl_id_expresion.add(btn_id_expresion_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.pnl_id_expresion.add(btn_id_expresion_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_expresion.add(cmb_id_expresion, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_expresion, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(ExpresionDetalleJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new ExpresionDetalle_controlJInternalFrameAdditional();//JInternalFrameBase("Expresion Detalle DATOS");
	        ...
	        //this.setTitle("[FOR] - Expresion Detalle DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Expresion Detalle Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			ExpresionDetalle_model expresiondetalleModel=new ExpresionDetalle_model(this);
			
			//SI USARA CLASE INTERNA
			//ExpresionDetalleModel.ExpresionDetalleFocusTraversalPolicy expresiondetalleFocusTraversalPolicy = expresiondetalleModel.new ExpresionDetalleFocusTraversalPolicy(this);
			
			//expresiondetalleFocusTraversalPolicy.setexpresiondetalleJInternalFrame(this);
			
			this.setFocusTraversalPolicy(expresiondetalleModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& expresiondetalle_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesExpresionDetalle.setVisible(false);
	...
	*/
	...
	public interface ExpresionDetalle_form_windowI {	
