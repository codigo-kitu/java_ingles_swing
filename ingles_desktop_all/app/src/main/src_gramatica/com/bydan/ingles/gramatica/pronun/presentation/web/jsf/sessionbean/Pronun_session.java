...
*/
package com.bydan.ingles.gramatica.pronun.presentation.web.jsf.sessionbean;
...
public class Pronun_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionTipoGrammar=false;
	public Long lidTipoGrammarActual=0L;
	...
	public Pronun_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionTipoGrammar=false;
		//this.lidTipoGrammarActual=0L; 
		//FOREIGN_KEY_FIN
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Pronun:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionTipoGrammar() {
		return isBusquedaDesdeFKSesionTipoGrammar;
	}

	public void setisBusquedaDesdeFKSesionTipoGrammar(
		Boolean isBusquedaDesdeFKSesionTipoGrammar) {
		this.isBusquedaDesdeFKSesionTipoGrammar = isBusquedaDesdeFKSesionTipoGrammar;
	}

	public Long getlidTipoGrammarActual() {
		return lidTipoGrammarActual;
	}

	public void setlidTipoGrammarActual(Long lidTipoGrammarActual) {
		this.lidTipoGrammarActual = lidTipoGrammarActual;
	}
