...
*/
package com.bydan.ingles.gramatica.numerogeneral.presentation.swing.jinternalframes.window;
...
public class NumeroGeneral_window extends JInternalFrameBase {	
	...
	public NumeroGeneral_form_window jFrameDetalleForm;//_form;		
	...
	public NumeroGeneral_session numerogeneral_session;
	...
	public JPanel pnl_BusquedaPorNumero;
	public JButton btn_BusquedaPorNumero;
	
	public JPanel pnlnumeroBusquedaPorNumero;
	public JLabel lbl_numeroBusquedaPorNumero;
	public JTextField txf_numeroBusquedaPorNumero;
	public JButton btn_numeroBusquedaPorNumero_Busqueda= new JButton();
	...
	*/
	...
	public NumeroGeneral_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public NumeroGeneral_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public NumeroGeneral_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public NumeroGeneral_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("NumeroGeneral No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<NumeroGeneral> getnumerogenerals() {
		return this.numerogenerals;
	}

	public void setnumerogenerals(List<NumeroGeneral> numerogenerals) {
		this.numerogenerals = numerogenerals;
	}
	
	public List<NumeroGeneral> getnumerogeneralsAux() {
		return this.numerogeneralsAux;
	}

	public void setnumerogeneralsAux(List<NumeroGeneral> numerogeneralsAux) {
		this.numerogeneralsAux = numerogeneralsAux;
	}
	
	public List<NumeroGeneral> getnumerogeneralsEliminados() {
		return this.numerogeneralsEliminados;
	}

	public void setNumeroGeneralsEliminados(List<NumeroGeneral> numerogeneralsEliminados) {
		this.numerogeneralsEliminados = numerogeneralsEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoNumeroGeneral) {
	//	this.jCheckBoxConGraficoDinamicoNumeroGeneral = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoNumeroGeneral.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		this.numerogeneral_session=new NumeroGeneral_session();
		
		this.numerogeneral_session.setConGuardarRelaciones(conGuardarRelaciones);
		this.numerogeneral_session.setEsGuardarRelacionado(esGuardarRelacionado);
		
		
		this.conCargarMinimo=this.numerogeneral_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=NumeroGeneral_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=NumeroGeneral_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		NumeroGeneral_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		NumeroGeneral_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		NumeroGeneral_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Numero General MANTENIMIENTO"));
		...
		NumeroGeneral_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorNumero=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorNumero.setToolTipText("Buscar Por Numero ");
		this.btn_BusquedaPorNumero= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorNumero,"buscar_button","Buscar","Buscar Por Numero ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorNumero, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorNumero, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_numeroBusquedaPorNumero = new JLabel();
		FuncionesSwing.setLabelProp(lbl_numeroBusquedaPorNumero,"Numero :","Numero");
		FuncionesSwing.setLabelSize(lbl_numeroBusquedaPorNumero,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_numeroBusquedaPorNumero,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_numeroBusquedaPorNumero,this.sTipoTamanioGeneral,false,true,this);

		txf_numeroBusquedaPorNumero= new JTextField();
		FuncionesSwing.setTextFieldSize(txf_numeroBusquedaPorNumero,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_numeroBusquedaPorNumero,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new NumeroGeneralDetalle_window(paginaTipo);//JInternalFrameBase("Numero General DATOS");
			//_form
			this.jFrameDetalleForm = new NumeroGeneral_form_window(jDesktopPane,this.numerogeneral_session.getConGuardarRelaciones(),this.numerogeneral_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new NumeroGeneral_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//NumeroGeneral
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipNumeroGeneral="";
		sToolTipNumeroGeneral=NumeroGeneral_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipNumeroGeneral+="(Gramatica.NumeroGeneral)";
		}
		
		if(!this.numerogeneral_session.getEsGuardarRelacionado()) {
			sToolTipNumeroGeneral+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipNumeroGeneral);
		...
		this.sPath=" <---> Acceso: Numero General";
		
		if(!this.numerogeneral_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Numero Generales" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByNumeroGeneral,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByNumeroGeneral,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"NumeroGeneral",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.numerogeneral_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"NumeroGeneral",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"NumeroGeneral",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+NumeroGeneral_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+NumeroGeneral_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),NumeroGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(NumeroGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),NumeroGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(NumeroGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),NumeroGeneralBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(NumeroGeneralBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosNumeroGeneral = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosNumeroGeneral);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoNumeroGeneral, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorNumeroNumeroGeneral= new GridBagLayout();
		gridaBagLayoutBusquedaPorNumeroNumeroGeneral.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNumeroNumeroGeneral.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNumeroNumeroGeneral.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNumeroNumeroGeneral.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNumero.setLayout(gridaBagLayoutBusquedaPorNumeroNumeroGeneral);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorNumero.add(lbl_numeroBusquedaPorNumero, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorNumero.add(txf_numeroBusquedaPorNumero, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorNumero.add(btn_BusquedaPorNumero, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Numero ", pnl_BusquedaPorNumero);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.numerogeneral_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(NumeroGeneral_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.numerogeneral_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//NumeroGeneral_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.numerogeneral_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > NumeroGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=NumeroGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < NumeroGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=NumeroGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > NumeroGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=NumeroGeneral_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < NumeroGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=NumeroGeneral_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	public void redimensionarTablaDatosConTamanio(int iTamanioFilaTabla) throws Exception {
		...
		if(Constantes.IS_USA_EJB_LOGIC_LAYER) {	
			iSizeTabla=numerogeneralLogic.getNumeroGenerals().size();
		} else if(Constantes.IS_USA_EJB_REMOTE || Constantes.IS_USA_EJB_HOME) {
			iSizeTabla=numerogenerals.size();
		}
		//ARCHITECTURE
	...
	//PARA REPORTES
	public static List<NumeroGeneral> TraerBeans(List<NumeroGeneral> numerogenerals,ArrayList<Classe> classes)throws Exception {
		try {
			for(NumeroGeneral numerogeneral:numerogenerals) {
					
				if(!(NumeroGeneral_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || NumeroGeneral_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					numerogeneral.setsDetalleGeneralEntityReporte(NumeroGeneral_util.getNumeroGeneralDescripcion(numerogeneral));
					...
					//numerogeneral.setsDetalleGeneralEntityReporte(numerogeneral.getsDetalleGeneralEntityReporte());
										
				}
				
				//numerogeneralbeans.add(numerogeneralbean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface NumeroGeneral_windowI {	
