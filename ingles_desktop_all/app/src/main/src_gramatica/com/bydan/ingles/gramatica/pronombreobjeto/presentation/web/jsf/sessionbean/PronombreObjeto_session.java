...
*/
package com.bydan.ingles.gramatica.pronombreobjeto.presentation.web.jsf.sessionbean;
...
public class PronombreObjeto_session  extends GeneralEntitySessionBean {
	...
	public PronombreObjeto_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("PronombreObjeto:Valor nulo no permitido en columna id");
					}
				}
