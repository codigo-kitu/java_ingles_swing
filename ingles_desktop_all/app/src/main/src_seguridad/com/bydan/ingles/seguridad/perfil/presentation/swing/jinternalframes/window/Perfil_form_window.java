...
public class Perfil_form_window extends JInternalFrameBase {	
	...
	//public Perfil_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public JPanel pnl_nombre2;
	public JLabel lbl_nombre2;
	public JTextArea txa_nombre2;
	public JScrollPane jscrollPane_nombre2;
	public JButton btn_nombre2_Busqueda= new JButton();
	...
	public Perfil_form_window(String sTipo) throws Exception {
	...
	public Perfil_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Perfil_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Perfil No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Perfil_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Perfil No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Perfil_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Perfil No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Perfil_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPerfil) {
		//this.jComboBoxTiposAccionesPerfil = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		FuncionesSwing.setLabelSize(lbl_Id,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id.setToolTipText(Perfil_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Perfil_util.LABEL_CODIGO+" : *","Codigo");
		FuncionesSwing.setLabelSize(this.lbl_codigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_codigo.setToolTipText(Perfil_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.perfil_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Perfil_util.LABEL_NOMBRE+" : *","Nombre");
		FuncionesSwing.setLabelSize(this.lbl_nombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_nombre.setToolTipText(Perfil_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		this.lbl_nombre2 = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre2,""+Perfil_util.LABEL_NOMBRE2+" : *","Nombre Alterno");
		FuncionesSwing.setLabelSize(this.lbl_nombre2,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_nombre2,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_nombre2,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_nombre2=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_nombre2.setToolTipText(Perfil_util.LABEL_NOMBRE2);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_nombre2.setLayout(this.gridaBagLayout);


		txa_nombre2= new JTextArea();
		txa_nombre2.setEnabled(false);
		txa_nombre2.setMinimumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0)));
		txa_nombre2.setMaximumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0)));
		txa_nombre2.setPreferredSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0)));
		txa_nombre2.setLineWrap(true);
		txa_nombre2.setWrapStyleWord(true);
		txa_nombre2.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
		txa_nombre2.setRows(12);

		FuncionesSwing.setBoldTextArea(txa_nombre2,this.sTipoTamanioGeneral,false,false,this);

		jscrollPane_nombre2 = new JScrollPane(txa_nombre2);
		jscrollPane_nombre2.setMinimumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70 + FuncionesSwing.getValorProporcion(70,0)));
		jscrollPane_nombre2.setMaximumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70 + FuncionesSwing.getValorProporcion(70,0)));
		jscrollPane_nombre2.setPreferredSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70 + FuncionesSwing.getValorProporcion(70,0)));

		this.btn_nombre2_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_nombre2_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_nombre2_Busqueda.setText("U");
		this.btn_nombre2_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_nombre2_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_nombre2_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		txa_nombre2.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		txa_nombre2.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"nombre2_Busqueda"));

		if(this.perfil_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_nombre2_Busqueda.setVisible(false);		}


					
		this.lbl_estado = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_estado,""+Perfil_util.LABEL_ESTADO+" : *","Estado");
		FuncionesSwing.setLabelSize(this.lbl_estado,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_estado.setToolTipText(Perfil_util.LABEL_ESTADO);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_sistema,""+Perfil_util.LABEL_IDSISTEMA+" : *","Sistema");
		FuncionesSwing.setLabelSize(this.lbl_id_sistema,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-30),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_sistema.setToolTipText(Perfil_util.LABEL_IDSISTEMA);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_sistema.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sistemaPerfil"));
		...
		cmb_id_sistema.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_sistema.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sistemaPerfilUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Perfil_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Perfil DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.perfil_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.perfil_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Perfil_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Perfil_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Perfil_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPerfil,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPerfil, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_nombre2.add(lbl_nombre2, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Boton_Busqueda
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_nombre2.add(btn_nombre2_Busqueda, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_nombre2.add(jscrollPane_nombre2, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_nombre2, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(PerfilJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Perfil_controlJInternalFrameAdditional();//JInternalFrameBase("Perfil DATOS");
			...
			Perfil_model perfilModel=new Perfil_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& perfil_session.getConGuardarRelaciones()
						) {
	...
	public void cargarSessionConBeanSwingJFramePerfilOpcion(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.perfilopcion_session.getEsGuardarRelacionado()) {
				...
				PerfilOpcion_window.S_TIPO_TAMANIO_GENERAL=Perfil_window.S_TIPO_TAMANIO_GENERAL;
				PerfilOpcion_window.S_TIPO_TAMANIO_GENERAL_TABLA=Perfil_window.S_TIPO_TAMANIO_GENERAL;
	...
	public void cargarSessionConBeanSwingJFramePerfilUsuario(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.perfilusuario_session.getEsGuardarRelacionado()) {
				...
				PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL=Perfil_window.S_TIPO_TAMANIO_GENERAL;
				PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL_TABLA=Perfil_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarPerfilOpcionBeanSwingJFrame(List<Perfil> perfils,Perfil perfil,PerfilOpcion_control_window perfilopcionBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					perfilopcionBeanSwingJFrame.getPerfilOpcionLogic().setConnexion(this.perfilLogic.getConnexion());

					perfilopcionBeanSwingJFrame.setperfilsFK(perfils);
					perfilopcionBeanSwingJFrame.setperfilFK(perfil);
					perfilopcionBeanSwingJFrame.perfilopcion_session.setisBusquedaDesdeFKSesionPerfil(true);
					perfilopcionBeanSwingJFrame.perfilopcion_session.setlidPerfilActual(perfil.getId());
					...
					perfilopcionBeanSwingJFrame.setVisibilidadBusquedasParaPerfil(true);
					perfilopcionBeanSwingJFrame.setid_perfilFK_IdPerfil(perfil.getId());

					if(!this.conCargarFormDetalle) {
						perfilopcionBeanSwingJFrame.inicializarFormDetalle();
					}

					perfilopcionBeanSwingJFrame.setSelectedItemCombosFramePerfilFK(perfil,1,false,true,true);
					perfilopcionBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					perfilopcionBeanSwingJFrame.procesarBusqueda("FK_IdPerfil");
					perfilopcionBeanSwingJFrame.setsAccionBusqueda("FK_IdPerfil");
		...
		public void cargarPerfilUsuarioBeanSwingJFrame(List<Perfil> perfils,Perfil perfil,PerfilUsuario_control_window perfilusuarioBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					perfilusuarioBeanSwingJFrame.getPerfilUsuarioLogic().setConnexion(this.perfilLogic.getConnexion());

					perfilusuarioBeanSwingJFrame.setperfilsFK(perfils);
					perfilusuarioBeanSwingJFrame.setperfilFK(perfil);
					perfilusuarioBeanSwingJFrame.perfilusuario_session.setisBusquedaDesdeFKSesionPerfil(true);
					perfilusuarioBeanSwingJFrame.perfilusuario_session.setlidPerfilActual(perfil.getId());
					//NO VOLVER A RECARGAR FK, TALVEZ INICIALIZAR FK DEPENDENTES
					//Hijos Independientes, No carga Fk al inicializar, Hay que setisBusquedaDesdeFKSesion(true), luego cargar todos los Fks necesarios
					perfilusuarioBeanSwingJFrame.cargarCombosFK(perfilusuarioBeanSwingJFrame.isCargarCombosDependencia);
					perfilusuarioBeanSwingJFrame.setVisibilidadBusquedasParaPerfil(true);
					perfilusuarioBeanSwingJFrame.setid_perfilFK_IdPerfil(perfil.getId());

					if(!this.conCargarFormDetalle) {
						perfilusuarioBeanSwingJFrame.inicializarFormDetalle();
					}

					perfilusuarioBeanSwingJFrame.setSelectedItemCombosFramePerfilFK(perfil,1,false,true,true);
					perfilusuarioBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					perfilusuarioBeanSwingJFrame.procesarBusqueda("FK_IdPerfil");
					perfilusuarioBeanSwingJFrame.setsAccionBusqueda("FK_IdPerfil");
	...
	*/
	...
	public interface Perfil_form_windowI {	
