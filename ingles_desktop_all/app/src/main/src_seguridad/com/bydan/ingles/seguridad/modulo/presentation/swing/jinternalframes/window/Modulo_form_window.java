...
public class Modulo_form_window extends JInternalFrameBase {	
	...
	//public Modulo_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public JPanel pnl_tecla;
	public JLabel lbl_tecla;
	public JTextField txf_tecla;
	public JButton btn_tecla_Busqueda= new JButton();
	...
	public JPanel pnl_id_paquete;
	public JLabel lbl_id_paquete;
	public JComboBoxMe cmb_id_paquete;
	public JButton btn_id_paquete= new JButton();
	public JButton btn_id_paquete_Update= new JButton();
	public JButton btn_id_paquete_Busqueda= new JButton();

	public JPanel pnl_id_tipo_tecla_mascara;
	public JLabel lbl_id_tipo_tecla_mascara;
	public JComboBoxMe cmb_id_tipo_tecla_mascara;
	public JButton btn_id_tipo_tecla_mascara= new JButton();
	public JButton btn_id_tipo_tecla_mascara_Update= new JButton();
	public JButton btn_id_tipo_tecla_mascara_Busqueda= new JButton();
	...
	public Modulo_form_window(String sTipo) throws Exception {
	...
	public Modulo_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Modulo_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Modulo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Modulo_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Modulo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Modulo_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Modulo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesModulo) {
		//this.jComboBoxTiposAccionesModulo = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Modulo_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Modulo_util.LABEL_CODIGO+" : *","Codigo");
		FuncionesSwing.setLabelSize(this.lbl_codigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_codigo.setToolTipText(Modulo_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.modulo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Modulo_util.LABEL_NOMBRE+" : *","Nombre");
		FuncionesSwing.setLabelSize(this.lbl_nombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_nombre.setToolTipText(Modulo_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		this.lbl_tecla = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_tecla,""+Modulo_util.LABEL_TECLA+" : *","Tecla");
		FuncionesSwing.setLabelSize(this.lbl_tecla,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_tecla,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_tecla,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_tecla=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_tecla.setToolTipText(Modulo_util.LABEL_TECLA);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_tecla.setLayout(this.gridaBagLayout);


		txf_tecla= new JTextField();

		txf_tecla.setEnabled(false);
		FuncionesSwing.setTextFieldSize(txf_tecla,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_tecla,this.sTipoTamanioGeneral,false,false,this);

		this.btn_tecla_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_tecla_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_tecla_Busqueda.setText("U");
		this.btn_tecla_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_tecla_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_tecla_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		txf_tecla.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		txf_tecla.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"tecla_Busqueda"));

		if(this.modulo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_tecla_Busqueda.setVisible(false);		}


					
		this.lbl_estado = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_estado,""+Modulo_util.LABEL_ESTADO+" : *","Estado");
		FuncionesSwing.setLabelSize(this.lbl_estado,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_estado.setToolTipText(Modulo_util.LABEL_ESTADO);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_orden,""+Modulo_util.LABEL_ORDEN+" : *","Orden");
		FuncionesSwing.setLabelSize(this.lbl_orden,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_orden.setToolTipText(Modulo_util.LABEL_ORDEN);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+Modulo_util.LABEL_DESCRIPCION+" : *","Descripcion");
		FuncionesSwing.setLabelSize(this.lbl_descripcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_descripcion.setToolTipText(Modulo_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_sistema,""+Modulo_util.LABEL_IDSISTEMA+" : *","Sistema");
		FuncionesSwing.setLabelSize(this.lbl_id_sistema,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_sistema.setToolTipText(Modulo_util.LABEL_IDSISTEMA);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_sistema.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sistemaModulo"));
		...
		cmb_id_sistema.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_sistema.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_sistemaModuloUpdate"));



					
		this.lbl_id_paquete = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_paquete,""+Modulo_util.LABEL_IDPAQUETE+" : *","Paquete");
		FuncionesSwing.setLabelSize(this.lbl_id_paquete,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_paquete,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_paquete,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_paquete=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_paquete.setToolTipText(Modulo_util.LABEL_IDPAQUETE);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_paquete.setLayout(this.gridaBagLayout);


		cmb_id_paquete= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_paquete,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_paquete,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_paquete= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_paquete,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_paquete.setText("Buscar");
		this.btn_id_paquete.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_paquete.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_paquete,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_paquete.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_paquete.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_paqueteModulo"));

		this.btn_id_paquete_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_paquete_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_paquete_Busqueda.setText("U");
		this.btn_id_paquete_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_paquete_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_paquete_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_paquete.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_paquete.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_paquete_Busqueda"));

		if(this.modulo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_paquete_Busqueda.setVisible(false);		}

		this.btn_id_paquete_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_paquete_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_paquete_Update.setText("U");
		this.btn_id_paquete_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_paquete_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_paquete_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_paquete.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_paquete.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_paqueteModuloUpdate"));



					
		this.lbl_id_tipo_tecla_mascara = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_tipo_tecla_mascara,""+Modulo_util.LABEL_IDTIPOTECLAMASCARA+" : *","Tipo Tecla Mascara");
		FuncionesSwing.setLabelSize(this.lbl_id_tipo_tecla_mascara,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-13),Constantes2.I_SWING_ALTO_CONTROL_LABEL2 + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL2,0));

		FuncionesSwing.setBoldLabel(lbl_id_tipo_tecla_mascara,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_tipo_tecla_mascara,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_tipo_tecla_mascara=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_tipo_tecla_mascara.setToolTipText(Modulo_util.LABEL_IDTIPOTECLAMASCARA);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_tipo_tecla_mascara.setLayout(this.gridaBagLayout);


		cmb_id_tipo_tecla_mascara= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_tipo_tecla_mascara,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_tipo_tecla_mascara,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_tipo_tecla_mascara= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_tecla_mascara,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_tipo_tecla_mascara.setText("Buscar");
		this.btn_id_tipo_tecla_mascara.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_tipo_tecla_mascara.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_tecla_mascara,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_tipo_tecla_mascara.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_tecla_mascara.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_tecla_mascaraModulo"));

		this.btn_id_tipo_tecla_mascara_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_tecla_mascara_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_tipo_tecla_mascara_Busqueda.setText("U");
		this.btn_id_tipo_tecla_mascara_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_tipo_tecla_mascara_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_tecla_mascara_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_tipo_tecla_mascara.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_tecla_mascara.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_tecla_mascara_Busqueda"));

		if(this.modulo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_tipo_tecla_mascara_Busqueda.setVisible(false);		}

		this.btn_id_tipo_tecla_mascara_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_tipo_tecla_mascara_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_tipo_tecla_mascara_Update.setText("U");
		this.btn_id_tipo_tecla_mascara_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_tipo_tecla_mascara_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_tipo_tecla_mascara_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_tipo_tecla_mascara.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_tipo_tecla_mascara.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_tipo_tecla_mascaraModuloUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Modulo_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Modulo DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.modulo_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.modulo_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Modulo_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Modulo_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Modulo_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesModulo,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesModulo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_paquete.add(lbl_id_paquete, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_id_paquete.add(btn_id_paquete_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,3,0,0,0);
		this.pnl_id_paquete.add(btn_id_paquete_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_paquete.add(cmb_id_paquete, this.gridBagConstraints);
	...
	this.pnl_id_tipo_tecla_mascara.add(lbl_id_tipo_tecla_mascara, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_id_tipo_tecla_mascara.add(btn_id_tipo_tecla_mascara_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,3,0,0,0);
		this.pnl_id_tipo_tecla_mascara.add(btn_id_tipo_tecla_mascara_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_tipo_tecla_mascara.add(cmb_id_tipo_tecla_mascara, this.gridBagConstraints);
	...
	this.pnl_tecla.add(lbl_tecla, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Boton_Busqueda
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_tecla.add(btn_tecla_Busqueda, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_tecla.add(txf_tecla, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_paquete, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_tipo_tecla_mascara, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_tecla, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(ModuloJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Modulo_controlJInternalFrameAdditional();//JInternalFrameBase("Modulo DATOS");
			...
			Modulo_model moduloModel=new Modulo_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& modulo_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface Modulo_form_windowI {	
