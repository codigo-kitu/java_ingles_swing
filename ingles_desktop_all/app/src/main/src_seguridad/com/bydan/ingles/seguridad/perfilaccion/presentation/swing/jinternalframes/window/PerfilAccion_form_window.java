...
public class PerfilAccion_form_window extends JInternalFrameBase {	
	...
	//public PerfilAccion_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public JPanel pnl_ejecusion;
	public JLabel lbl_ejecusion;
	public JCheckBox chb_ejecusion;
	public JButton btn_ejecusion_Busqueda= new JButton();
	...
	public JPanel pnl_id_accion;
	public JLabel lbl_id_accion;
	public JComboBoxMe cmb_id_accion;
	public JButton btn_id_accion= new JButton();
	public JButton btn_id_accion_Update= new JButton();
	public JButton btn_id_accion_Busqueda= new JButton();
	...
	public PerfilAccion_form_window(String sTipo) throws Exception {
	...
	public PerfilAccion_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public PerfilAccion_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("PerfilAccion No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public PerfilAccion_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilAccion No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilAccion_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilAccion No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPerfilAccion) {
		//this.jComboBoxTiposAccionesPerfilAccion = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(PerfilAccion_util.LABEL_ID);
		...
		this.lbl_ejecusion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_ejecusion,""+PerfilAccion_util.LABEL_EJECUSION+" : *","Ejecusion");
		FuncionesSwing.setLabelSize(this.lbl_ejecusion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_ejecusion,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_ejecusion,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_ejecusion=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_ejecusion.setToolTipText(PerfilAccion_util.LABEL_EJECUSION);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_ejecusion.setLayout(this.gridaBagLayout);


		chb_ejecusion= new JCheckBox();
		chb_ejecusion.setEnabled(false);

		FuncionesSwing.setCheckBoxSize(chb_ejecusion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldCheckBox(chb_ejecusion,this.sTipoTamanioGeneral,false,false,this);

		this.btn_ejecusion_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_ejecusion_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_ejecusion_Busqueda.setText("U");
		this.btn_ejecusion_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_ejecusion_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_ejecusion_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		chb_ejecusion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		chb_ejecusion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"ejecusion_Busqueda"));

		if(this.perfilaccion_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_ejecusion_Busqueda.setVisible(false);		}


					
		this.lbl_estado = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_estado,""+PerfilAccion_util.LABEL_ESTADO+" : *","Estado");
		FuncionesSwing.setLabelSize(this.lbl_estado,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_estado.setToolTipText(PerfilAccion_util.LABEL_ESTADO);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_perfil,""+PerfilAccion_util.LABEL_IDPERFIL+" : *","Perfil");
		FuncionesSwing.setLabelSize(this.lbl_id_perfil,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_perfil.setToolTipText(PerfilAccion_util.LABEL_IDPERFIL);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_perfil.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_perfilPerfilAccion"));
		...
		cmb_id_perfil.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_perfil.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_perfilPerfilAccionUpdate"));



					
		this.lbl_id_accion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_accion,""+PerfilAccion_util.LABEL_IDACCION+" : *","Accion");
		FuncionesSwing.setLabelSize(this.lbl_id_accion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_accion,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_accion,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_accion=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_accion.setToolTipText(PerfilAccion_util.LABEL_IDACCION);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_accion.setLayout(this.gridaBagLayout);


		cmb_id_accion= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_accion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_accion,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_accion= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_accion,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_accion.setText("Buscar");
		this.btn_id_accion.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_accion.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_accion,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_accion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_accion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_accionPerfilAccion"));

		this.btn_id_accion_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_accion_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_accion_Busqueda.setText("U");
		this.btn_id_accion_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_accion_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_accion_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_accion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_accion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_accion_Busqueda"));

		if(this.perfilaccion_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_accion_Busqueda.setVisible(false);		}

		this.btn_id_accion_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_accion_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_accion_Update.setText("U");
		this.btn_id_accion_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_accion_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_accion_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_accion.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_accion.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_accionPerfilAccionUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new PerfilAccion_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Perfil Accion DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.perfilaccion_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.perfilaccion_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=PerfilAccion_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=PerfilAccion_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=PerfilAccion_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPerfilAccion,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPerfilAccion, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_accion.add(lbl_id_accion, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_id_accion.add(btn_id_accion_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,3,0,0,0);
		this.pnl_id_accion.add(btn_id_accion_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_accion.add(cmb_id_accion, this.gridBagConstraints);
	...
	this.pnl_ejecusion.add(lbl_ejecusion, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Boton_Busqueda
		...
		this.gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
		this.pnl_ejecusion.add(btn_ejecusion_Busqueda, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_ejecusion.add(chb_ejecusion, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_accion, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_ejecusion, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(PerfilAccionJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new PerfilAccion_controlJInternalFrameAdditional();//JInternalFrameBase("Perfil Accion DATOS");
			...
			PerfilAccion_model perfilaccionModel=new PerfilAccion_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& perfilaccion_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface PerfilAccion_form_windowI {	
