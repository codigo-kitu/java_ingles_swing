...
*/
package com.bydan.ingles.seguridad.historialcambioclave.presentation.swing.jinternalframes.window;
...
public class HistorialCambioClave_window extends JInternalFrameBase {	
	...
	public HistorialCambioClave_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public HistorialCambioClave_window() throws Exception {
	...
	public HistorialCambioClave_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("HistorialCambioClave No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public HistorialCambioClave_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("HistorialCambioClave No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoHistorialCambioClave = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.historialcambioclave_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=HistorialCambioClave_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=HistorialCambioClave_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		HistorialCambioClave_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		HistorialCambioClave_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		HistorialCambioClave_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		HistorialCambioClave_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorIdUsuarioPorFechaHora.setToolTipText("Buscar Por Usuario Por Fecha Hora ");
		this.btn_BusquedaPorIdUsuarioPorFechaHora= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorIdUsuarioPorFechaHora,"buscar_button","Buscar","Buscar Por Usuario Por Fecha Hora ");
		...
		FuncionesSwing.setLabelSize(lbl_id_usuarioBusquedaPorIdUsuarioPorFechaHora,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		FuncionesSwing.setLabelProp(lbl_fecha_horaBusquedaPorIdUsuarioPorFechaHora,"Fecha Hora :","Fecha Hora");
		FuncionesSwing.setLabelSize(lbl_fecha_horaBusquedaPorIdUsuarioPorFechaHora,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		FuncionesSwing.setLabelSize(lbl_id_usuarioFK_IdUsuario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new HistorialCambioClaveDetalle_window(paginaTipo);//JInternalFrameBase("Historial Cambio Clave DATOS");
			//_form
			this.jFrameDetalleForm = new HistorialCambioClave_form_window(jDesktopPane,this.historialcambioclave_session.getConGuardarRelaciones(),this.historialcambioclave_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new HistorialCambioClave_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//HistorialCambioClave
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipHistorialCambioClave="";
		sToolTipHistorialCambioClave=HistorialCambioClave_util.S_CLASS_WEB_TITULO;
		...
		this.tableDatos.setToolTipText(sToolTipHistorialCambioClave);
		...
		if(!this.historialcambioclave_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Historial Cambio Claves" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByHistorialCambioClave,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByHistorialCambioClave,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"HistorialCambioClave",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.historialcambioclave_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"HistorialCambioClave",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"HistorialCambioClave",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+HistorialCambioClave_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+HistorialCambioClave_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(HistorialCambioClaveBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosHistorialCambioClave);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoHistorialCambioClave, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_BusquedaPorIdUsuarioPorFechaHora.setLayout(gridaBagLayoutBusquedaPorIdUsuarioPorFechaHoraHistorialCambioClave);
		...
		jTabbedPaneBusquedas.addTab("1.-Por Usuario Por Fecha Hora ", pnl_BusquedaPorIdUsuarioPorFechaHora);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdUsuarioHistorialCambioClave= new GridBagLayout();
		gridaBagLayoutFK_IdUsuarioHistorialCambioClave.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdUsuarioHistorialCambioClave.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdUsuarioHistorialCambioClave.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdUsuarioHistorialCambioClave.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdUsuario.setLayout(gridaBagLayoutFK_IdUsuarioHistorialCambioClave);
		...
		jTabbedPaneBusquedas.addTab("2.-Por Usuario ", pnl_FK_IdUsuario);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.historialcambioclave_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.historialcambioclave_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//HistorialCambioClave_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.historialcambioclave_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > HistorialCambioClave_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=HistorialCambioClave_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < HistorialCambioClave_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=HistorialCambioClave_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > HistorialCambioClave_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=HistorialCambioClave_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < HistorialCambioClave_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=HistorialCambioClave_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<HistorialCambioClave> TraerBeans(List<HistorialCambioClave> historialcambioclaves,ArrayList<Classe> classes)throws Exception {
		try {
			for(HistorialCambioClave historialcambioclave:historialcambioclaves) {
					
				if(!(HistorialCambioClave_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || HistorialCambioClave_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					historialcambioclave.setsDetalleGeneralEntityReporte(HistorialCambioClave_util.getHistorialCambioClaveDescripcion(historialcambioclave));
	...
	/*
		public interface HistorialCambioClave_windowI {	
