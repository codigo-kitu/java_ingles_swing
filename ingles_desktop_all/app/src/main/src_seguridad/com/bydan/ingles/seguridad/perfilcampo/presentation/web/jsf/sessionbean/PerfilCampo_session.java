...
*/
package com.bydan.ingles.seguridad.perfilcampo.presentation.web.jsf.sessionbean;
...
public class PerfilCampo_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionCampo=false;
	public Long lidCampoActual=0L;
	...
	public PerfilCampo_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionCampo=false;
		//this.lidCampoActual=0L; 
		//FOREIGN_KEY_FIN
	...
	public Boolean getisBusquedaDesdeFKSesionCampo() {
		return isBusquedaDesdeFKSesionCampo;
	}

	public void setisBusquedaDesdeFKSesionCampo(
		Boolean isBusquedaDesdeFKSesionCampo) {
		this.isBusquedaDesdeFKSesionCampo = isBusquedaDesdeFKSesionCampo;
	}
