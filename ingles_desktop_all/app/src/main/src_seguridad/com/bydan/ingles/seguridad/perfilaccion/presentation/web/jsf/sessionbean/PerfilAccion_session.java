...
*/
package com.bydan.ingles.seguridad.perfilaccion.presentation.web.jsf.sessionbean;
...
public class PerfilAccion_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionPerfil=false;
	public Long lidPerfilActual=0L;
	public Boolean isBusquedaDesdeFKSesionAccion=false;
	public Long lidAccionActual=0L;
	...
	public PerfilAccion_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionPerfil=false;
		//this.lidPerfilActual=0L;

		//this.isBusquedaDesdeFKSesionAccion=false;
		//this.lidAccionActual=0L; 
		//FOREIGN_KEY_FIN
	...
	public Boolean getisBusquedaDesdeFKSesionPerfil() {
		return isBusquedaDesdeFKSesionPerfil;
	}

	public void setisBusquedaDesdeFKSesionPerfil(
		Boolean isBusquedaDesdeFKSesionPerfil) {
		this.isBusquedaDesdeFKSesionPerfil = isBusquedaDesdeFKSesionPerfil;
	}
	...
	public Boolean getisBusquedaDesdeFKSesionAccion() {
		return isBusquedaDesdeFKSesionAccion;
	}

	public void setisBusquedaDesdeFKSesionAccion(
		Boolean isBusquedaDesdeFKSesionAccion) {
		this.isBusquedaDesdeFKSesionAccion = isBusquedaDesdeFKSesionAccion;
	}
