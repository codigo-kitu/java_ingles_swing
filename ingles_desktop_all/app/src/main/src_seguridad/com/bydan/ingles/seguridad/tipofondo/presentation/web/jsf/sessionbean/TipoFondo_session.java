...
*/
package com.bydan.ingles.seguridad.tipofondo.presentation.web.jsf.sessionbean;
...
public class TipoFondo_session  extends GeneralEntitySessionBean {
	...
	public TipoFondo_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("TipoFondo:Valor nulo no permitido en columna id");
					}
				}
