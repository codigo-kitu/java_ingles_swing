...
*/
package com.bydan.ingles.seguridad.modulo.presentation.web.jsf.sessionbean;
...
public class Modulo_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionSistema=false;
	public Long lidSistemaActual=0L;
	public Boolean isBusquedaDesdeFKSesionPaquete=false;
	public Long lidPaqueteActual=0L;
	public Boolean isBusquedaDesdeFKSesionTipoTeclaMascara=false;
	public Long lidTipoTeclaMascaraActual=0L;
	...
	public Modulo_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionSistema=false;
		//this.lidSistemaActual=0L;

		//this.isBusquedaDesdeFKSesionPaquete=false;
		//this.lidPaqueteActual=0L;

		//this.isBusquedaDesdeFKSesionTipoTeclaMascara=false;
		//this.lidTipoTeclaMascaraActual=0L; 
		//FOREIGN_KEY_FIN
	...
	public Boolean getisBusquedaDesdeFKSesionSistema() {
		return isBusquedaDesdeFKSesionSistema;
	}

	public void setisBusquedaDesdeFKSesionSistema(
		Boolean isBusquedaDesdeFKSesionSistema) {
		this.isBusquedaDesdeFKSesionSistema = isBusquedaDesdeFKSesionSistema;
	}
	...
	public Boolean getisBusquedaDesdeFKSesionPaquete() {
		return isBusquedaDesdeFKSesionPaquete;
	}

	public void setisBusquedaDesdeFKSesionPaquete(
		Boolean isBusquedaDesdeFKSesionPaquete) {
		this.isBusquedaDesdeFKSesionPaquete = isBusquedaDesdeFKSesionPaquete;
	}
	...
	public Boolean getisBusquedaDesdeFKSesionTipoTeclaMascara() {
		return isBusquedaDesdeFKSesionTipoTeclaMascara;
	}

	public void setisBusquedaDesdeFKSesionTipoTeclaMascara(
		Boolean isBusquedaDesdeFKSesionTipoTeclaMascara) {
		this.isBusquedaDesdeFKSesionTipoTeclaMascara = isBusquedaDesdeFKSesionTipoTeclaMascara;
	}
