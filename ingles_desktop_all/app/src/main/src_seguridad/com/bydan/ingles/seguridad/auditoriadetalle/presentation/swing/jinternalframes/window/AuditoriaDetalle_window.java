...
public class AuditoriaDetalle_window extends JInternalFrameBase {	
	...
	public AuditoriaDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_BusquedaPorIdAuditoriaPorNombreCampo;
	public JButton btn_BusquedaPorIdAuditoriaPorNombreCampo;
	public JPanel pnl_FK_IdAuditoria;
	public JButton btn_FK_IdAuditoria;
	
	public JPanel pnlid_auditoriaBusquedaPorIdAuditoriaPorNombreCampo;
	public JLabel lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo;
	public JComboBoxMe cmb_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo;
	public JButton btn_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo= new JButton();
	public JButton btn_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo_Update= new JButton();
	public JButton btn_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo_Busqueda= new JButton();

	
	public JPanel pnlnombre_campoBusquedaPorIdAuditoriaPorNombreCampo;
	public JLabel lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo;
	public JTextArea txa_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo;
	public JButton btn_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo_Busqueda= new JButton();

	
	public JPanel pnlid_auditoriaFK_IdAuditoria;
	public JLabel lbl_id_auditoriaFK_IdAuditoria;
	public JComboBoxMe cmb_id_auditoriaFK_IdAuditoria;
	public JButton btn_id_auditoriaFK_IdAuditoria= new JButton();
	public JButton btn_id_auditoriaFK_IdAuditoria_Update= new JButton();
	public JButton btn_id_auditoriaFK_IdAuditoria_Busqueda= new JButton();
	...
	*/
	...
	public AuditoriaDetalle_window() throws Exception {
	...
	public AuditoriaDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("AuditoriaDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public AuditoriaDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("AuditoriaDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoAuditoriaDetalle = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=AuditoriaDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=AuditoriaDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorIdAuditoriaPorNombreCampo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorIdAuditoriaPorNombreCampo.setToolTipText("Buscar Por Auditoria Por Nombre Del Campo ");
		this.btn_BusquedaPorIdAuditoriaPorNombreCampo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorIdAuditoriaPorNombreCampo,"buscar_button","Buscar","Buscar Por Auditoria Por Nombre Del Campo ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorIdAuditoriaPorNombreCampo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorIdAuditoriaPorNombreCampo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,"Auditoria :","Auditoria");
		FuncionesSwing.setLabelSize(lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);



	
		lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,"Nombre Del Campo :","Nombre Del Campo");
		FuncionesSwing.setLabelSize(lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL2);

		FuncionesSwing.setBoldLabel(lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);

		txa_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo= new JTextArea();
		FuncionesSwing.setTextAreaSize(txa_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextArea(txa_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo,this.sTipoTamanioGeneral,false,true,this);



		this.pnl_FK_IdAuditoria=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdAuditoria.setToolTipText("Buscar Por Auditoria ");
		this.btn_FK_IdAuditoria= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdAuditoria,"buscar_button","Buscar","Buscar Por Auditoria ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdAuditoria, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdAuditoria, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_auditoriaFK_IdAuditoria = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_auditoriaFK_IdAuditoria,"Auditoria :","Auditoria");
		FuncionesSwing.setLabelSize(lbl_id_auditoriaFK_IdAuditoria,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_auditoriaFK_IdAuditoria,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_auditoriaFK_IdAuditoria,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_auditoriaFK_IdAuditoria= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_auditoriaFK_IdAuditoria,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_auditoriaFK_IdAuditoria,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new AuditoriaDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Auditoria Detalle DATOS");
			//_form
			this.jFrameDetalleForm = new AuditoriaDetalle_form_window(jDesktopPane,this.auditoriadetalle_session.getConGuardarRelaciones(),this.auditoriadetalle_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new AuditoriaDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//AuditoriaDetalle
		...
		this.tableDatos.setToolTipText(sToolTipAuditoriaDetalle);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByAuditoriaDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByAuditoriaDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"AuditoriaDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.auditoriadetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"AuditoriaDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"AuditoriaDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+AuditoriaDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+AuditoriaDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(AuditoriaDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosAuditoriaDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoAuditoriaDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.setLayout(gridaBagLayoutBusquedaPorIdAuditoriaPorNombreCampoAuditoriaDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.add(lbl_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.add(cmb_id_auditoriaBusquedaPorIdAuditoriaPorNombreCampo, gridBagConstraints);


		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,1);
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.add(lbl_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.add(txa_nombre_campoBusquedaPorIdAuditoriaPorNombreCampo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,2);
		pnl_BusquedaPorIdAuditoriaPorNombreCampo.add(btn_BusquedaPorIdAuditoriaPorNombreCampo, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Auditoria Por Nombre Del Campo ", pnl_BusquedaPorIdAuditoriaPorNombreCampo);
		...
		pnl_FK_IdAuditoria.setLayout(gridaBagLayoutFK_IdAuditoriaAuditoriaDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdAuditoria.add(lbl_id_auditoriaFK_IdAuditoria, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdAuditoria.add(cmb_id_auditoriaFK_IdAuditoria, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdAuditoria.add(btn_FK_IdAuditoria, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Auditoria ", pnl_FK_IdAuditoria);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.auditoriadetalle_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(AuditoriaDetalle_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.auditoriadetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//AuditoriaDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.auditoriadetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > AuditoriaDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=AuditoriaDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < AuditoriaDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=AuditoriaDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > AuditoriaDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=AuditoriaDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < AuditoriaDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=AuditoriaDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<AuditoriaDetalle> TraerBeans(List<AuditoriaDetalle> auditoriadetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(AuditoriaDetalle auditoriadetalle:auditoriadetalles) {
					
				if(!(AuditoriaDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || AuditoriaDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					auditoriadetalle.setsDetalleGeneralEntityReporte(AuditoriaDetalle_util.getAuditoriaDetalleDescripcion(auditoriadetalle));
	...
	/*
		public interface AuditoriaDetalle_windowI {	
