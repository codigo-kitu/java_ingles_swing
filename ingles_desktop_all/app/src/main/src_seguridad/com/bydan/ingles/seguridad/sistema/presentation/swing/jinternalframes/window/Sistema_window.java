...
public class Sistema_window extends Sistema_control_window_add {	
	...
	public Sistema_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_BusquedaPorNombrePrincipal;
	public JButton btn_BusquedaPorNombrePrincipal;
	
	public JPanel pnlnombre_principalBusquedaPorNombrePrincipal;
	public JLabel lbl_nombre_principalBusquedaPorNombrePrincipal;
	public JTextArea txa_nombre_principalBusquedaPorNombrePrincipal;
	public JButton btn_nombre_principalBusquedaPorNombrePrincipal_Busqueda= new JButton();
	...
	*/
	...
	public Sistema_window() throws Exception {
	...
	public Sistema_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Sistema_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Sistema No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Sistema_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Sistema No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoSistema = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=Sistema_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Sistema_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorNombrePrincipal=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorNombrePrincipal.setToolTipText("Buscar Por Nombre Principal ");
		this.btn_BusquedaPorNombrePrincipal= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorNombrePrincipal,"buscar_button","Buscar","Buscar Por Nombre Principal ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorNombrePrincipal, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorNombrePrincipal, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_nombre_principalBusquedaPorNombrePrincipal = new JLabel();
		FuncionesSwing.setLabelProp(lbl_nombre_principalBusquedaPorNombrePrincipal,"Nombre Principal :","Nombre Principal");
		FuncionesSwing.setLabelSize(lbl_nombre_principalBusquedaPorNombrePrincipal,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-17),Constantes2.I_SWING_ALTO_CONTROL_LABEL2);

		FuncionesSwing.setBoldLabel(lbl_nombre_principalBusquedaPorNombrePrincipal,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_nombre_principalBusquedaPorNombrePrincipal,this.sTipoTamanioGeneral,false,true,this);

		txa_nombre_principalBusquedaPorNombrePrincipal= new JTextArea();
		FuncionesSwing.setTextAreaSize(txa_nombre_principalBusquedaPorNombrePrincipal,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextArea(txa_nombre_principalBusquedaPorNombrePrincipal,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new SistemaDetalle_window(paginaTipo);//JInternalFrameBase("Sistema DATOS");
			//_form
			this.jFrameDetalleForm = new Sistema_form_window(jDesktopPane,this.sistema_session.getConGuardarRelaciones(),this.sistema_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Sistema_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Sistema
		...
		this.tableDatos.setToolTipText(sToolTipSistema);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderBySistema,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderBySistema,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Sistema",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.sistema_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Sistema",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Sistema",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Sistema_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Sistema_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),SistemaBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(SistemaBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),SistemaBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(SistemaBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),SistemaBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(SistemaBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosSistema);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoSistema, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_BusquedaPorNombrePrincipal.setLayout(gridaBagLayoutBusquedaPorNombrePrincipalSistema);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorNombrePrincipal.add(lbl_nombre_principalBusquedaPorNombrePrincipal, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorNombrePrincipal.add(txa_nombre_principalBusquedaPorNombrePrincipal, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorNombrePrincipal.add(btn_BusquedaPorNombrePrincipal, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Nombre Principal ", pnl_BusquedaPorNombrePrincipal);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.sistema_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.sistema_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Sistema_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.sistema_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Sistema_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Sistema_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Sistema_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Sistema_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Sistema_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Sistema_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Sistema_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Sistema_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Sistema> TraerBeans(List<Sistema> sistemas,ArrayList<Classe> classes)throws Exception {
		try {
			for(Sistema sistema:sistemas) {
					
				if(!(Sistema_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Sistema_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					sistema.setsDetalleGeneralEntityReporte(Sistema_util.getSistemaDescripcion(sistema));
										
					sistema.setestado_descripcion(Sistema_util.getestadoDescripcion(sistema));	
	...
	/*
		public interface Sistema_windowI {	
