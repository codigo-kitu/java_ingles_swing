...
public class PerfilCampo_window extends JInternalFrameBase {	
	...
	public PerfilCampo_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_FK_IdCampo;
	public JButton btn_FK_IdCampo;
	public JPanel pnl_FK_IdPerfil;
	public JButton btn_FK_IdPerfil;
	
	public JPanel pnlid_campoFK_IdCampo;
	public JLabel lbl_id_campoFK_IdCampo;
	public JComboBoxMe cmb_id_campoFK_IdCampo;
	public JButton btn_id_campoFK_IdCampo= new JButton();
	public JButton btn_id_campoFK_IdCampo_Update= new JButton();
	public JButton btn_id_campoFK_IdCampo_Busqueda= new JButton();
	...
	*/
	...
	public PerfilCampo_window() throws Exception {
	...
	public PerfilCampo_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public PerfilCampo_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilCampo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilCampo_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilCampo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoPerfilCampo = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=PerfilCampo_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PerfilCampo_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdCampo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdCampo.setToolTipText("Buscar Por Campo ");
		this.btn_FK_IdCampo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdCampo,"buscar_button","Buscar","Buscar Por Campo ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdCampo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdCampo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_campoFK_IdCampo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_campoFK_IdCampo,"Campo :","Campo");
		FuncionesSwing.setLabelSize(lbl_id_campoFK_IdCampo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_campoFK_IdCampo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_campoFK_IdCampo,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_campoFK_IdCampo= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_campoFK_IdCampo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_campoFK_IdCampo,this.sTipoTamanioGeneral,false,true,this);
		...
		FuncionesSwing.setLabelSize(lbl_id_perfilFK_IdPerfil,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-39),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PerfilCampoDetalle_window(paginaTipo);//JInternalFrameBase("Perfil Campo DATOS");
			//_form
			this.jFrameDetalleForm = new PerfilCampo_form_window(jDesktopPane,this.perfilcampo_session.getConGuardarRelaciones(),this.perfilcampo_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new PerfilCampo_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PerfilCampo
		...
		this.tableDatos.setToolTipText(sToolTipPerfilCampo);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilCampo,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilCampo,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PerfilCampo",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.perfilcampo_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PerfilCampo",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PerfilCampo",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PerfilCampo_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PerfilCampo_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PerfilCampoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilCampoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PerfilCampoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilCampoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PerfilCampoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilCampoBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPerfilCampo);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPerfilCampo, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_FK_IdPerfil.setLayout(gridaBagLayoutFK_IdPerfilPerfilCampo);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.perfilcampo_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.perfilcampo_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PerfilCampo_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.perfilcampo_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PerfilCampo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilCampo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilCampo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilCampo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PerfilCampo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilCampo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilCampo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilCampo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PerfilCampo> TraerBeans(List<PerfilCampo> perfilcampos,ArrayList<Classe> classes)throws Exception {
		try {
			for(PerfilCampo perfilcampo:perfilcampos) {
					
				if(!(PerfilCampo_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PerfilCampo_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					perfilcampo.setsDetalleGeneralEntityReporte(PerfilCampo_util.getPerfilCampoDescripcion(perfilcampo));
										
					perfilcampo.settodo_descripcion(PerfilCampo_util.gettodoDescripcion(perfilcampo));perfilcampo.setingreso_descripcion(PerfilCampo_util.getingresoDescripcion(perfilcampo));perfilcampo.setmodificacion_descripcion(PerfilCampo_util.getmodificacionDescripcion(perfilcampo));perfilcampo.seteliminacion_descripcion(PerfilCampo_util.geteliminacionDescripcion(perfilcampo));perfilcampo.setconsulta_descripcion(PerfilCampo_util.getconsultaDescripcion(perfilcampo));perfilcampo.setestado_descripcion(PerfilCampo_util.getestadoDescripcion(perfilcampo));	
	...
	/*
		public interface PerfilCampo_windowI {	
