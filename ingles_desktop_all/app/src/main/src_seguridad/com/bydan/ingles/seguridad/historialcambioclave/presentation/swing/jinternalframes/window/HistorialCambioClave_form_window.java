...
public class HistorialCambioClave_form_window extends JInternalFrameBase {	
	...
	//public HistorialCambioClave_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public HistorialCambioClave_form_window(String sTipo) throws Exception {
	...
	public HistorialCambioClave_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public HistorialCambioClave_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("HistorialCambioClave No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public HistorialCambioClave_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("HistorialCambioClave No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public HistorialCambioClave_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("HistorialCambioClave No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesHistorialCambioClave) {
		//this.jComboBoxTiposAccionesHistorialCambioClave = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(HistorialCambioClave_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+HistorialCambioClave_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(HistorialCambioClave_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.historialcambioclave_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_nombre_Busqueda.setVisible(false);		}


					
		this.lbl_fecha_hora = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_fecha_hora,""+HistorialCambioClave_util.LABEL_FECHAHORA+" : *","Fecha Hora");
		FuncionesSwing.setLabelSize(this.lbl_fecha_hora,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_fecha_hora.setToolTipText(HistorialCambioClave_util.LABEL_FECHAHORA);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_fecha_hora.setLayout(this.gridaBagLayout);


		//jFormattedTextFieldfecha_horaHistorialCambioClave= new JFormattedTextField();
		...
		FuncionesSwing.setLabelProp(this.lbl_observacion,""+HistorialCambioClave_util.LABEL_OBSERVACION+" : *","Observacion");
		FuncionesSwing.setLabelSize(this.lbl_observacion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_observacion.setToolTipText(HistorialCambioClave_util.LABEL_OBSERVACION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setTextAreaSize(txa_observacion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		...
		FuncionesSwing.setScrollPaneSize(jscrollPane_observacion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),70);
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_usuario,""+HistorialCambioClave_util.LABEL_IDUSUARIO+" : *","Usuario");
		FuncionesSwing.setLabelSize(this.lbl_id_usuario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_usuario.setToolTipText(HistorialCambioClave_util.LABEL_IDUSUARIO);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_usuario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_usuarioHistorialCambioClave"));
		...
		cmb_id_usuario.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_usuario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_usuarioHistorialCambioClaveUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new HistorialCambioClave_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Historial Cambio Clave DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.historialcambioclave_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.historialcambioclave_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=HistorialCambioClave_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=HistorialCambioClave_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=HistorialCambioClave_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesHistorialCambioClave,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesHistorialCambioClave, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(HistorialCambioClaveJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new HistorialCambioClave_controlJInternalFrameAdditional();//JInternalFrameBase("Historial Cambio Clave DATOS");
			...
			HistorialCambioClave_model historialcambioclaveModel=new HistorialCambioClave_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& historialcambioclave_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface HistorialCambioClave_form_windowI {	
