...
public class TipoTeclaMascara_form_window extends JInternalFrameBase {	
	...
	//public TipoTeclaMascara_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public TipoTeclaMascara_form_window(String sTipo) throws Exception {
	...
	public TipoTeclaMascara_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public TipoTeclaMascara_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("TipoTeclaMascara No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public TipoTeclaMascara_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoTeclaMascara No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoTeclaMascara_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoTeclaMascara No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoTeclaMascara_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesTipoTeclaMascara) {
		//this.jComboBoxTiposAccionesTipoTeclaMascara = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(TipoTeclaMascara_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+TipoTeclaMascara_util.LABEL_CODIGO+" : *","Codigo");
		...
		this.pnl_codigo.setToolTipText(TipoTeclaMascara_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.tipoteclamascara_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+TipoTeclaMascara_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(TipoTeclaMascara_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new TipoTeclaMascara_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Tipo Tecla Mascara DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.tipoteclamascara_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.tipoteclamascara_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=TipoTeclaMascara_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=TipoTeclaMascara_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=TipoTeclaMascara_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesTipoTeclaMascara,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesTipoTeclaMascara, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(TipoTeclaMascaraJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new TipoTeclaMascara_controlJInternalFrameAdditional();//JInternalFrameBase("Tipo Tecla Mascara DATOS");
			...
			TipoTeclaMascara_model tipoteclamascaraModel=new TipoTeclaMascara_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& tipoteclamascara_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface TipoTeclaMascara_form_windowI {	
