...
*/
package com.bydan.ingles.seguridad.provincia.presentation.swing.jinternalframes.window;
...
public class Provincia_form_window extends JInternalFrameBase {	
	...
	//public Provincia_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public Ciudad_control_window ciudadBeanSwingJFrame=null;
	public Ciudad_control_window ciudadBeanSwingJFramePopup=null;
	...
	public Provincia_form_window(String sTipo) throws Exception {
	...
	public Provincia_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Provincia_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Provincia No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Provincia_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Provincia No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Provincia_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Provincia No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Provincia_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesProvincia) {
		//this.jComboBoxTiposAccionesProvincia = jComboBoxTiposAcciones;
	//}		
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.provincia_session.getEsGuardarRelacionado();				
		...
		Provincia_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Provincia_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Provincia_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		Provincia_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Provincia_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Provincia_util.LABEL_CODIGO+" : *","Codigo");
		FuncionesSwing.setLabelSize(this.lbl_codigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_codigo.setToolTipText(Provincia_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.provincia_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Provincia_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(Provincia_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_pais,""+Provincia_util.LABEL_IDPAIS+" : *","Pais");
		FuncionesSwing.setLabelSize(this.lbl_id_pais,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_pais.setToolTipText(Provincia_util.LABEL_IDPAIS);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_pais.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_paisProvincia"));
		...
		cmb_id_pais.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_pais.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_paisProvinciaUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Provincia_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Provincia DATOS");
		...
		sToolTipProvincia=Provincia_util.S_CLASS_WEB_TITULO;
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.provincia_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.provincia_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Provincia_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Provincia_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Provincia_util.S_CLASS_WEB_TITULO;
		...
		if(!this.provincia_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Provinciaes" + this.sPath));
		} else {
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesProvincia,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesProvincia, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.provincia_session.getEsGuardarRelacionado()) {			
		...
		//if(ProvinciaJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Provincia_controlJInternalFrameAdditional();//JInternalFrameBase("Provincia DATOS");
			...
			Provincia_model provinciaModel=new Provincia_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& provincia_session.getConGuardarRelaciones()
						) {
					//paraCargarPorParte es false por defecto(y ejecuta funcion normal cargando detalle en tab panel), si se utiliza funcionalidad es true y carga tab panel auxiliar temporal
					
					this.cargarSessionConBeanSwingJFrameCiudad(this.puedeCargarPorParteCiudad,false,-1);
					...
					this.cargarSessionConBeanSwingJFrameCiudad(true,false,-1);
	...
	public void cargarSessionConBeanSwingJFrameCiudad(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {

		//SOLO INICIALIZA SESSION (YA NO, CONSUME MUCHA MEMORIA)
		this.ciudad_session=new Ciudad_session();
		this.ciudad_session.setConGuardarRelaciones(false);
		this.ciudad_session.setEsGuardarRelacionado(true);

		this.ciudadBeanSwingJFrame=null;//new CiudadBeanSwingJInternalFrame(false,true,false);

		if(!soloSession) {
			//this.ciudadBeanSwingJFramePopup=new CiudadBeanSwingJInternalFrame(true,false,jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,false,false,true);
			//this.ciudadBeanSwingJFramePopup.jFrameParent=this;


			if(this.ciudad_session.getEsGuardarRelacionado()) {

				Ciudad_window.S_TIPO_TAMANIO_GENERAL=Provincia_window.S_TIPO_TAMANIO_GENERAL;
				Ciudad_window.S_TIPO_TAMANIO_GENERAL_TABLA=Provincia_window.S_TIPO_TAMANIO_GENERAL;

				this.ciudad_session.setEsGuardarRelacionado(true);

				this.ciudadBeanSwingJFrame=new Ciudad_control_window(true,false,jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,PaginaTipo.SECUNDARIO,false,true,false,false);//false->4

				this.ciudadBeanSwingJFrame.setJFrameParent(this);
				this.ciudadBeanSwingJFrame.setciudad_session(this.ciudad_session);

				//this.gridBagConstraints = new GridBagConstraints();
				//this.gridBagConstraints.gridy = gxy.iGridyRelaciones++;
				//this.gridBagConstraints.gridx = 0;
				//this.jContentPaneDetalle.add(this.ciudadBeanSwingJFrame.getContentPane(), this.gridBagConstraints);

				if(!actualizarTab) {
					this.jTabbedPaneRelaciones.add("Ciudades",this.ciudadBeanSwingJFrame.getContentPane());
				} else {
					this.jTabbedPaneRelaciones.setComponentAt(iIndexTab,this.ciudadBeanSwingJFrame.getContentPane());
				}

				//CiudadJInternalFrame.ESTA_CARGADO_PORPARTE=true;
			} else {
				this.ciudad_session.setEsGuardarRelacionado(false);
				this.ciudadBeanSwingJFrame=null;//new CiudadBeanSwingJInternalFrame(false,false,jDesktopPane,this.usuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,false,false,false);
			}
		} else {
			if(this.ciudad_session.getEsGuardarRelacionado()) {
				if(this.puedeCargarPorParteCiudad) {
					this.jTabbedPaneRelaciones.add("Ciudades",new JPanel());
				}
			}
		}
	}
	...
	public void cargarSessionConBeanSwingJFrameDatoGeneralUsuario(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.datogeneralusuario_session.getEsGuardarRelacionado()) {
				...
				DatoGeneralUsuario_window.S_TIPO_TAMANIO_GENERAL=Provincia_window.S_TIPO_TAMANIO_GENERAL;
				DatoGeneralUsuario_window.S_TIPO_TAMANIO_GENERAL_TABLA=Provincia_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarCiudadBeanSwingJFrame(List<Provincia> provincias,Provincia provincia,Ciudad_control_window ciudadBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					//GETCONTENTPANE SOLO UN PAPA, SE PIERDE PANEL, POR LO QUE SE CREA NUEVO POR CADA PANTALLA
					//ciudadBeanSwingJFrame=new CiudadBeanSwingJInternalFrame(false,false,this.jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,conGuardarRelaciones,esGuardarRelacionado);

				}
					ciudadBeanSwingJFrame.getCiudadLogic().setConnexion(this.provinciaLogic.getConnexion());

					ciudadBeanSwingJFrame.setprovinciasFK(provincias);
					ciudadBeanSwingJFrame.setprovinciaFK(provincia);
					ciudadBeanSwingJFrame.ciudad_session.setisBusquedaDesdeFKSesionProvincia(true);
					ciudadBeanSwingJFrame.ciudad_session.setlidProvinciaActual(provincia.getId());
					...
					ciudadBeanSwingJFrame.cargarCombosFK(ciudadBeanSwingJFrame.isCargarCombosDependencia);
					ciudadBeanSwingJFrame.setVisibilidadBusquedasParaProvincia(true);
					ciudadBeanSwingJFrame.setid_provinciaFK_IdProvincia(provincia.getId());

					if(!this.conCargarFormDetalle) {
						ciudadBeanSwingJFrame.inicializarFormDetalle();
					}

					ciudadBeanSwingJFrame.setSelectedItemCombosFrameProvinciaFK(provincia,1,false,true,true);
					ciudadBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					ciudadBeanSwingJFrame.procesarBusqueda("FK_IdProvincia");
					ciudadBeanSwingJFrame.setsAccionBusqueda("FK_IdProvincia");
					ciudadBeanSwingJFrame.inicializarActualizarBindingTabla(true);
					ciudadBeanSwingJFrame.actualizarEstadoCeldasBotones("n",ciudadBeanSwingJFrame.isGuardarCambiosEnLote, ciudadBeanSwingJFrame.isEsMantenimientoRelacionado);
					ciudadBeanSwingJFrame.setAutoscrolls(true);
					ciudadBeanSwingJFrame.setVisible(true);

					if(esGuardarRelacionado) {
						ciudadBeanSwingJFrame.actualizarEstadoPanels("relacionado");
					} else {
						ciudadBeanSwingJFrame.actualizarEstadoPanels("no_relacionado");
					}

					ciudadBeanSwingJFrame.jPanelPaginacion.getbtn_RecargarInformacion().setVisible(false);
		...
		public void cargarDatoGeneralUsuarioBeanSwingJFrame(List<Provincia> provincias,Provincia provincia,DatoGeneralUsuario_control_window datogeneralusuarioBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					datogeneralusuarioBeanSwingJFrame.getDatoGeneralUsuarioLogic().setConnexion(this.provinciaLogic.getConnexion());

					datogeneralusuarioBeanSwingJFrame.setprovinciasFK(provincias);
					datogeneralusuarioBeanSwingJFrame.setprovinciaFK(provincia);
					datogeneralusuarioBeanSwingJFrame.datogeneralusuario_session.setisBusquedaDesdeFKSesionProvincia(true);
					datogeneralusuarioBeanSwingJFrame.datogeneralusuario_session.setlidProvinciaActual(provincia.getId());
					//NO VOLVER A RECARGAR FK, TALVEZ INICIALIZAR FK DEPENDENTES
					//Hijos Independientes, No carga Fk al inicializar, Hay que setisBusquedaDesdeFKSesion(true), luego cargar todos los Fks necesarios
					datogeneralusuarioBeanSwingJFrame.cargarCombosFK(datogeneralusuarioBeanSwingJFrame.isCargarCombosDependencia);
					datogeneralusuarioBeanSwingJFrame.setVisibilidadBusquedasParaProvincia(true);
					datogeneralusuarioBeanSwingJFrame.setid_provinciaFK_IdProvincia(provincia.getId());

					if(!this.conCargarFormDetalle) {
						datogeneralusuarioBeanSwingJFrame.inicializarFormDetalle();
					}

					datogeneralusuarioBeanSwingJFrame.setSelectedItemCombosFrameProvinciaFK(provincia,1,false,true,true);
					datogeneralusuarioBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					datogeneralusuarioBeanSwingJFrame.procesarBusqueda("FK_IdProvincia");
					datogeneralusuarioBeanSwingJFrame.setsAccionBusqueda("FK_IdProvincia");
	...
	*/
	...
	public interface Provincia_form_windowI {	
