...
*/
package com.bydan.ingles.seguridad.perfilusuario.presentation.swing.jinternalframes.window;
...
public class PerfilUsuario_window extends JInternalFrameBase {	
	...
	public PerfilUsuario_form_window jFrameDetalleForm;//_form;		
	...
	public JButton btn_Buscar_FK_IdUsuarioid_usuario;
	...
	*/
	...
	public PerfilUsuario_window() throws Exception {
	...
	public PerfilUsuario_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public PerfilUsuario_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilUsuario_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoPerfilUsuario = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.perfilusuario_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		PerfilUsuario_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		PerfilUsuario_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		PerfilUsuario_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		FuncionesSwing.setLabelSize(lbl_id_perfilFK_IdPerfil,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		FuncionesSwing.setLabelSize(lbl_id_usuarioFK_IdUsuario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		this.btn_Buscar_FK_IdUsuarioid_usuario= new JButton();
		FuncionesSwing.setButtonSize(this.btn_Buscar_FK_IdUsuarioid_usuario,50,Constantes.I_SWING_ALTO_CONTROL);

		this.btn_Buscar_FK_IdUsuarioid_usuario.setText("Buscar");
		this.btn_Buscar_FK_IdUsuarioid_usuario.setToolTipText("Buscar");
		this.btn_Buscar_FK_IdUsuarioid_usuario.setFocusable(false);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PerfilUsuarioDetalle_window(paginaTipo);//JInternalFrameBase("Usuarios Perfiles  DATOS");
			//_form
			this.jFrameDetalleForm = new PerfilUsuario_form_window(jDesktopPane,this.perfilusuario_session.getConGuardarRelaciones(),this.perfilusuario_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new PerfilUsuario_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PerfilUsuario
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipPerfilUsuario="";
		sToolTipPerfilUsuario=PerfilUsuario_util.S_CLASS_WEB_TITULO;
		...
		this.tableDatos.setToolTipText(sToolTipPerfilUsuario);
		...
		if(!this.perfilusuario_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Usuarios Perfiles s" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilUsuario,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilUsuario,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PerfilUsuario",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.perfilusuario_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PerfilUsuario",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PerfilUsuario",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PerfilUsuario_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PerfilUsuario_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PerfilUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PerfilUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PerfilUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPerfilUsuario);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPerfilUsuario, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_FK_IdPerfil.setLayout(gridaBagLayoutFK_IdPerfilPerfilUsuario);
		...
		jTabbedPaneBusquedas.addTab("1.-Por Perfil ", pnl_FK_IdPerfil);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdUsuarioPerfilUsuario= new GridBagLayout();
		gridaBagLayoutFK_IdUsuarioPerfilUsuario.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdUsuarioPerfilUsuario.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdUsuarioPerfilUsuario.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdUsuarioPerfilUsuario.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdUsuario.setLayout(gridaBagLayoutFK_IdUsuarioPerfilUsuario);
		...
		pnl_FK_IdUsuario.add(this.btn_Buscar_FK_IdUsuarioid_usuario, gridBagConstraints);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.perfilusuario_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.perfilusuario_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PerfilUsuario_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.perfilusuario_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PerfilUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PerfilUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PerfilUsuario> TraerBeans(List<PerfilUsuario> perfilusuarios,ArrayList<Classe> classes)throws Exception {
		try {
			for(PerfilUsuario perfilusuario:perfilusuarios) {
					
				if(!(PerfilUsuario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PerfilUsuario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					perfilusuario.setsDetalleGeneralEntityReporte(PerfilUsuario_util.getPerfilUsuarioDescripcion(perfilusuario));
										
					perfilusuario.setestado_descripcion(PerfilUsuario_util.getestadoDescripcion(perfilusuario));	
	...
	/*
		public interface PerfilUsuario_windowI {	
