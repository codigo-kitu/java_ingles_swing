...
public class PerfilUsuario_form_window extends JInternalFrameBase {	
	...
	//public PerfilUsuario_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public PerfilUsuario_form_window(String sTipo) throws Exception {
	...
	public PerfilUsuario_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public PerfilUsuario_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("PerfilUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public PerfilUsuario_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilUsuario_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilUsuario_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesPerfilUsuario) {
		//this.jComboBoxTiposAccionesPerfilUsuario = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(PerfilUsuario_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_estado,""+PerfilUsuario_util.LABEL_ESTADO+" : *","Estado");
		FuncionesSwing.setLabelSize(this.lbl_estado,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_estado.setToolTipText(PerfilUsuario_util.LABEL_ESTADO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.perfilusuario_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
	...
	public void inicializarElementosCamposFKs() {
		...
		FuncionesSwing.setLabelProp(this.lbl_id_perfil,""+PerfilUsuario_util.LABEL_IDPERFIL+" : *","Perfil");
		FuncionesSwing.setLabelSize(this.lbl_id_perfil,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_perfil.setToolTipText(PerfilUsuario_util.LABEL_IDPERFIL);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_perfil.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_perfilPerfilUsuario"));
		...
		cmb_id_perfil.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_perfil.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_perfilPerfilUsuarioUpdate"));



					
		this.lbl_id_usuario = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_usuario,""+PerfilUsuario_util.LABEL_IDUSUARIO+" : *","Usuario");
		FuncionesSwing.setLabelSize(this.lbl_id_usuario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-60),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_id_usuario.setToolTipText(PerfilUsuario_util.LABEL_IDUSUARIO);
		this.gridaBagLayout = new GridBagLayout();
		...
		cmb_id_usuario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_usuarioPerfilUsuario"));
		...
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_usuario.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_usuario.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_usuarioPerfilUsuarioUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new PerfilUsuario_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Usuarios Perfiles  DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.perfilusuario_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.perfilusuario_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=PerfilUsuario_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=PerfilUsuario_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=PerfilUsuario_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesPerfilUsuario,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesPerfilUsuario, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,-1,2,0,0,0);
	this.pnl_id_usuario.add(btn_id_usuario, this.gridBagConstraints);
	}
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(PerfilUsuarioJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new PerfilUsuario_controlJInternalFrameAdditional();//JInternalFrameBase("Usuarios Perfiles  DATOS");
			...
			PerfilUsuario_model perfilusuarioModel=new PerfilUsuario_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& perfilusuario_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface PerfilUsuario_form_windowI {	
