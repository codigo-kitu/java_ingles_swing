...
public class DatoGeneralUsuario_window extends JInternalFrameBase {	
	...
	public DatoGeneralUsuario_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_FK_IdCiudad;
	public JButton btn_FK_IdCiudad;
	public JPanel pnl_FK_IdPais;
	public JButton btn_FK_IdPais;
	public JPanel pnl_FK_IdProvincia;
	public JButton btn_FK_IdProvincia;
	public JPanel pnl_FK_IdUsuario;
	public JButton btn_FK_IdUsuario;
	
	public JPanel pnlid_ciudadFK_IdCiudad;
	public JLabel lbl_id_ciudadFK_IdCiudad;
	public JComboBoxMe cmb_id_ciudadFK_IdCiudad;
	public JButton btn_id_ciudadFK_IdCiudad= new JButton();
	public JButton btn_id_ciudadFK_IdCiudad_Update= new JButton();
	public JButton btn_id_ciudadFK_IdCiudad_Busqueda= new JButton();

	
	public JPanel pnlid_paisFK_IdPais;
	public JLabel lbl_id_paisFK_IdPais;
	public JComboBoxMe cmb_id_paisFK_IdPais;
	public JButton btn_id_paisFK_IdPais= new JButton();
	public JButton btn_id_paisFK_IdPais_Update= new JButton();
	public JButton btn_id_paisFK_IdPais_Busqueda= new JButton();

	
	public JPanel pnlid_provinciaFK_IdProvincia;
	public JLabel lbl_id_provinciaFK_IdProvincia;
	public JComboBoxMe cmb_id_provinciaFK_IdProvincia;
	public JButton btn_id_provinciaFK_IdProvincia= new JButton();
	public JButton btn_id_provinciaFK_IdProvincia_Update= new JButton();
	public JButton btn_id_provinciaFK_IdProvincia_Busqueda= new JButton();
	...
	*/
	...
	public DatoGeneralUsuario_window() throws Exception {
	...
	public DatoGeneralUsuario_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public DatoGeneralUsuario_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("DatoGeneralUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public DatoGeneralUsuario_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("DatoGeneralUsuario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoDatoGeneralUsuario = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=DatoGeneralUsuario_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=DatoGeneralUsuario_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdCiudad=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdCiudad.setToolTipText("Buscar Por Ciudad ");
		this.btn_FK_IdCiudad= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdCiudad,"buscar_button","Buscar","Buscar Por Ciudad ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdCiudad, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdCiudad, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_ciudadFK_IdCiudad = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_ciudadFK_IdCiudad,"Ciudad :","Ciudad");
		FuncionesSwing.setLabelSize(lbl_id_ciudadFK_IdCiudad,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_ciudadFK_IdCiudad,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_ciudadFK_IdCiudad,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_ciudadFK_IdCiudad= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_ciudadFK_IdCiudad,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_ciudadFK_IdCiudad,this.sTipoTamanioGeneral,false,true,this);



		this.pnl_FK_IdPais=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdPais.setToolTipText("Buscar Por Pais ");
		this.btn_FK_IdPais= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdPais,"buscar_button","Buscar","Buscar Por Pais ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdPais, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdPais, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_paisFK_IdPais = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_paisFK_IdPais,"Pais :","Pais");
		FuncionesSwing.setLabelSize(lbl_id_paisFK_IdPais,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_paisFK_IdPais,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_paisFK_IdPais,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_paisFK_IdPais= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_paisFK_IdPais,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_paisFK_IdPais,this.sTipoTamanioGeneral,false,true,this);



		this.pnl_FK_IdProvincia=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdProvincia.setToolTipText("Buscar Por Provincia ");
		this.btn_FK_IdProvincia= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdProvincia,"buscar_button","Buscar","Buscar Por Provincia ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdProvincia, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdProvincia, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_provinciaFK_IdProvincia = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_provinciaFK_IdProvincia,"Provincia :","Provincia");
		FuncionesSwing.setLabelSize(lbl_id_provinciaFK_IdProvincia,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_provinciaFK_IdProvincia,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_provinciaFK_IdProvincia,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_provinciaFK_IdProvincia= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_provinciaFK_IdProvincia,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_provinciaFK_IdProvincia,this.sTipoTamanioGeneral,false,true,this);
		...
		FuncionesSwing.setLabelSize(lbl_id_usuarioFK_IdUsuario,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new DatoGeneralUsuarioDetalle_window(paginaTipo);//JInternalFrameBase("Dato General Usuario DATOS");
			//_form
			this.jFrameDetalleForm = new DatoGeneralUsuario_form_window(jDesktopPane,this.datogeneralusuario_session.getConGuardarRelaciones(),this.datogeneralusuario_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new DatoGeneralUsuario_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//DatoGeneralUsuario
		...
		this.tableDatos.setToolTipText(sToolTipDatoGeneralUsuario);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByDatoGeneralUsuario,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByDatoGeneralUsuario,true,this);
		...
		//VALORES PARA DISENO
		/*
		this.tableDatos.setMinimumSize(new Dimension(400,50));//1430
		this.tableDatos.setMaximumSize(new Dimension(400,50));//1430
		this.tableDatos.setPreferredSize(new Dimension(400,50));//1430
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"DatoGeneralUsuario",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.datogeneralusuario_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"DatoGeneralUsuario",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"DatoGeneralUsuario",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+DatoGeneralUsuario_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+DatoGeneralUsuario_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DatoGeneralUsuarioBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosDatoGeneralUsuario);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoDatoGeneralUsuario, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_FK_IdCiudad.setLayout(gridaBagLayoutFK_IdCiudadDatoGeneralUsuario);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdCiudad.add(lbl_id_ciudadFK_IdCiudad, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdCiudad.add(cmb_id_ciudadFK_IdCiudad, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdCiudad.add(btn_FK_IdCiudad, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Ciudad ", pnl_FK_IdCiudad);
		...
		pnl_FK_IdPais.setLayout(gridaBagLayoutFK_IdPaisDatoGeneralUsuario);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdPais.add(lbl_id_paisFK_IdPais, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdPais.add(cmb_id_paisFK_IdPais, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdPais.add(btn_FK_IdPais, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Pais ", pnl_FK_IdPais);
		...
		pnl_FK_IdProvincia.setLayout(gridaBagLayoutFK_IdProvinciaDatoGeneralUsuario);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdProvincia.add(lbl_id_provinciaFK_IdProvincia, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdProvincia.add(cmb_id_provinciaFK_IdProvincia, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdProvincia.add(btn_FK_IdProvincia, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("3.-Por Provincia ", pnl_FK_IdProvincia);
		...
		pnl_FK_IdUsuario.setLayout(gridaBagLayoutFK_IdUsuarioDatoGeneralUsuario);
		...
		jTabbedPaneBusquedas.addTab("4.-Por Id ", pnl_FK_IdUsuario);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.datogeneralusuario_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.datogeneralusuario_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//DatoGeneralUsuario_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.datogeneralusuario_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > DatoGeneralUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=DatoGeneralUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < DatoGeneralUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=DatoGeneralUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > DatoGeneralUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=DatoGeneralUsuario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < DatoGeneralUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=DatoGeneralUsuario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<DatoGeneralUsuario> TraerBeans(List<DatoGeneralUsuario> datogeneralusuarios,ArrayList<Classe> classes)throws Exception {
		try {
			for(DatoGeneralUsuario datogeneralusuario:datogeneralusuarios) {
					
				if(!(DatoGeneralUsuario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || DatoGeneralUsuario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					datogeneralusuario.setsDetalleGeneralEntityReporte(DatoGeneralUsuario_util.getDatoGeneralUsuarioDescripcion(datogeneralusuario));
	...
	/*
		public interface DatoGeneralUsuario_windowI {	
