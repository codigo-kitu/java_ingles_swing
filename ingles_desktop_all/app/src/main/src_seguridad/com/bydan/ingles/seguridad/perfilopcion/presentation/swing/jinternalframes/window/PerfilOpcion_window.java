...
public class PerfilOpcion_window extends JInternalFrameBase {	
	...
	public PerfilOpcion_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_BusquedaPorIdPerfilPorIdOpcion;
	public JButton btn_BusquedaPorIdPerfilPorIdOpcion;
	public JPanel pnl_FK_IdOpcion;
	public JButton btn_FK_IdOpcion;
	public JPanel pnl_FK_IdPerfil;
	public JButton btn_FK_IdPerfil;
	
	public JPanel pnlid_perfilBusquedaPorIdPerfilPorIdOpcion;
	public JLabel lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion;
	public JComboBoxMe cmb_id_perfilBusquedaPorIdPerfilPorIdOpcion;
	public JButton btn_id_perfilBusquedaPorIdPerfilPorIdOpcion= new JButton();
	public JButton btn_id_perfilBusquedaPorIdPerfilPorIdOpcion_Update= new JButton();
	public JButton btn_id_perfilBusquedaPorIdPerfilPorIdOpcion_Busqueda= new JButton();

	
	public JPanel pnlid_opcionBusquedaPorIdPerfilPorIdOpcion;
	public JLabel lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion;
	public JComboBoxMe cmb_id_opcionBusquedaPorIdPerfilPorIdOpcion;
	public JButton btn_id_opcionBusquedaPorIdPerfilPorIdOpcion= new JButton();
	public JButton btn_id_opcionBusquedaPorIdPerfilPorIdOpcion_Update= new JButton();
	public JButton btn_id_opcionBusquedaPorIdPerfilPorIdOpcion_Busqueda= new JButton();
	public JButton btn_id_opcionBusquedaPorIdPerfilPorIdOpcionArbol= new JButton();

	public JButton btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion;
	...
	public JButton btn_Buscar_FK_IdOpcionid_opcion;
	...
	*/
	...
	public PerfilOpcion_window() throws Exception {
	...
	public PerfilOpcion_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilOpcion No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public PerfilOpcion_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("PerfilOpcion No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoPerfilOpcion = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=PerfilOpcion_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=PerfilOpcion_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorIdPerfilPorIdOpcion=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorIdPerfilPorIdOpcion.setToolTipText("Buscar Por Perfil Por Opcion ");
		this.btn_BusquedaPorIdPerfilPorIdOpcion= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorIdPerfilPorIdOpcion,"buscar_button","Buscar","Buscar Por Perfil Por Opcion ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorIdPerfilPorIdOpcion, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorIdPerfilPorIdOpcion, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion,"Perfil :","Perfil");
		FuncionesSwing.setLabelSize(lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_perfilBusquedaPorIdPerfilPorIdOpcion= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_perfilBusquedaPorIdPerfilPorIdOpcion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_perfilBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);



	
		lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion,"Opcion :","Opcion");
		FuncionesSwing.setLabelSize(lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_opcionBusquedaPorIdPerfilPorIdOpcion= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_opcionBusquedaPorIdPerfilPorIdOpcion,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_opcionBusquedaPorIdPerfilPorIdOpcion,this.sTipoTamanioGeneral,false,true,this);



		this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion= new JButton();
		FuncionesSwing.setButtonSize(this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion,50,Constantes.I_SWING_ALTO_CONTROL);

		this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion.setText("Buscar");
		this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion.setToolTipText("Buscar");
		this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion.setFocusable(false);
		...
		FuncionesSwing.setLabelSize(lbl_id_opcionFK_IdOpcion,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		this.btn_Buscar_FK_IdOpcionid_opcion= new JButton();
		FuncionesSwing.setButtonSize(this.btn_Buscar_FK_IdOpcionid_opcion,50,Constantes.I_SWING_ALTO_CONTROL);

		this.btn_Buscar_FK_IdOpcionid_opcion.setText("Buscar");
		this.btn_Buscar_FK_IdOpcionid_opcion.setToolTipText("Buscar");
		this.btn_Buscar_FK_IdOpcionid_opcion.setFocusable(false);
		...
		FuncionesSwing.setLabelSize(lbl_id_perfilFK_IdPerfil,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-22),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new PerfilOpcionDetalle_window(paginaTipo);//JInternalFrameBase("Perfil Opcion DATOS");
			//_form
			this.jFrameDetalleForm = new PerfilOpcion_form_window(jDesktopPane,this.perfilopcion_session.getConGuardarRelaciones(),this.perfilopcion_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new PerfilOpcion_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//PerfilOpcion
		...
		this.tableDatos.setToolTipText(sToolTipPerfilOpcion);
		...
		FuncionesSwing.setBoldPanel(this.jPanelCamposIniciopermiso, S_TIPO_TAMANIO_GENERAL,false,false,this);;
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilOpcion,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByPerfilOpcion,true,this);
		...
		//VALORES PARA DISENO
		/*
		this.tableDatos.setMinimumSize(new Dimension(400,50));//2030
		this.tableDatos.setMaximumSize(new Dimension(400,50));//2030
		this.tableDatos.setPreferredSize(new Dimension(400,50));//2030
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"PerfilOpcion",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.perfilopcion_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"PerfilOpcion",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"PerfilOpcion",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+PerfilOpcion_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+PerfilOpcion_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),PerfilOpcionBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilOpcionBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),PerfilOpcionBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilOpcionBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),PerfilOpcionBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(PerfilOpcionBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosPerfilOpcion);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoPerfilOpcion, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		pnl_BusquedaPorIdPerfilPorIdOpcion.setLayout(gridaBagLayoutBusquedaPorIdPerfilPorIdOpcionPerfilOpcion);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(lbl_id_perfilBusquedaPorIdPerfilPorIdOpcion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(cmb_id_perfilBusquedaPorIdPerfilPorIdOpcion, gridBagConstraints);


		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,1);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(lbl_id_opcionBusquedaPorIdPerfilPorIdOpcion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(cmb_id_opcionBusquedaPorIdPerfilPorIdOpcion, gridBagConstraints);


		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.EAST,GridBagConstraints.NONE,0,1);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(this.btn_Buscar_BusquedaPorIdPerfilPorIdOpcionid_opcion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,2);
		pnl_BusquedaPorIdPerfilPorIdOpcion.add(btn_BusquedaPorIdPerfilPorIdOpcion, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Perfil Por Opcion ", pnl_BusquedaPorIdPerfilPorIdOpcion);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdOpcionPerfilOpcion= new GridBagLayout();
		gridaBagLayoutFK_IdOpcionPerfilOpcion.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdOpcionPerfilOpcion.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdOpcionPerfilOpcion.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdOpcionPerfilOpcion.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdOpcion.setLayout(gridaBagLayoutFK_IdOpcionPerfilOpcion);
		...
		pnl_FK_IdOpcion.add(this.btn_Buscar_FK_IdOpcionid_opcion, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdOpcion.add(btn_FK_IdOpcion, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Opcion ", pnl_FK_IdOpcion);
		jTabbedPaneBusquedas.setMnemonicAt(1, KeyEvent.VK_2);

		GridBagLayout gridaBagLayoutFK_IdPerfilPerfilOpcion= new GridBagLayout();
		gridaBagLayoutFK_IdPerfilPerfilOpcion.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdPerfilPerfilOpcion.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdPerfilPerfilOpcion.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdPerfilPerfilOpcion.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdPerfil.setLayout(gridaBagLayoutFK_IdPerfilPerfilOpcion);
		...
		jTabbedPaneBusquedas.addTab("3.-Por Perfil ", pnl_FK_IdPerfil);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.perfilopcion_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.perfilopcion_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//PerfilOpcion_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.perfilopcion_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > PerfilOpcion_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilOpcion_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilOpcion_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilOpcion_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > PerfilOpcion_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=PerfilOpcion_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < PerfilOpcion_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=PerfilOpcion_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<PerfilOpcion> TraerBeans(List<PerfilOpcion> perfilopcions,ArrayList<Classe> classes)throws Exception {
		try {
			for(PerfilOpcion perfilopcion:perfilopcions) {
					
				if(!(PerfilOpcion_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || PerfilOpcion_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					perfilopcion.setsDetalleGeneralEntityReporte(PerfilOpcion_util.getPerfilOpcionDescripcion(perfilopcion));
										
					perfilopcion.settodo_descripcion(PerfilOpcion_util.gettodoDescripcion(perfilopcion));perfilopcion.setingreso_descripcion(PerfilOpcion_util.getingresoDescripcion(perfilopcion));perfilopcion.setmodificacion_descripcion(PerfilOpcion_util.getmodificacionDescripcion(perfilopcion));perfilopcion.seteliminacion_descripcion(PerfilOpcion_util.geteliminacionDescripcion(perfilopcion));perfilopcion.setguardar_cambios_descripcion(PerfilOpcion_util.getguardar_cambiosDescripcion(perfilopcion));perfilopcion.setconsulta_descripcion(PerfilOpcion_util.getconsultaDescripcion(perfilopcion));perfilopcion.setbusqueda_descripcion(PerfilOpcion_util.getbusquedaDescripcion(perfilopcion));perfilopcion.setreporte_descripcion(PerfilOpcion_util.getreporteDescripcion(perfilopcion));perfilopcion.setestado_descripcion(PerfilOpcion_util.getestadoDescripcion(perfilopcion));perfilopcion.setorden_descripcion(PerfilOpcion_util.getordenDescripcion(perfilopcion));perfilopcion.setpaginacion_medio_descripcion(PerfilOpcion_util.getpaginacion_medioDescripcion(perfilopcion));perfilopcion.setpaginacion_alto_descripcion(PerfilOpcion_util.getpaginacion_altoDescripcion(perfilopcion));perfilopcion.setpaginacion_todo_descripcion(PerfilOpcion_util.getpaginacion_todoDescripcion(perfilopcion));perfilopcion.setduplicar_descripcion(PerfilOpcion_util.getduplicarDescripcion(perfilopcion));perfilopcion.setcopiar_descripcion(PerfilOpcion_util.getcopiarDescripcion(perfilopcion));perfilopcion.setcon_precargar_descripcion(PerfilOpcion_util.getcon_precargarDescripcion(perfilopcion));	
	...
	/*
		public interface PerfilOpcion_windowI {	
