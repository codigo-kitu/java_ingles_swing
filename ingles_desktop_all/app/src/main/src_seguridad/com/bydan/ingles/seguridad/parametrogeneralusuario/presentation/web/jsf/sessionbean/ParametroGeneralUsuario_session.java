...
*/
package com.bydan.ingles.seguridad.parametrogeneralusuario.presentation.web.jsf.sessionbean;
...
public class ParametroGeneralUsuario_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionTipoFondo=false;
	public Long lidTipoFondoActual=0L;
	...
	public ParametroGeneralUsuario_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionTipoFondo=false;
		//this.lidTipoFondoActual=0L; 
		//FOREIGN_KEY_FIN
	...
	public Boolean getisBusquedaDesdeFKSesionTipoFondo() {
		return isBusquedaDesdeFKSesionTipoFondo;
	}

	public void setisBusquedaDesdeFKSesionTipoFondo(
		Boolean isBusquedaDesdeFKSesionTipoFondo) {
		this.isBusquedaDesdeFKSesionTipoFondo = isBusquedaDesdeFKSesionTipoFondo;
	}
