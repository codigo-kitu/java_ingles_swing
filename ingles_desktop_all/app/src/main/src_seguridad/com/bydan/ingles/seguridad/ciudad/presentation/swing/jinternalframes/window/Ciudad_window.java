...
public class Ciudad_window extends JInternalFrameBase {	
	...
	public Ciudad_form_window jFrameDetalleForm;//_form;		
	...
	public JPanel pnl_BusquedaPorCodigo;
	public JButton btn_BusquedaPorCodigo;
	...
	public JPanel pnlcodigoBusquedaPorCodigo;
	public JLabel lbl_codigoBusquedaPorCodigo;
	public JTextField txf_codigoBusquedaPorCodigo;
	public JButton btn_codigoBusquedaPorCodigo_Busqueda= new JButton();

	
	public JPanel pnlnombreBusquedaPorNombre;
	public JLabel lbl_nombreBusquedaPorNombre;
	public JTextArea txa_nombreBusquedaPorNombre;
	...
	*/
	...
	public Ciudad_window() throws Exception {
	...
	public Ciudad_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Ciudad_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Ciudad No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Ciudad_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Ciudad No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//	this.jCheckBoxConGraficoDinamicoCiudad = jCheckBoxConGraficoDinamico;
	//}	
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=Ciudad_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Ciudad_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_BusquedaPorCodigo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_BusquedaPorCodigo.setToolTipText("Buscar Por Codigo ");
		this.btn_BusquedaPorCodigo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_BusquedaPorCodigo,"buscar_button","Buscar","Buscar Por Codigo ");
		FuncionesSwing.setBoldButton(this.btn_BusquedaPorCodigo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_BusquedaPorCodigo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_codigoBusquedaPorCodigo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_codigoBusquedaPorCodigo,"Codigo :","Codigo");
		FuncionesSwing.setLabelSize(lbl_codigoBusquedaPorCodigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_codigoBusquedaPorCodigo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_codigoBusquedaPorCodigo,this.sTipoTamanioGeneral,false,true,this);

		txf_codigoBusquedaPorCodigo= new JTextField();
		FuncionesSwing.setTextFieldSize(txf_codigoBusquedaPorCodigo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextField(txf_codigoBusquedaPorCodigo,this.sTipoTamanioGeneral,false,true,this);
		...
		FuncionesSwing.setLabelSize(lbl_nombreBusquedaPorNombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		txa_nombreBusquedaPorNombre= new JTextArea();
		FuncionesSwing.setTextAreaSize(txa_nombreBusquedaPorNombre,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldTextArea(txa_nombreBusquedaPorNombre,this.sTipoTamanioGeneral,false,true,this);
		...
		FuncionesSwing.setLabelSize(lbl_id_provinciaFK_IdProvincia,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-52),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new CiudadDetalle_window(paginaTipo);//JInternalFrameBase("Ciudad DATOS");
			//_form
			this.jFrameDetalleForm = new Ciudad_form_window(jDesktopPane,this.ciudad_session.getConGuardarRelaciones(),this.ciudad_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Ciudad_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Ciudad
		...
		this.tableDatos.setToolTipText(sToolTipCiudad);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByCiudad,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByCiudad,true,this);
		...
		//VALORES PARA DISENO
		/*
		this.tableDatos.setMinimumSize(new Dimension(400,50));//530
		this.tableDatos.setMaximumSize(new Dimension(400,50));//530
		this.tableDatos.setPreferredSize(new Dimension(400,50));//530
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Ciudad",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.ciudad_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Ciudad",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Ciudad",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Ciudad_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Ciudad_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),CiudadBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(CiudadBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),CiudadBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(CiudadBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),CiudadBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(CiudadBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			...
			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosCiudad);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoCiudad, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorCodigoCiudad= new GridBagLayout();
		gridaBagLayoutBusquedaPorCodigoCiudad.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorCodigoCiudad.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorCodigoCiudad.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorCodigoCiudad.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorCodigo.setLayout(gridaBagLayoutBusquedaPorCodigoCiudad);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_BusquedaPorCodigo.add(lbl_codigoBusquedaPorCodigo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorCodigo.add(txf_codigoBusquedaPorCodigo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorCodigo.add(btn_BusquedaPorCodigo, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Codigo ", pnl_BusquedaPorCodigo);
		...
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombreCiudad);
		...
		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_BusquedaPorNombre.add(txa_nombreBusquedaPorNombre, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_BusquedaPorNombre.add(btn_BusquedaPorNombre, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Nombre ", pnl_BusquedaPorNombre);
		jTabbedPaneBusquedas.setMnemonicAt(1, KeyEvent.VK_2);

		GridBagLayout gridaBagLayoutFK_IdProvinciaCiudad= new GridBagLayout();
		gridaBagLayoutFK_IdProvinciaCiudad.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdProvinciaCiudad.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdProvinciaCiudad.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdProvinciaCiudad.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdProvincia.setLayout(gridaBagLayoutFK_IdProvinciaCiudad);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.ciudad_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.ciudad_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Ciudad_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.ciudad_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Ciudad_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Ciudad_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Ciudad_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Ciudad_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Ciudad_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Ciudad_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Ciudad_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Ciudad_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Ciudad> TraerBeans(List<Ciudad> ciudads,ArrayList<Classe> classes)throws Exception {
		try {
			for(Ciudad ciudad:ciudads) {
					
				if(!(Ciudad_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Ciudad_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					ciudad.setsDetalleGeneralEntityReporte(Ciudad_util.getCiudadDescripcion(ciudad));
	...
	/*
		public interface Ciudad_windowI {	
