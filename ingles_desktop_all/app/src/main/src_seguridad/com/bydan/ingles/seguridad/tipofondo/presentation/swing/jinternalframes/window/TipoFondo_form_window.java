...
public class TipoFondo_form_window extends JInternalFrameBase {	
	...
	//public TipoFondo_controlJInternalFrameAdditional jFrameDetalle;		
	...
	public TipoFondo_form_window(String sTipo) throws Exception {
	...
	public TipoFondo_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public TipoFondo_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("TipoFondo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public TipoFondo_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoFondo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoFondo_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("TipoFondo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public TipoFondo_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesTipoFondo) {
		//this.jComboBoxTiposAccionesTipoFondo = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(TipoFondo_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+TipoFondo_util.LABEL_CODIGO+" : *","Codigo");
		...
		this.pnl_codigo.setToolTipText(TipoFondo_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.tipofondo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+TipoFondo_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(TipoFondo_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new TipoFondo_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Tipo Fondo DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.tipofondo_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.tipofondo_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=TipoFondo_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=TipoFondo_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=TipoFondo_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesTipoFondo,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesTipoFondo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(TipoFondoJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new TipoFondo_controlJInternalFrameAdditional();//JInternalFrameBase("Tipo Fondo DATOS");
			...
			TipoFondo_model tipofondoModel=new TipoFondo_model(this);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& tipofondo_session.getConGuardarRelaciones()
						) {
	...
	*/
	...
	public interface TipoFondo_form_windowI {	
