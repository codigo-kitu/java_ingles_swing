...
*/
package com.bydan.ingles.general.grupo.presentation.web.jsf.sessionbean;
...
public class Grupo_session  extends GeneralEntitySessionBean {
	...
	public Grupo_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Grupo:Valor nulo no permitido en columna id");
					}
				}
