...
*/
package com.bydan.ingles.general.diccionario.presentation.web.jsf.sessionbean;
...
public class Diccionario_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionGrupo=false;
	public Long lidGrupoActual=0L;
	public Boolean isBusquedaDesdeFKSesionTipo=false;
	public Long lidTipoActual=0L;
	...
	public Diccionario_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionGrupo=false;
		//this.lidGrupoActual=0L;

		//this.isBusquedaDesdeFKSesionTipo=false;
		//this.lidTipoActual=0L;
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Diccionario:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionGrupo() {
		return isBusquedaDesdeFKSesionGrupo;
	}

	public void setisBusquedaDesdeFKSesionGrupo(
		Boolean isBusquedaDesdeFKSesionGrupo) {
		this.isBusquedaDesdeFKSesionGrupo = isBusquedaDesdeFKSesionGrupo;
	}

	public Long getlidGrupoActual() {
		return lidGrupoActual;
	}

	public void setlidGrupoActual(Long lidGrupoActual) {
		this.lidGrupoActual = lidGrupoActual;
	}
	public Boolean getisBusquedaDesdeFKSesionTipo() {
		return isBusquedaDesdeFKSesionTipo;
	}

	public void setisBusquedaDesdeFKSesionTipo(
		Boolean isBusquedaDesdeFKSesionTipo) {
		this.isBusquedaDesdeFKSesionTipo = isBusquedaDesdeFKSesionTipo;
	}

	public Long getlidTipoActual() {
		return lidTipoActual;
	}

	public void setlidTipoActual(Long lidTipoActual) {
		this.lidTipoActual = lidTipoActual;
	}
