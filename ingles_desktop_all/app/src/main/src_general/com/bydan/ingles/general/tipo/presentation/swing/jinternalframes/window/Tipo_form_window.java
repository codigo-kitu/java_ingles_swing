...
public class Tipo_form_window extends JInternalFrameBase {	
	...
	//public Tipo_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposTipo=0;
	//protected Integer iYPanelCamposTipo=0;
	
	//protected Integer iXPanelCamposOcultosTipo=0;
	//protected Integer iYPanelCamposOcultosTipo=0;
	...
	public Tipo_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleTipo=new JMenuBar();
				this.jTtoolBarDetalleTipo=new JToolBar();
				*/
	  		}
	...
	public Tipo_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Tipo_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Tipo_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Tipo_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Tipo_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesTipo) {
		//this.jComboBoxTiposAccionesTipo = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Tipo_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Tipo_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(Tipo_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.tipo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Tipo_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Tipo DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.tipo_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.tipo_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Tipo_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Tipo_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Tipo_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesTipo = new JComboBoxMe();
				//this.jComboBoxTiposAccionesTipo.setText("Accion");
		//this.jComboBoxTiposAccionesTipo.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesTipo,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesTipo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(TipoJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Tipo_controlJInternalFrameAdditional();//JInternalFrameBase("Tipo DATOS");
	        ...
	        //this.setTitle("[FOR] - Tipo DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Tipo Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Tipo_model tipoModel=new Tipo_model(this);
			
			//SI USARA CLASE INTERNA
			//TipoModel.TipoFocusTraversalPolicy tipoFocusTraversalPolicy = tipoModel.new TipoFocusTraversalPolicy(this);
			
			//tipoFocusTraversalPolicy.settipoJInternalFrame(this);
			
			this.setFocusTraversalPolicy(tipoModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& tipo_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesTipo.setVisible(false);
	...
	public void cargarSessionConBeanSwingJFrameDiccionario(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.diccionario_session.getEsGuardarRelacionado()) {
				...
				Diccionario_window.S_TIPO_TAMANIO_GENERAL=Tipo_window.S_TIPO_TAMANIO_GENERAL;
				Diccionario_window.S_TIPO_TAMANIO_GENERAL_TABLA=Tipo_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarDiccionarioBeanSwingJFrame(List<Tipo> tipos,Tipo tipo,Diccionario_control_window diccionarioBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					diccionarioBeanSwingJFrame.getDiccionarioLogic().setConnexion(this.tipoLogic.getConnexion());

					diccionarioBeanSwingJFrame.settiposFK(tipos);
					diccionarioBeanSwingJFrame.settipoFK(tipo);
					diccionarioBeanSwingJFrame.diccionario_session.setisBusquedaDesdeFKSesionTipo(true);
					diccionarioBeanSwingJFrame.diccionario_session.setlidTipoActual(tipo.getId());
					...
					diccionarioBeanSwingJFrame.setVisibilidadBusquedasParaTipo(true);
					diccionarioBeanSwingJFrame.setid_tipoFK_IdTipo(tipo.getId());

					if(!this.conCargarFormDetalle) {
						diccionarioBeanSwingJFrame.inicializarFormDetalle();
					}

					diccionarioBeanSwingJFrame.setSelectedItemCombosFrameTipoFK(tipo,1,false,true,true);
					diccionarioBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					diccionarioBeanSwingJFrame.procesarBusqueda("FK_IdTipo");
					diccionarioBeanSwingJFrame.setsAccionBusqueda("FK_IdTipo");
	...
	*/
	...
	public interface Tipo_form_windowI {	
