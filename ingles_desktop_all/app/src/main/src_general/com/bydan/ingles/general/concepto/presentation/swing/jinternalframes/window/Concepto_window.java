...
public class Concepto_window extends JInternalFrameBase {	
	...
	public Concepto_form_window jFrameDetalleForm;//_form;		
	...
	*/
	...
	public Concepto_window() throws Exception {
	...
	public Concepto_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Concepto_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Concepto_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<Concepto> getconceptosAux() {
		return this.conceptosAux;
	}

	public void setconceptosAux(List<Concepto> conceptosAux) {
		this.conceptosAux = conceptosAux;
	}
	
	public List<Concepto> getconceptosEliminados() {
		return this.conceptosEliminados;
	}

	public void setConceptosEliminados(List<Concepto> conceptosEliminados) {
		this.conceptosEliminados = conceptosEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoConcepto) {
	//	this.jCheckBoxConGraficoDinamicoConcepto = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoConcepto.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		//this.sTipoTamanioGeneral=Concepto_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Concepto_window.S_TIPO_TAMANIO_GENERAL_TABLA;
	...
	public void inicializarElementosBusquedas() {
		...
		FuncionesSwing.setLabelSize(lbl_codigoBusquedaPorCodigo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		FuncionesSwing.setLabelSize(lbl_nombreBusquedaPorNombre,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new ConceptoDetalle_window(paginaTipo);//JInternalFrameBase("Concepto DATOS");
			//_form
			this.jFrameDetalleForm = new Concepto_form_window(jDesktopPane,this.concepto_session.getConGuardarRelaciones(),this.concepto_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Concepto_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Concepto
		...
		this.tableDatos.setToolTipText(sToolTipConcepto);
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByConcepto,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByConcepto,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Concepto",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.concepto_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Concepto",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Concepto",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Concepto_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Concepto_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),ConceptoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),ConceptoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),ConceptoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosConcepto = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosConcepto);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoConcepto, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutBusquedaPorCodigoConcepto= new GridBagLayout();
		gridaBagLayoutBusquedaPorCodigoConcepto.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorCodigoConcepto.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorCodigoConcepto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorCodigoConcepto.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorCodigo.setLayout(gridaBagLayoutBusquedaPorCodigoConcepto);
		...
		GridBagLayout gridaBagLayoutBusquedaPorNombreConcepto= new GridBagLayout();
		gridaBagLayoutBusquedaPorNombreConcepto.rowHeights = new int[] {1};
		gridaBagLayoutBusquedaPorNombreConcepto.columnWidths = new int[] {1};
		gridaBagLayoutBusquedaPorNombreConcepto.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutBusquedaPorNombreConcepto.columnWeights = new double[]{0.0, 1.0};
		pnl_BusquedaPorNombre.setLayout(gridaBagLayoutBusquedaPorNombreConcepto);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.concepto_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.concepto_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Concepto_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.concepto_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Concepto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Concepto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Concepto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Concepto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Concepto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Concepto_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Concepto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Concepto_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	public void redimensionarTablaDatosConTamanio(int iTamanioFilaTabla) throws Exception {
		...
		if(Constantes.IS_USA_EJB_LOGIC_LAYER) {	
			iSizeTabla=conceptoLogic.getConceptos().size();
		} else if(Constantes.IS_USA_EJB_REMOTE || Constantes.IS_USA_EJB_HOME) {
			iSizeTabla=conceptos.size();
		}
		//ARCHITECTURE
	...
	//PARA REPORTES
	public static List<Concepto> TraerBeans(List<Concepto> conceptos,ArrayList<Classe> classes)throws Exception {
		try {
			for(Concepto concepto:conceptos) {
					
				if(!(Concepto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Concepto_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					concepto.setsDetalleGeneralEntityReporte(Concepto_util.getConceptoDescripcion(concepto));
					...
					//concepto.setsDetalleGeneralEntityReporte(concepto.getsDetalleGeneralEntityReporte());
										
				}
				
				//conceptobeans.add(conceptobean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface Concepto_windowI {	
