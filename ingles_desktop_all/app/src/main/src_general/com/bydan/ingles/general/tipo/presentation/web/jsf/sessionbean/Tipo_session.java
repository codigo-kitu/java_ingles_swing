...
*/
package com.bydan.ingles.general.tipo.presentation.web.jsf.sessionbean;
...
public class Tipo_session  extends GeneralEntitySessionBean {
	...
	public Tipo_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Tipo:Valor nulo no permitido en columna id");
					}
				}
