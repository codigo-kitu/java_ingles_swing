...
*/
package com.bydan.ingles.general.concepto.presentation.swing.jinternalframes.window;
...
public class Concepto_form_window extends JInternalFrameBase {	
	...
	//public Concepto_controlJInternalFrameAdditional jFrameDetalle;		
	
	
	//VENTANAS PARA ACTUALIZAR Y BUSCAR FK
	
	
	public Concepto_session concepto_session;
	
	

	public ConceptoDetalle_control_window conceptodetalleBeanSwingJFrame=null;
	public ConceptoDetalle_control_window conceptodetalleBeanSwingJFramePopup=null;
	public Boolean puedeCargarPorParteConceptoDetalle=false;
	public ConceptoDetalle_session conceptodetalle_session;
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposConcepto=0;
	//protected Integer iYPanelCamposConcepto=0;
	
	//protected Integer iXPanelCamposOcultosConcepto=0;
	//protected Integer iYPanelCamposOcultosConcepto=0;
	...
	public int iHeightFormulario=550;//(screenSize.height-screenSize.height/Constantes.I_SWING_RESTOPARTE_DIFERENCIA_ALTO);
	...
	public Concepto_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleConcepto=new JMenuBar();
				this.jTtoolBarDetalleConcepto=new JToolBar();
				*/
	  		}
	...
	public Concepto_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
		
		//super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Concepto_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Concepto_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Concepto_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Concepto No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Concepto_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesConcepto) {
		//this.jComboBoxTiposAccionesConcepto = jComboBoxTiposAcciones;
	//}		
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.concepto_session.getEsGuardarRelacionado();				
		...
		Concepto_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Concepto_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Concepto_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Concepto MANTENIMIENTO"));
		...
		Concepto_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Concepto_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_codigo,""+Concepto_util.LABEL_CODIGO+" : *","Codigo");
		...
		this.pnl_codigo.setToolTipText(Concepto_util.LABEL_CODIGO);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.concepto_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_codigo_Busqueda.setVisible(false);		}


					
		this.lbl_nombre = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Concepto_util.LABEL_NOMBRE+" : *","Nombre");
		...
		this.pnl_nombre.setToolTipText(Concepto_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_descripcion,""+Concepto_util.LABEL_DESCRIPCION+" : *","Descripcion");
		...
		this.pnl_descripcion.setToolTipText(Concepto_util.LABEL_DESCRIPCION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Concepto_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Concepto DATOS");
		...
		String sToolTipConcepto="";
		sToolTipConcepto=Concepto_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipConcepto+="(General.Concepto)";
		}
		
		if(!this.concepto_session.getEsGuardarRelacionado()) {
			sToolTipConcepto+="_"+this.opcionActual.getId();
		}
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.concepto_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.concepto_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Concepto_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Concepto_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Concepto_util.S_CLASS_WEB_TITULO;
		...
		this.sPath=" <---> Acceso: Concepto";
		
		if(!this.concepto_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Conceptos" + this.sPath));
		} else {
		...
		*/
		...
		//this.jComboBoxTiposAccionesConcepto = new JComboBoxMe();
				//this.jComboBoxTiposAccionesConcepto.setText("Accion");
		//this.jComboBoxTiposAccionesConcepto.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesConcepto,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesConcepto, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.concepto_session.getEsGuardarRelacionado()) {			
		...
		//if(ConceptoJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Concepto_controlJInternalFrameAdditional();//JInternalFrameBase("Concepto DATOS");
	        ...
	        //this.setTitle("[FOR] - Concepto DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Concepto Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Concepto_model conceptoModel=new Concepto_model(this);
			
			//SI USARA CLASE INTERNA
			//ConceptoModel.ConceptoFocusTraversalPolicy conceptoFocusTraversalPolicy = conceptoModel.new ConceptoFocusTraversalPolicy(this);
			
			//conceptoFocusTraversalPolicy.setconceptoJInternalFrame(this);
			
			this.setFocusTraversalPolicy(conceptoModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& concepto_session.getConGuardarRelaciones()
						) {
					//paraCargarPorParte es false por defecto(y ejecuta funcion normal cargando detalle en tab panel), si se utiliza funcionalidad es true y carga tab panel auxiliar temporal
					
					this.cargarSessionConBeanSwingJFrameConceptoDetalle(this.puedeCargarPorParteConceptoDetalle,false,-1);
					...
					;
						...
						//this.jButtonNuevoRelacionesConcepto.setVisible(false);
						
					this.cargarSessionConBeanSwingJFrameConceptoDetalle(true,false,-1);
					}
				}
			}
	...
	public void cargarSessionConBeanSwingJFrameConceptoDetalle(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {

		//SOLO INICIALIZA SESSION (YA NO, CONSUME MUCHA MEMORIA)
		this.conceptodetalle_session=new ConceptoDetalle_session();
		this.conceptodetalle_session.setConGuardarRelaciones(false);
		this.conceptodetalle_session.setEsGuardarRelacionado(true);

		this.conceptodetalleBeanSwingJFrame=null;//new ConceptoDetalleBeanSwingJInternalFrame(false,true,false);

		if(!soloSession) {
			//this.conceptodetalleBeanSwingJFramePopup=new ConceptoDetalleBeanSwingJInternalFrame(true,false,jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,false,false,true);
			//this.conceptodetalleBeanSwingJFramePopup.jFrameParent=this;


			if(this.conceptodetalle_session.getEsGuardarRelacionado()) {

				ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL=Concepto_window.S_TIPO_TAMANIO_GENERAL;
				ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=Concepto_window.S_TIPO_TAMANIO_GENERAL;

				this.conceptodetalle_session.setEsGuardarRelacionado(true);

				this.conceptodetalleBeanSwingJFrame=new ConceptoDetalle_control_window(true,false,jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,PaginaTipo.SECUNDARIO,false,true,false,false);//false->4

				this.conceptodetalleBeanSwingJFrame.setJFrameParent(this);
				this.conceptodetalleBeanSwingJFrame.setconceptodetalle_session(this.conceptodetalle_session);

				//this.gridBagConstraints = new GridBagConstraints();
				//this.gridBagConstraints.gridy = gxy.iGridyRelaciones++;
				//this.gridBagConstraints.gridx = 0;
				//this.jContentPaneDetalle.add(this.conceptodetalleBeanSwingJFrame.getContentPane(), this.gridBagConstraints);

				if(!actualizarTab) {
					this.jTabbedPaneRelaciones.add("Concepto Detalles",this.conceptodetalleBeanSwingJFrame.getContentPane());
				} else {
					this.jTabbedPaneRelaciones.setComponentAt(iIndexTab,this.conceptodetalleBeanSwingJFrame.getContentPane());
				}

				//ConceptoDetalleJInternalFrame.ESTA_CARGADO_PORPARTE=true;
			} else {
				this.conceptodetalle_session.setEsGuardarRelacionado(false);
				this.conceptodetalleBeanSwingJFrame=null;//new ConceptoDetalleBeanSwingJInternalFrame(false,false,jDesktopPane,this.usuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,false,false,false);
			}
		} else {
			if(this.conceptodetalle_session.getEsGuardarRelacionado()) {
				if(this.puedeCargarPorParteConceptoDetalle) {
					this.jTabbedPaneRelaciones.add("Concepto Detalles",new JPanel());
				}
			}
		}
	}
		...
		public void cargarConceptoDetalleBeanSwingJFrame(List<Concepto> conceptos,Concepto concepto,ConceptoDetalle_control_window conceptodetalleBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					//GETCONTENTPANE SOLO UN PAPA, SE PIERDE PANEL, POR LO QUE SE CREA NUEVO POR CADA PANTALLA
					//conceptodetalleBeanSwingJFrame=new ConceptoDetalleBeanSwingJInternalFrame(false,false,this.jDesktopPane,this.usuarioActual,this.resumenUsuarioActual,this.moduloActual,this.opcionActual,this.parametroGeneralSg,this.parametroGeneralUsuario,conGuardarRelaciones,esGuardarRelacionado);

				}
					conceptodetalleBeanSwingJFrame.getConceptoDetalleLogic().setConnexion(this.conceptoLogic.getConnexion());

					conceptodetalleBeanSwingJFrame.setconceptosFK(conceptos);
					conceptodetalleBeanSwingJFrame.setconceptoFK(concepto);
					conceptodetalleBeanSwingJFrame.conceptodetalle_session.setisBusquedaDesdeFKSesionConcepto(true);
					conceptodetalleBeanSwingJFrame.conceptodetalle_session.setlidConceptoActual(concepto.getId());
					...
					conceptodetalleBeanSwingJFrame.cargarCombosFK(conceptodetalleBeanSwingJFrame.isCargarCombosDependencia);
					conceptodetalleBeanSwingJFrame.setVisibilidadBusquedasParaConcepto(true);
					conceptodetalleBeanSwingJFrame.setid_conceptoFK_IdConcepto(concepto.getId());

					if(!this.conCargarFormDetalle) {
						conceptodetalleBeanSwingJFrame.inicializarFormDetalle();
					}

					conceptodetalleBeanSwingJFrame.setSelectedItemCombosFrameConceptoFK(concepto,1,false,true,true);
					conceptodetalleBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					conceptodetalleBeanSwingJFrame.procesarBusqueda("FK_IdConcepto");
					conceptodetalleBeanSwingJFrame.setsAccionBusqueda("FK_IdConcepto");
					conceptodetalleBeanSwingJFrame.inicializarActualizarBindingTabla(true);
					conceptodetalleBeanSwingJFrame.actualizarEstadoCeldasBotones("n",conceptodetalleBeanSwingJFrame.isGuardarCambiosEnLote, conceptodetalleBeanSwingJFrame.isEsMantenimientoRelacionado);
					conceptodetalleBeanSwingJFrame.setAutoscrolls(true);
					conceptodetalleBeanSwingJFrame.setVisible(true);

					if(esGuardarRelacionado) {
						conceptodetalleBeanSwingJFrame.actualizarEstadoPanels("relacionado");
					} else {
						conceptodetalleBeanSwingJFrame.actualizarEstadoPanels("no_relacionado");
					}

					conceptodetalleBeanSwingJFrame.jPanelPaginacion.getbtn_RecargarInformacion().setVisible(false);
	...
	*/
	...
	public interface Concepto_form_windowI {	
