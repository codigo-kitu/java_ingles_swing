...
*/
package com.bydan.ingles.general.conceptodetalle.presentation.web.jsf.sessionbean;
...
public class ConceptoDetalle_session  extends GeneralEntitySessionBean {
	...
	public Boolean isBusquedaDesdeFKSesionConcepto=false;
	public Long lidConceptoActual=0L;
	...
	public ConceptoDetalle_session () throws Exception {
	...
	public void inicializar_session () throws Exception {	
		...
		//this.isBusquedaDesdeFKSesionConcepto=false;
		//this.lidConceptoActual=0L; 
		//FOREIGN_KEY_FIN
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("ConceptoDetalle:Valor nulo no permitido en columna id");
					}
				}
	...
	public Boolean getisBusquedaDesdeFKSesionConcepto() {
		return isBusquedaDesdeFKSesionConcepto;
	}

	public void setisBusquedaDesdeFKSesionConcepto(
		Boolean isBusquedaDesdeFKSesionConcepto) {
		this.isBusquedaDesdeFKSesionConcepto = isBusquedaDesdeFKSesionConcepto;
	}

	public Long getlidConceptoActual() {
		return lidConceptoActual;
	}

	public void setlidConceptoActual(Long lidConceptoActual) {
		this.lidConceptoActual = lidConceptoActual;
	}
