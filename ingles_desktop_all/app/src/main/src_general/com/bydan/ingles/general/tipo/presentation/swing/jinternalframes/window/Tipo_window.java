...
*/
package com.bydan.ingles.general.tipo.presentation.swing.jinternalframes.window;
...
public class Tipo_window extends JInternalFrameBase {	
	...
	public Tipo_form_window jFrameDetalleForm;//_form;		
	...
	public List<Tipo> tiposEliminados;	
	public List<Tipo> tiposAux;
	...
	*/
	...
	public Tipo_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Tipo_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Tipo_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Tipo_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Tipo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<Tipo> gettiposAux() {
		return this.tiposAux;
	}

	public void settiposAux(List<Tipo> tiposAux) {
		this.tiposAux = tiposAux;
	}
	
	public List<Tipo> gettiposEliminados() {
		return this.tiposEliminados;
	}

	public void setTiposEliminados(List<Tipo> tiposEliminados) {
		this.tiposEliminados = tiposEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoTipo) {
	//	this.jCheckBoxConGraficoDinamicoTipo = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoTipo.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		this.tipo_session=new Tipo_session();
		
		this.tipo_session.setConGuardarRelaciones(conGuardarRelaciones);
		this.tipo_session.setEsGuardarRelacionado(esGuardarRelacionado);
		
		
		this.conCargarMinimo=this.tipo_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=Tipo_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Tipo_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		Tipo_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Tipo_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Tipo_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Tipo MANTENIMIENTO"));
		...
		Tipo_window.ESTA_CARGADO_PORPARTE=true;
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new TipoDetalle_window(paginaTipo);//JInternalFrameBase("Tipo DATOS");
			//_form
			this.jFrameDetalleForm = new Tipo_form_window(jDesktopPane,this.tipo_session.getConGuardarRelaciones(),this.tipo_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Tipo_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Tipo
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipTipo="";
		sToolTipTipo=Tipo_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipTipo+="(General.Tipo)";
		}
		
		if(!this.tipo_session.getEsGuardarRelacionado()) {
			sToolTipTipo+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipTipo);
		...
		this.sPath=" <---> Acceso: Tipo";
		
		if(!this.tipo_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Tipos" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipo,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByTipo,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Tipo",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,true);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.tipo_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Tipo",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Tipo",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Tipo_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Tipo_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),TipoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),TipoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),TipoBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(TipoBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosTipo = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosTipo);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoTipo, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.tipo_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(Tipo_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.tipo_session.getConGuardarRelaciones()
			) {
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Tipo_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.tipo_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Tipo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Tipo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Tipo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Tipo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Tipo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Tipo_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Tipo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Tipo_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Tipo> TraerBeans(List<Tipo> tipos,ArrayList<Classe> classes)throws Exception {
		try {
			for(Tipo tipo:tipos) {
					
				if(!(Tipo_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Tipo_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					tipo.setsDetalleGeneralEntityReporte(Tipo_util.getTipoDescripcion(tipo));
					...
					//tipo.setsDetalleGeneralEntityReporte(tipo.getsDetalleGeneralEntityReporte());
										
				}
				
				//tipobeans.add(tipobean);
			}
		} catch(Exception ex) {
			throw ex;
		}
