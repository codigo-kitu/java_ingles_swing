...
public class Grupo_form_window extends JInternalFrameBase {	
	...
	//public Grupo_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposGrupo=0;
	//protected Integer iYPanelCamposGrupo=0;
	
	//protected Integer iXPanelCamposOcultosGrupo=0;
	//protected Integer iYPanelCamposOcultosGrupo=0;
	...
	public Grupo_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleGrupo=new JMenuBar();
				this.jTtoolBarDetalleGrupo=new JToolBar();
				*/
	  		}
	...
	public Grupo_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public Grupo_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("Grupo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public Grupo_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grupo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grupo_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Grupo No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Grupo_form_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesGrupo) {
		//this.jComboBoxTiposAccionesGrupo = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(Grupo_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_nombre,""+Grupo_util.LABEL_NOMBRE+" :","Nombre");
		...
		this.pnl_nombre.setToolTipText(Grupo_util.LABEL_NOMBRE);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.grupo_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new Grupo_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Grupo DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.grupo_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.grupo_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=Grupo_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=Grupo_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=Grupo_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesGrupo = new JComboBoxMe();
				//this.jComboBoxTiposAccionesGrupo.setText("Accion");
		//this.jComboBoxTiposAccionesGrupo.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesGrupo,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesGrupo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(GrupoJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new Grupo_controlJInternalFrameAdditional();//JInternalFrameBase("Grupo DATOS");
	        ...
	        //this.setTitle("[FOR] - Grupo DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Grupo Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			Grupo_model grupoModel=new Grupo_model(this);
			
			//SI USARA CLASE INTERNA
			//GrupoModel.GrupoFocusTraversalPolicy grupoFocusTraversalPolicy = grupoModel.new GrupoFocusTraversalPolicy(this);
			
			//grupoFocusTraversalPolicy.setgrupoJInternalFrame(this);
			
			this.setFocusTraversalPolicy(grupoModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& grupo_session.getConGuardarRelaciones()
						) {
					...
					;
						...
						//this.jButtonNuevoRelacionesGrupo.setVisible(false);
	...
	public void cargarSessionConBeanSwingJFrameDiccionario(Boolean soloSession,Boolean actualizarTab,Integer iIndexTab) throws Exception {
		...
		if(!soloSession) {
			...
			if(this.diccionario_session.getEsGuardarRelacionado()) {
				...
				Diccionario_window.S_TIPO_TAMANIO_GENERAL=Grupo_window.S_TIPO_TAMANIO_GENERAL;
				Diccionario_window.S_TIPO_TAMANIO_GENERAL_TABLA=Grupo_window.S_TIPO_TAMANIO_GENERAL;
		...
		public void cargarDiccionarioBeanSwingJFrame(List<Grupo> grupos,Grupo grupo,Diccionario_control_window diccionarioBeanSwingJFrame,/*Boolean conInicializar,*/Boolean conGuardarRelaciones,Boolean esGuardarRelacionado) throws Exception 
		{
			try
			{
				if(true/*conInicializar*/) {
					...
					diccionarioBeanSwingJFrame.getDiccionarioLogic().setConnexion(this.grupoLogic.getConnexion());

					diccionarioBeanSwingJFrame.setgruposFK(grupos);
					diccionarioBeanSwingJFrame.setgrupoFK(grupo);
					diccionarioBeanSwingJFrame.diccionario_session.setisBusquedaDesdeFKSesionGrupo(true);
					diccionarioBeanSwingJFrame.diccionario_session.setlidGrupoActual(grupo.getId());
					...
					diccionarioBeanSwingJFrame.setVisibilidadBusquedasParaGrupo(true);
					diccionarioBeanSwingJFrame.setid_grupoFK_IdGrupo(grupo.getId());

					if(!this.conCargarFormDetalle) {
						diccionarioBeanSwingJFrame.inicializarFormDetalle();
					}

					diccionarioBeanSwingJFrame.setSelectedItemCombosFrameGrupoFK(grupo,1,false,true,true);
					diccionarioBeanSwingJFrame.setiNumeroPaginacion(Funciones2.getPaginacionDefecto("RELACIONADO"));
					diccionarioBeanSwingJFrame.procesarBusqueda("FK_IdGrupo");
					diccionarioBeanSwingJFrame.setsAccionBusqueda("FK_IdGrupo");
	...
	*/
	...
	public interface Grupo_form_windowI {	
