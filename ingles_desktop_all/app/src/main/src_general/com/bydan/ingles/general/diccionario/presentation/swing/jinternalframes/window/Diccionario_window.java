...
*/
package com.bydan.ingles.general.diccionario.presentation.swing.jinternalframes.window;
...
public class Diccionario_window extends JInternalFrameBase {	
	...
	public Diccionario_form_window jFrameDetalleForm;//_form;		
	...
	public Grupo_control_window grupoBeanSwingJFrame;
	public String sFinalQueryGeneral_grupo="";

	public Tipo_control_window tipoBeanSwingJFrame;
	public String sFinalQueryGeneral_tipo="";
	...
	public Grupo_session grupo_session;
	public Tipo_session tipo_session;
	...
	public JPanel pnl_FK_IdGrupo;
	public JButton btn_FK_IdGrupo;
	public JPanel pnl_FK_IdNivel;
	public JButton btn_FK_IdNivel;
	public JPanel pnl_FK_IdTipo;
	public JButton btn_FK_IdTipo;
	...
	public JPanel pnlid_grupoFK_IdGrupo;
	public JLabel lbl_id_grupoFK_IdGrupo;
	public JComboBoxMe cmb_id_grupoFK_IdGrupo;
	public JButton btn_id_grupoFK_IdGrupo= new JButton();
	public JButton btn_id_grupoFK_IdGrupo_Update= new JButton();
	public JButton btn_id_grupoFK_IdGrupo_Busqueda= new JButton();
	...
	public JPanel pnlid_tipoFK_IdTipo;
	public JLabel lbl_id_tipoFK_IdTipo;
	public JComboBoxMe cmb_id_tipoFK_IdTipo;
	public JButton btn_id_tipoFK_IdTipo= new JButton();
	public JButton btn_id_tipoFK_IdTipo_Update= new JButton();
	public JButton btn_id_tipoFK_IdTipo_Busqueda= new JButton();
	...
	//public int iHeightFormulario=726;//(screenSize.height-screenSize.height/Constantes.I_SWING_RESTOPARTE_DIFERENCIA_ALTO);
	...
	*/
	...
	public Diccionario_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("Diccionario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Diccionario_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public Diccionario_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Diccionario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public Diccionario_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("Diccionario No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<Diccionario> getdiccionariosAux() {
		return this.diccionariosAux;
	}

	public void setdiccionariosAux(List<Diccionario> diccionariosAux) {
		this.diccionariosAux = diccionariosAux;
	}
	
	public List<Diccionario> getdiccionariosEliminados() {
		return this.diccionariosEliminados;
	}

	public void setDiccionariosEliminados(List<Diccionario> diccionariosEliminados) {
		this.diccionariosEliminados = diccionariosEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoDiccionario) {
	//	this.jCheckBoxConGraficoDinamicoDiccionario = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoDiccionario.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conCargarMinimo=this.diccionario_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=Diccionario_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=Diccionario_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		Diccionario_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		Diccionario_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		Diccionario_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Diccionario MANTENIMIENTO"));
		...
		Diccionario_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		FuncionesSwing.setLabelSize(lbl_id_areaFK_IdArea,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		this.pnl_FK_IdGrupo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdGrupo.setToolTipText("Buscar Por Grupo ");
		this.btn_FK_IdGrupo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdGrupo,"buscar_button","Buscar","Buscar Por Grupo ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdGrupo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdGrupo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_grupoFK_IdGrupo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_grupoFK_IdGrupo,"Grupo :","Grupo");
		FuncionesSwing.setLabelSize(lbl_id_grupoFK_IdGrupo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_grupoFK_IdGrupo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_grupoFK_IdGrupo,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_grupoFK_IdGrupo= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_grupoFK_IdGrupo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_grupoFK_IdGrupo,this.sTipoTamanioGeneral,false,true,this);
		...
		FuncionesSwing.setLabelSize(lbl_id_nivelFK_IdNivel,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);
		...
		this.pnl_FK_IdTipo=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdTipo.setToolTipText("Buscar Por Tipo ");
		this.btn_FK_IdTipo= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdTipo,"buscar_button","Buscar","Buscar Por Tipo ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdTipo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdTipo, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_tipoFK_IdTipo = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_tipoFK_IdTipo,"Tipo :","Tipo");
		FuncionesSwing.setLabelSize(lbl_id_tipoFK_IdTipo,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-43),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_tipoFK_IdTipo,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_tipoFK_IdTipo,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_tipoFK_IdTipo= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_tipoFK_IdTipo,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_tipoFK_IdTipo,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new DiccionarioDetalle_window(paginaTipo);//JInternalFrameBase("Diccionario DATOS");
			//_form
			this.jFrameDetalleForm = new Diccionario_form_window(jDesktopPane,this.diccionario_session.getConGuardarRelaciones(),this.diccionario_session.getEsGuardarRelacionado(),cargarRelaciones,usuarioActual,resumenUsuarioActual,moduloActual,opcionActual,parametroGeneralSg,parametroGeneralUsuario,paginaTipo);
		} else {
			//_form
			this.jFrameDetalleForm = null;//new Diccionario_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//Diccionario
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipDiccionario="";
		sToolTipDiccionario=Diccionario_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipDiccionario+="(General.Diccionario)";
		}
		
		if(!this.diccionario_session.getEsGuardarRelacionado()) {
			sToolTipDiccionario+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipDiccionario);
		...
		this.sPath=" <---> Acceso: Diccionario";
		
		if(!this.diccionario_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Diccionarios" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByDiccionario,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByDiccionario,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"Diccionario",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.diccionario_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"Diccionario",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"Diccionario",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+Diccionario_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+Diccionario_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),DiccionarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DiccionarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),DiccionarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DiccionarioBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),DiccionarioBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(DiccionarioBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosDiccionario = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosDiccionario);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoDiccionario, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdAreaDiccionario= new GridBagLayout();
		gridaBagLayoutFK_IdAreaDiccionario.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdAreaDiccionario.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdAreaDiccionario.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdAreaDiccionario.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdArea.setLayout(gridaBagLayoutFK_IdAreaDiccionario);
		...
		jTabbedPaneBusquedas.addTab("1.-Por Area ", pnl_FK_IdArea);
		jTabbedPaneBusquedas.setMnemonicAt(0, KeyEvent.VK_1);

		GridBagLayout gridaBagLayoutFK_IdGrupoDiccionario= new GridBagLayout();
		gridaBagLayoutFK_IdGrupoDiccionario.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdGrupoDiccionario.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdGrupoDiccionario.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdGrupoDiccionario.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdGrupo.setLayout(gridaBagLayoutFK_IdGrupoDiccionario);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdGrupo.add(lbl_id_grupoFK_IdGrupo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdGrupo.add(cmb_id_grupoFK_IdGrupo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdGrupo.add(btn_FK_IdGrupo, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("2.-Por Grupo ", pnl_FK_IdGrupo);
		jTabbedPaneBusquedas.setMnemonicAt(1, KeyEvent.VK_2);

		GridBagLayout gridaBagLayoutFK_IdNivelDiccionario= new GridBagLayout();
		gridaBagLayoutFK_IdNivelDiccionario.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdNivelDiccionario.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdNivelDiccionario.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdNivelDiccionario.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdNivel.setLayout(gridaBagLayoutFK_IdNivelDiccionario);
		...
		jTabbedPaneBusquedas.addTab("3.-Por Nivel ", pnl_FK_IdNivel);
		jTabbedPaneBusquedas.setMnemonicAt(2, KeyEvent.VK_3);

		GridBagLayout gridaBagLayoutFK_IdTipoDiccionario= new GridBagLayout();
		gridaBagLayoutFK_IdTipoDiccionario.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdTipoDiccionario.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdTipoDiccionario.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdTipoDiccionario.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdTipo.setLayout(gridaBagLayoutFK_IdTipoDiccionario);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdTipo.add(lbl_id_tipoFK_IdTipo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdTipo.add(cmb_id_tipoFK_IdTipo, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdTipo.add(btn_FK_IdTipo, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("4.-Por Tipo ", pnl_FK_IdTipo);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.diccionario_session.getEsGuardarRelacionado()) {			
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.diccionario_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//Diccionario_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.diccionario_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > Diccionario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Diccionario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Diccionario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Diccionario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > Diccionario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=Diccionario_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < Diccionario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=Diccionario_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<Diccionario> TraerBeans(List<Diccionario> diccionarios,ArrayList<Classe> classes)throws Exception {
		try {
			for(Diccionario diccionario:diccionarios) {
					
				if(!(Diccionario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || Diccionario_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					diccionario.setsDetalleGeneralEntityReporte(Diccionario_util.getDiccionarioDescripcion(diccionario));
					...
					//diccionario.setsDetalleGeneralEntityReporte(diccionario.getsDetalleGeneralEntityReporte());
										
				}
				
				//diccionariobeans.add(diccionariobean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface Diccionario_windowI {	
