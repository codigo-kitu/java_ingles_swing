...
public class ConceptoDetalle_form_window extends JInternalFrameBase {	
	...
	//public ConceptoDetalle_controlJInternalFrameAdditional jFrameDetalle;		
	...
	//Usa los de GridXy
	//protected Integer iXPanelCamposConceptoDetalle=0;
	//protected Integer iYPanelCamposConceptoDetalle=0;
	
	//protected Integer iXPanelCamposOcultosConceptoDetalle=0;
	//protected Integer iYPanelCamposOcultosConceptoDetalle=0;
	...
	public JPanel pnl_id_concepto;
	public JLabel lbl_id_concepto;
	public JComboBoxMe cmb_id_concepto;
	public JButton btn_id_concepto= new JButton();
	public JButton btn_id_concepto_Update= new JButton();
	public JButton btn_id_concepto_Busqueda= new JButton();
	...
	public ConceptoDetalle_form_window(String sTipo) throws Exception {
		...
		try {
	  		...
	  		if(sTipo.equals("MINIMO")) {
				...
				this.jmenuBarDetalleConceptoDetalle=new JMenuBar();
				this.jTtoolBarDetalleConceptoDetalle=new JToolBar();
				*/
	  		}
	...
	public ConceptoDetalle_form_window(PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo); 
	...
	public ConceptoDetalle_form_window() throws Exception {
		super(PaginaTipo.FORMULARIO);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
			Boolean cargarRelaciones=false;
	...
	public ConceptoDetalle_form_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ConceptoDetalle_form_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	//public void setjComboBoxTiposAcciones(
			//JComboBoxMe jComboBoxTiposAccionesConceptoDetalle) {
		//this.jComboBoxTiposAccionesConceptoDetalle = jComboBoxTiposAcciones;
	//}		
	...
	public void inicializarElementosCampos() {
		...
		this.pnl_id.setToolTipText(ConceptoDetalle_util.LABEL_ID);
		...
		FuncionesSwing.setLabelProp(this.lbl_idea,""+ConceptoDetalle_util.LABEL_IDEA+" : *","Idea");
		FuncionesSwing.setLabelSize(this.lbl_idea,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));
		...
		this.pnl_idea.setToolTipText(ConceptoDetalle_util.LABEL_IDEA);
		this.gridaBagLayout = new GridBagLayout();
		...
		if(this.conceptodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_idea_Busqueda.setVisible(false);		}


					
		this.lbl_traduccion = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_traduccion,""+ConceptoDetalle_util.LABEL_TRADUCCION+" :","Traduccion");
		...
		this.pnl_traduccion.setToolTipText(ConceptoDetalle_util.LABEL_TRADUCCION);
		this.gridaBagLayout = new GridBagLayout();
		...
		FuncionesSwing.setLabelProp(this.lbl_pronunciacion,""+ConceptoDetalle_util.LABEL_PRONUNCIACION+" :","Pronunciacion");
		...
		this.pnl_pronunciacion.setToolTipText(ConceptoDetalle_util.LABEL_PRONUNCIACION);
		this.gridaBagLayout = new GridBagLayout();
	...
	public void inicializarElementosCamposFKs() {
		...
		this.lbl_id_concepto = new JLabel();
		FuncionesSwing.setLabelProp(this.lbl_id_concepto,""+ConceptoDetalle_util.LABEL_IDCONCEPTO+" : *","Concepto");
		FuncionesSwing.setLabelSize(this.lbl_id_concepto,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes2.I_SWING_ALTO_CONTROL_LABEL,0));

		FuncionesSwing.setBoldLabel(lbl_id_concepto,this.sTipoTamanioGeneral,false,false,this);

		FuncionesSwing.setBoldComponent(lbl_id_concepto,this.sTipoTamanioGeneral,false,false,this);

		
		this.pnl_id_concepto=new JPanelMe("fondo_formulario",true);//new JPanel();

		this.pnl_id_concepto.setToolTipText(ConceptoDetalle_util.LABEL_IDCONCEPTO);
		this.gridaBagLayout = new GridBagLayout();
		this.pnl_id_concepto.setLayout(this.gridaBagLayout);


		cmb_id_concepto= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_concepto,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));

		FuncionesSwing.setBoldComboBox(cmb_id_concepto,this.sTipoTamanioGeneral,false,false,this);

		this.btn_id_concepto= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_concepto,50,Constantes.I_SWING_ALTO_CONTROL);
		this.btn_id_concepto.setText("Buscar");
		this.btn_id_concepto.setToolTipText("Buscar ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA")+")");
		this.btn_id_concepto.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_concepto,"buscar_form","Buscar");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSQUEDA");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSQUEDA");
		cmb_id_concepto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_concepto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_conceptoConceptoDetalle"));

		this.btn_id_concepto_Busqueda= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_concepto_Busqueda,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);		//this.btn_id_concepto_Busqueda.setText("U");
		this.btn_id_concepto_Busqueda.setToolTipText("BUSCAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR")+")");
		this.btn_id_concepto_Busqueda.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_concepto_Busqueda,"buscardatos","BUSCAR DATOS");

		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_BUSCAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_BUSCAR");
		cmb_id_concepto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_concepto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_concepto_Busqueda"));

		if(this.conceptodetalle_session.getEsGuardarRelacionado() || paginaTipo.equals(PaginaTipo.SECUNDARIO)) {
		this.btn_id_concepto_Busqueda.setVisible(false);		}

		this.btn_id_concepto_Update= new JButton();
		FuncionesSwing.setButtonSize(this.btn_id_concepto_Update,Constantes2.I_SWING_ANCHO_CONTROL_BOTON_ICONO,Constantes2.I_SWING_ALTO_CONTROL_BOTON_ICONO);
		//this.btn_id_concepto_Update.setText("U");
		this.btn_id_concepto_Update.setToolTipText("ACTUALIZAR DATOS ("+FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR")+")");
		this.btn_id_concepto_Update.setFocusable(false);
		FuncionesSwing.addImagenButtonGeneral(this.btn_id_concepto_Update,"actualizardatos","ACTUALIZAR DATOS");
		sKeyStrokeName = FuncionesSwing.getKeyNameControl("CONTROL_ACTUALIZAR");
		keyStrokeControl=FuncionesSwing.getKeyStrokeControl( "CONTROL_ACTUALIZAR");
		cmb_id_concepto.getInputMap().put(keyStrokeControl, sKeyStrokeName);
		cmb_id_concepto.getActionMap().put(sKeyStrokeName, new ButtonAbstractAction(this,"id_conceptoConceptoDetalleUpdate"));
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		//CARGAR MENUS
		//this.jFrameDetalle = new ConceptoDetalle_controlJInternalFrameAdditional(paginaTipo);//JInternalFrameBase("Concepto Detalle DATOS");
		...
		this.jPanelAccionesBotonesFormulario = new JPanelAccionesBotonesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),this.sTipoTamanioGeneral,this.conceptodetalle_session.getEsGuardarRelacionado());               
		//this.jPanelAccionesFormulario = new JPanelMe(FuncionesSwing.getFondoImagen(parametroGeneralUsuario.getid_tipo_fondo()),true);               
		this.jPanelAccionesFormulario = new JPanelAccionesFormulario(this,parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.sTipoTamanioGeneral,this.conceptodetalle_session.getEsGuardarRelacionado(),false,false,false);
		...
		this.jPanelAccionesBotonesFormulario.sNombreClase=ConceptoDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelAccionesFormulario.sNombreClase=ConceptoDetalle_util.S_CLASS_WEB_TITULO;
		this.jPanelToolBarDetalle.sNombreClase=ConceptoDetalle_util.S_CLASS_WEB_TITULO;
		...
		*/
		...
		//this.jComboBoxTiposAccionesConceptoDetalle = new JComboBoxMe();
				//this.jComboBoxTiposAccionesConceptoDetalle.setText("Accion");
		//this.jComboBoxTiposAccionesConceptoDetalle.setToolTipText("Tipos de Acciones");
		...
		*/
		...
		//FuncionesSwing.setComboBoxSize(this.jComboBoxTiposAccionesConceptoDetalle,145,20);
		//FuncionesSwing.setBoldComboBox(this.jComboBoxTiposAccionesConceptoDetalle, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	...
	this.pnl_id_concepto.add(lbl_id_concepto, this.gridBagConstraints);
	...
	if(this.conMostrarAccionesCampo) {//Busqueda_General
		...
		this.pnl_id_concepto.add(btn_id_concepto_Busqueda, this.gridBagConstraints);
	}
	...
	if(this.conMostrarAccionesCampo) {//Actualizar_FK
		...
		this.pnl_id_concepto.add(btn_id_concepto_Update, this.gridBagConstraints);
	}

	this.gridBagConstraints = new GridBagConstraints();
	GridXy.SetGridBagPropIpad(this.gridBagConstraints,GridBagConstraints.HORIZONTAL,1,0,0);
	this.gridBagConstraints.insets = new Insets(Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING_LEFT, Constantes2.I_CELLSPACING, Constantes2.I_CELLSPACING);
	this.pnl_id_concepto.add(cmb_id_concepto, this.gridBagConstraints);
	...
	this.jPanelCampos.add(this.pnl_id_concepto, this.gridBagConstraints);
	...
	if(gxy.iXPanelCampos % 1==0) {
		...
		//if(ConceptoDetalleJInternalFrame.CON_DATOS_FRAME) {				
			//this.jFrameDetalle = new ConceptoDetalle_controlJInternalFrameAdditional();//JInternalFrameBase("Concepto Detalle DATOS");
	        ...
	        //this.setTitle("[FOR] - Concepto Detalle DATOS");
			
			this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.usuarioActual,"Concepto Detalle Formulario",PaginaTipo.FORMULARIO,paginaTipo));			
			...
			ConceptoDetalle_model conceptodetalleModel=new ConceptoDetalle_model(this);
			
			//SI USARA CLASE INTERNA
			//ConceptoDetalleModel.ConceptoDetalleFocusTraversalPolicy conceptodetalleFocusTraversalPolicy = conceptodetalleModel.new ConceptoDetalleFocusTraversalPolicy(this);
			
			//conceptodetalleFocusTraversalPolicy.setconceptodetalleJInternalFrame(this);
			
			this.setFocusTraversalPolicy(conceptodetalleModel);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar()) {				
			...
			if(conMaximoRelaciones) { // && this.conFuncionalidadRelaciones) {
				if(!this.conCargarMinimo) {
					if(cargarRelaciones 
						&& conceptodetalle_session.getConGuardarRelaciones()
						) {
					//paraCargarPorParte es false por defecto(y ejecuta funcion normal cargando detalle en tab panel), si se utiliza funcionalidad es true y carga tab panel auxiliar temporal
					
					
					if(this.conceptodetalle_session.getConGuardarRelaciones()) {
						this.gridBagConstraints= new GridBagConstraints();
						GridXy.SetGridBagProp(this.gridBagConstraints,0,gxy.iGridyRelaciones++);
					...
					;
						...
						//this.jButtonNuevoRelacionesConceptoDetalle.setVisible(false);
	...
	*/
	...
	public interface ConceptoDetalle_form_windowI {	
