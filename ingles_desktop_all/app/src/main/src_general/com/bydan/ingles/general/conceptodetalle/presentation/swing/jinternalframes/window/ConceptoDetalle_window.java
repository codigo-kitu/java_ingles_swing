...
*/
package com.bydan.ingles.general.conceptodetalle.presentation.swing.jinternalframes.window;
...
public class ConceptoDetalle_window extends JInternalFrameBase {	
	...
	public ConceptoDetalle_form_window jFrameDetalleForm;//_form;		
	...
	public Concepto_control_window conceptoBeanSwingJFrame;
	public String sFinalQueryGeneral_concepto="";
	...
	public List<ConceptoDetalle> conceptodetallesEliminados;	
	public List<ConceptoDetalle> conceptodetallesAux;
	...
	public ConceptoDetalle_logic conceptodetalleLogic;
	...
	public JPanel pnl_FK_IdConcepto;
	public JButton btn_FK_IdConcepto;
	
	public JPanel pnlid_conceptoFK_IdConcepto;
	public JLabel lbl_id_conceptoFK_IdConcepto;
	public JComboBoxMe cmb_id_conceptoFK_IdConcepto;
	public JButton btn_id_conceptoFK_IdConcepto= new JButton();
	public JButton btn_id_conceptoFK_IdConcepto_Update= new JButton();
	public JButton btn_id_conceptoFK_IdConcepto_Busqueda= new JButton();
	...
	*/
	...
	public ConceptoDetalle_window() throws Exception {
		super(PaginaTipo.PRINCIPAL);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ConceptoDetalle_window(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
	...
	public ConceptoDetalle_window(Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public ConceptoDetalle_window(Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,PaginaTipo paginaTipo) throws Exception {
		super(paginaTipo);
        //super("ConceptoDetalle No " + (++openFrameCount),true, /*resizable*/true, /*closable*/true, /*maximizable*/true);//iconifiable
	  	try {
	...
	public List<ConceptoDetalle> getconceptodetalles() {
		return this.conceptodetalles;
	}

	public void setconceptodetalles(List<ConceptoDetalle> conceptodetalles) {
		this.conceptodetalles = conceptodetalles;
	}
	
	public List<ConceptoDetalle> getconceptodetallesAux() {
		return this.conceptodetallesAux;
	}

	public void setconceptodetallesAux(List<ConceptoDetalle> conceptodetallesAux) {
		this.conceptodetallesAux = conceptodetallesAux;
	}
	
	public List<ConceptoDetalle> getconceptodetallesEliminados() {
		return this.conceptodetallesEliminados;
	}

	public void setConceptoDetallesEliminados(List<ConceptoDetalle> conceptodetallesEliminados) {
		this.conceptodetallesEliminados = conceptodetallesEliminados;
	}
	...
	//		JCheckBox jCheckBoxConGraficoDinamicoConceptoDetalle) {
	//	this.jCheckBoxConGraficoDinamicoConceptoDetalle = jCheckBoxConGraficoDinamico;
	//}	
	
	//public void setBorderResaltarConGraficoDinamico() {
	//	Border borderResaltar=Funciones2.getBorderResaltar(this.getParametroGeneralUsuario(),"PARAMETRO");
	//	this.jPanelToolBar.toolBar.setBorder(borderResaltar);
	//	this.jCheckBoxConGraficoDinamicoConceptoDetalle.setBorder(borderResaltar);		
	//}
	...
	*/
	...
	private void initialize(JDesktopPane jdesktopPane,Boolean conGuardarRelaciones,Boolean esGuardarRelacionado,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {
		...
		this.conceptodetalle_session.setConGuardarRelaciones(conGuardarRelaciones);
		this.conceptodetalle_session.setEsGuardarRelacionado(esGuardarRelacionado);
		
		
		this.conCargarMinimo=this.conceptodetalle_session.getEsGuardarRelacionado();				
		...
		//this.sTipoTamanioGeneral=ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL;
		//this.sTipoTamanioGeneralTabla=ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA;
		...
		ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL=this.sTipoTamanioGeneral;
		ConceptoDetalle_window.S_TIPO_TAMANIO_GENERAL_TABLA=this.sTipoTamanioGeneralTabla;
		ConceptoDetalle_window.CONTIPO_TAMANIO_MANUAL=this.conTipoTamanioManual;
		...
		//this.setTitle(Funciones.GetTituloSistema(this.parametroGeneralSg,this.moduloActual,this.opcionActual,this.usuarioActual,"Concepto Detalle MANTENIMIENTO"));
		...
		ConceptoDetalle_window.ESTA_CARGADO_PORPARTE=true;
	...
	public void inicializarElementosBusquedas() {
		...
		this.pnl_FK_IdConcepto=new JPanelMe("fondo_formulario",true);//new JPanel();
		this.pnl_FK_IdConcepto.setToolTipText("Buscar Por Concepto ");
		this.btn_FK_IdConcepto= new JButton();

		FuncionesSwing.addImagenButtonGeneral(this.btn_FK_IdConcepto,"buscar_button","Buscar","Buscar Por Concepto ");
		FuncionesSwing.setBoldButton(this.btn_FK_IdConcepto, S_TIPO_TAMANIO_GENERAL,false,true,this);;
		FuncionesSwing.setBoldComponent(this.btn_FK_IdConcepto, S_TIPO_TAMANIO_GENERAL,false,true,this);;
	
		lbl_id_conceptoFK_IdConcepto = new JLabel();
		FuncionesSwing.setLabelProp(lbl_id_conceptoFK_IdConcepto,"Concepto :","Concepto");
		FuncionesSwing.setLabelSize(lbl_id_conceptoFK_IdConcepto,Constantes.I_SWING_ANCHO_CONTROL_LABEL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL_LABEL,-35),Constantes2.I_SWING_ALTO_CONTROL_LABEL);

		FuncionesSwing.setBoldLabel(lbl_id_conceptoFK_IdConcepto,this.sTipoTamanioGeneral,false,true,this);


		FuncionesSwing.setBoldComponent(lbl_id_conceptoFK_IdConcepto,this.sTipoTamanioGeneral,false,true,this);

		cmb_id_conceptoFK_IdConcepto= new JComboBoxMe();
		FuncionesSwing.setComboBoxSize(cmb_id_conceptoFK_IdConcepto,Constantes.I_SWING_ANCHO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,0),Constantes.I_SWING_ALTO_CONTROL + FuncionesSwing.getValorProporcion(Constantes.I_SWING_ALTO_CONTROL,0));
		FuncionesSwing.setBoldComboBox(cmb_id_conceptoFK_IdConcepto,this.sTipoTamanioGeneral,false,true,this);
	...
	public JScrollPane getJContentPane(int iWidth,int iHeight,JDesktopPane jDesktopPane,Boolean cargarRelaciones,Usuario usuarioActual,ResumenUsuario resumenUsuarioActual,Modulo moduloActual,Opcion opcionActual,ParametroGeneralSg parametroGeneralSg,ParametroGeneralUsuario parametroGeneralUsuario,PaginaTipo paginaTipo) throws Exception {	
		...
		if(this.conCargarFormDetalle) { //true) {
			//this.jFrameDetalle = new ConceptoDetalleDetalle_window(paginaTipo);//JInternalFrameBase("Concepto Detalle DATOS");
			//_form
			...
			//_form
			this.jFrameDetalleForm = null;//new ConceptoDetalle_form_window("MINIMO");
		}
		...
		this.gridaBagLayout= new GridBagLayout();//ConceptoDetalle
		
		
		this.tableDatos = new JTable();      
		
		String sToolTipConceptoDetalle="";
		sToolTipConceptoDetalle=ConceptoDetalle_util.S_CLASS_WEB_TITULO;
		
		if(Constantes.IS_DEVELOPING) {
			sToolTipConceptoDetalle+="(General.ConceptoDetalle)";
		}
		
		if(!this.conceptodetalle_session.getEsGuardarRelacionado()) {
			sToolTipConceptoDetalle+="_"+this.opcionActual.getId();
		}
		
		this.tableDatos.setToolTipText(sToolTipConceptoDetalle);
		...
		this.sPath=" <---> Acceso: Concepto Detalle";
		
		if(!this.conceptodetalle_session.getEsGuardarRelacionado()) {
			this.jScrollPanelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos Concepto Detalles" + this.sPath));
		} else {
		...
		if(!this.conCargarMinimo) {
			...
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByConceptoDetalle,false,this);
			
			//this.cargarOrderBy(false);
		} else {
			//NO CARGAR INICIALMENTE, EN BOTON AL ABRIR
			//this.jFrameOrderBy=new OrderByJInternalFrame(S_TIPO_TAMANIO_GENERAL,this.jButtonAbrirOrderByConceptoDetalle,true,this);
		...
		*/
		...
		this.jPanelParametrosReportes = new JPanelParametrosReportes(this,"ConceptoDetalle",this.parametroGeneralUsuario.getid_tipo_fondo(),S_TIPO_TAMANIO_GENERAL,this.conCargarMinimo,false,false,false);//new JPanel();
		...
		this.jPanelPaginacion = new JPanelPaginacion(this,this.parametroGeneralUsuario.getid_tipo_fondo(),true,this.conCargarMinimo,this.conceptodetalle_session.getEsGuardarRelacionado(),S_TIPO_TAMANIO_GENERAL,"ConceptoDetalle",PaginaTipo.PRINCIPAL,false,this.conFuncionalidadRelaciones,false);
		this.jPanelToolBar = new JPanelToolBar(this.parametroGeneralUsuario.getid_tipo_fondo(),"ConceptoDetalle",PaginaTipo.PRINCIPAL,this);
		...
		//FuncionesSwing.addImagenButtonGeneral(this.jButtonRecargarInformacion,"recargar_button","Recargar","Recargar"+" "+ConceptoDetalle_util.S_CLASS_WEB_TITULO + FuncionesSwing.getKeyMensaje("RECARGAR"));		
		
		
		
		
		this.btn_ProcesarInformacion = new JButton();
		FuncionesSwing.setButtonProp(this.btn_ProcesarInformacion,"Procesar","Procesar"+" "+ConceptoDetalle_util.S_CLASS_WEB_TITULO,false);
		...
		*/
		...
		//ESTA EN BEAN
		/*
		this.jTabbedPaneRelaciones.setMinimumSize(new Dimension(this.getWidth(),ConceptoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setMaximumSize(new Dimension(this.getWidth(),ConceptoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		this.jTabbedPaneRelaciones.setPreferredSize(new Dimension(this.getWidth(),ConceptoDetalleBean.ALTO_TABPANE_RELACIONES  + FuncionesSwing.getValorProporcion(ConceptoDetalleBean.ALTO_TABPANE_RELACIONES,0)));
		*/
		...
		/*
			GridBagLayout gridaBagLayoutDatosConceptoDetalle = new GridBagLayout();

			this.jScrollPanelDatos.setLayout(gridaBagLayoutDatosConceptoDetalle);
		...
		*/
		...
		this.jPanelAcciones.add(this.jButtonNuevoConceptoDetalle, this.gridBagConstraints);
		*/
		int iPosXAccion=0;
		...
		GridBagLayout gridaBagLayoutFK_IdConceptoConceptoDetalle= new GridBagLayout();
		gridaBagLayoutFK_IdConceptoConceptoDetalle.rowHeights = new int[] {1};
		gridaBagLayoutFK_IdConceptoConceptoDetalle.columnWidths = new int[] {1};
		gridaBagLayoutFK_IdConceptoConceptoDetalle.rowWeights = new double[]{0.0, 0.0, 0.0};
		gridaBagLayoutFK_IdConceptoConceptoDetalle.columnWeights = new double[]{0.0, 1.0};
		pnl_FK_IdConcepto.setLayout(gridaBagLayoutFK_IdConceptoConceptoDetalle);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,0,0);
		pnl_FK_IdConcepto.add(lbl_id_conceptoFK_IdConcepto, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,0);
		pnl_FK_IdConcepto.add(cmb_id_conceptoFK_IdConcepto, gridBagConstraints);

		gridBagConstraints = new GridBagConstraints();
		GridXy.SetGridBagProp(gridBagConstraints,GridBagConstraints.WEST,GridBagConstraints.VERTICAL,1,1);
		pnl_FK_IdConcepto.add(btn_FK_IdConcepto, gridBagConstraints);

		jTabbedPaneBusquedas.addTab("1.-Por Concepto ", pnl_FK_IdConcepto);
...
if(this.parametroGeneralUsuario.getcon_botones_tool_bar() && !this.conceptodetalle_session.getEsGuardarRelacionado()) {			
		...
		*/		
		...
		if(ConceptoDetalle_window.CON_DATOS_FRAME) {				
	...
	public void redimensionarTablaDatos(int iNumFilas,int iTamanioFilaTabla) {
		...
		if(this.conMaximoRelaciones 
			&& this.conceptodetalle_session.getConGuardarRelaciones()
			) {
		}
		...
		*/
		...
		if(iTamanioFilaTabla<=0) {
			iTamanioFilaTabla=this.tableDatos.getRowHeight();//ConceptoDetalle_util.ITAMANIOFILATABLA;
		}
		...
		if(!this.conceptodetalle_session.getEsGuardarRelacionado()) {			
			if(iHeightTable > ConceptoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=ConceptoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < ConceptoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=ConceptoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
			
		} else {
			if(iHeightTable > ConceptoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL) { //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS) {
				//SI SE SELECCIONA MAXIMO TABLA SE AMPLIA A ALTO MAXIMO DE SCROLL, PARA QUE SCROLL NO SEA TAN PEQUE?O
				
				if(!this.jPanelParametrosReportes.chb_ConAltoMaximoTabla.isSelected()) {
					iHeightTable=ConceptoDetalle_util.TAMANIO_ALTO_MAXIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMAXIMO_TABLADATOS;
				} else {
				
					iHeightTable=iHeightTableTotal + FuncionesSwing.getValorProporcion(iHeightTableTotal,30);
				}
			} else {
				if(iHeightTable < ConceptoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL) {//Constantes.ISWING_TAMANIOMINIMO_TABLADATOS) {
					iHeightTable=ConceptoDetalle_util.TAMANIO_ALTO_MINIMO_TABLA_DATOS_REL; //Constantes.ISWING_TAMANIOMINIMO_TABLADATOS;
				}
			}
		}
	...
	//PARA REPORTES
	public static List<ConceptoDetalle> TraerBeans(List<ConceptoDetalle> conceptodetalles,ArrayList<Classe> classes)throws Exception {
		try {
			for(ConceptoDetalle conceptodetalle:conceptodetalles) {
					
				if(!(ConceptoDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_GENERICO)
						  || ConceptoDetalle_util.S_TIPO_REPORTE_EXTRA.equals(Constantes2.S_REPORTE_EXTRA_GROUP_TOTALES_GENERICO)) 
				   ) {
					
					conceptodetalle.setsDetalleGeneralEntityReporte(ConceptoDetalle_util.getConceptoDetalleDescripcion(conceptodetalle));
					...
					//conceptodetalle.setsDetalleGeneralEntityReporte(conceptodetalle.getsDetalleGeneralEntityReporte());
										
				}
				
				//conceptodetallebeans.add(conceptodetallebean);
			}
		} catch(Exception ex) {
			throw ex;
		}
	...
	/*
		public interface ConceptoDetalle_windowI {	
