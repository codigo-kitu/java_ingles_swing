...
*/
package com.bydan.ingles.general.concepto.presentation.web.jsf.sessionbean;
...
public class Concepto_session  extends GeneralEntitySessionBean {
	...
	public Concepto_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Concepto:Valor nulo no permitido en columna id");
					}
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Concepto:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>20) {
					newcodigo=newcodigo.substring(0,18);
					System.out.println("Concepto:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna codigo");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Concepto:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>50) {
					newnombre=newnombre.substring(0,48);
					System.out.println("Concepto:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre");
				}
