...
*/
package com.bydan.ingles.general.subarea.presentation.web.jsf.sessionbean;
...
public class SubArea_session  extends GeneralEntitySessionBean {
	...
	public SubArea_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("SubArea:Valor nulo no permitido en columna id");
					}
				}
