...
*/
package com.bydan.ingles.general.nivel.presentation.web.jsf.sessionbean;
...
public class Nivel_session  extends GeneralEntitySessionBean {
	...
	public Nivel_session () throws Exception {
			...
			if(this.id!=newid) {
				if(newid==null) {
					...
					if(Constantes.IS_DEVELOPING) {
						System.out.println("Nivel:Valor nulo no permitido en columna id");
					}
				}
