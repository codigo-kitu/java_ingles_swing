...
public class Funciones {
	...
	public static void enviarMails(String strHtmlSubject,String strHtmlBody,ArrayList<ArchivoMailAttachment> arrayListArchivoMailAttachments,String strMailEnvio,String strUsuarioMailEnvio,ArrayList<String> arrMailsDestinatarios)throws Exception { // 		
		/*
	...
	private static void enviarMailsException(String strMailEnvio,String strUsuarioMailEnvio,Exception exception,ArrayList<String> arrMailsDestinatarios)throws Exception { //MessagingException
		Properties properties= new Properties();
		/*
		properties.put("mail.host", Constantes.SMAILIP);
		properties.put("mail.user", strUsuarioMailEnvio);
	...
	public static void manageException(Logger logger,Exception e) throws Exception { // org.apache.log4j.
		try {
	...
	public static void manageException(Logger logger,StringBuilder stringBuilder,String sPath,String sAmbito,String sNombreProceso) throws Exception { // org.apache.log4j.
		try {
	...
	public static void logShowExceptionMessages(Logger logger,Exception e) throws Exception { //org.apache.log4j.
		try {
			logger.info("Exception:" + e.getMessage());//error
