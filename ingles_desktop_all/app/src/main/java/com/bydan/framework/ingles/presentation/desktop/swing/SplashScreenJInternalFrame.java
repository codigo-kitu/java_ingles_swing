...
public class SplashScreenJInternalFrame extends JInternalFrame {
  /**
	 * 
	 */
  ...
  public void initializeJProgressBar(Boolean isIndeterminate){
		this.progress_Bar = new JProgressBar(0, SplashScreenJInternalFrame.MAX);
  ...
  public void paintComponent(Graphics g) {
	...
	public void setImageIcon(ImageIcon img_Icon) {
		this.img_Icon = img_Icon;
	}
