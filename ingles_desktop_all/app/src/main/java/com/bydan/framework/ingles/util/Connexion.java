...
//import com.bydan.framework.ingles.ConstantesCommon;
...
public class Connexion {
	...
	private /*EntityManagerFactory*/ Object entityManagerFactory;
	
	private java.sql.Connection connection;

	//@PersistenceContext//(type=PersistenceContextType.EXTENDED)
    /*EntityManager*/ Object entityManager;
    
    private double dStart = 0; 
    private double dEnd = 0; 
    private double dDif = 0; 
	
	public /*EntityManager*/ Object getEntityManager() {
		return entityManager;
	}

	public void setEntityManager(/*EntityManager*/ Object entityManager) {
	...
	public Connexion(String newDriver,ConnexionType newConnexionType,ParameterDbType newDbType,String sDetalle) throws SQLException,Exception {
		 ...
		 try {	 
			 ...
			 if(!Constantes.ISUSACONNECTIONFROMDATASOURCESSERVER) {
				 ...
				 //org.sqlite.Driver driverSqlite=null;				 
				 ...
				 } else  if(this.dbType.equals(ParameterDbType.SQLITE)) {
					 Class.forName("org.sqlite.JDBC");
					 //driverSqlite= new org.sqlite.Driver();
				 ...
				 */
				 ...
				 if(!this.dbType.equals(ParameterDbType.SQLITE)) {
	...
	public Connexion getNewConnexion(ConnexionType connexionType,ParameterDbType parameterDbType,/*EntityManagerFactory*/ Object entityManagerFactory)throws Exception	{
		return getNewConnexion(connexionType,parameterDbType,entityManagerFactory,"");
	}
	
	public Connexion getNewConnexion(ConnexionType connexionType,ParameterDbType parameterDbType,/*EntityManagerFactory*/ Object entityManagerFactory,String sDetalle)throws Exception 
	{
		Connexion connexion= new Connexion();
	...
	public String getDriverJdbcString(ParameterDbType parameterDbType)throws SQLException,Exception	{
		...
		if(parameterDbType.equals(ParameterDbType.MYSQL)) {
			...
			strDriverJdbc32MySql="jdbc:sqlite://"+Constantes.SCONNEXION_SQLITE;
		}
		
		return strDriverJdbc32MySql;
	}
	
	public  Connexion getNewConnexionHibernate(/*EntityManagerFactory*/ Object entityManagerFactory)throws SQLException,Exception {
		Connexion connexion= new Connexion();
