...
public class GeneralEntityReturnGeneral extends GeneralEntityParameterGeneral implements Serializable {
	...
	protected Boolean conAbrirVentanaAuxiliar=false;
	protected Boolean esValidado=false;
	protected Boolean esError=false;
	
	protected Boolean conReturnJson=false;
	...
	public Boolean getConAbrirVentanaAuxiliar() {
		return conAbrirVentanaAuxiliar;
	}

	public void setConAbrirVentanaAuxiliar(Boolean conAbrirVentanaAuxiliar) {
