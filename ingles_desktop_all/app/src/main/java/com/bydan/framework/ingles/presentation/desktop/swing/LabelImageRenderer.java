...
public class LabelImageRenderer extends DefaultTableCellRenderer implements TableCellRenderer{	
	...
	*/
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		this.setOpaque(true);
	    this.setBackground(row % 2 == 0 ? FuncionesSwing.getColorTextFields(Constantes2.S_FONDO_CONTROL_COLOR) : Funciones2.getColorFilaTabla2()); //Funciones2.getColorFilaTabla1()
	    ...
	    */
	    ...
	    if(value!=null) {
	    	this.setMinimumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL_LABEL*3,Constantes2.I_SWING_ALTO_CONTROL_LABEL*5));
        	this.setMaximumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL_LABEL*3,Constantes2.I_SWING_ALTO_CONTROL_LABEL*5));
        	this.setPreferredSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL_LABEL*3,Constantes2.I_SWING_ALTO_CONTROL_LABEL*5));
