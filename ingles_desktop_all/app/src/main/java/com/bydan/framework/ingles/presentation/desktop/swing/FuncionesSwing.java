...
//import com.bydan.ingles.seguridad.util.AnioConstantesFunciones;
...
import com.bydan.framework.ingles.util.FuncionesNetwork;
...
public class FuncionesSwing {
	public static void manageNormalError(Object container,String sMensaje,Logger logger) throws Exception {		
		try {
			//e.printStackTrace();
			logger.info("Exception:" + sMensaje);//error
	...
	public static void manageNormalInfo(Object container,String sMensaje,Logger logger) throws Exception {		
		try {
			...
			JOptionPane.showMessageDialog((Container)container,sMensaje,Constantes.S_ERROR,JOptionPane.INFORMATION_MESSAGE);
	...
	public static void manageNormalAdvertencia(Object container,String sMensaje,Logger logger) throws Exception {		
		try {
			//e.printStackTrace();
			//logger.error("Exception:" + sMensaje);
			
			JOptionPane.showMessageDialog((Container)container,sMensaje,Constantes.S_ERROR,JOptionPane.WARNING_MESSAGE);
	...
	public static void manageException(Object container,Exception e,Logger logger) throws Exception {		
		try {
			e.printStackTrace();
			logger.info("Exception:" + e.getMessage());//error
			
			JOptionPane.showMessageDialog((Container)container,e.getMessage(),Constantes.S_ERROR,JOptionPane.ERROR_MESSAGE);
	...
	public static void manageException(Container container,Exception e) {
		e.printStackTrace();
		JOptionPane.showMessageDialog(container,e.getMessage(),Constantes.S_ERROR,JOptionPane.ERROR_MESSAGE);		
	}	
	...
	*/
	...
	public static JButton getButtonToolBarGeneral(JButton jbutton,JToolBar jToolBar,String sNombreImagen,String sActionCommand,String sToolTip,String sAltText) {
		return FuncionesSwing.getButtonToolBarGeneral(jbutton,jToolBar,sNombreImagen,sActionCommand,sToolTip,sAltText,false,null);
	}
	
	public static JButton getButtonToolBarGeneral(JButton jbutton,JToolBar jToolBar,String sNombreImagen,String sActionCommand,String sToolTip,String sAltText,Boolean paraForzarUbicarSwingDesarrollo,JInternalFrameBase jInternalFrameBase) {
		if(!paraForzarUbicarSwingDesarrollo) {
	        ...
	        if (urlImagen != null) {        
	        	...
	        	//ESTA DA EL TAMANO DEL BOTON, NO EL putClientProperty
	        	Image image = imageIcon.getImage().getScaledInstance(iSizeIcon, iSizeIcon, Image.SCALE_SMOOTH);
	...
	public static void addImagenButtonGeneral(JButton jbutton,String sNombreImagen,String sAltText,String sToolTipText) {
		FuncionesSwing.addImagenButtonGeneral(jbutton,sNombreImagen,sAltText,sToolTipText,false);
	}
	
	public static void addImagenButtonGeneral(JButton jbutton,String sNombreImagen,String sAltText,Boolean esRelacionado) {
		FuncionesSwing.addImagenButtonGeneral(jbutton,sNombreImagen,sAltText,"",esRelacionado);
	}
	
	public static void addImagenButtonGeneral(JButton jbutton,String sNombreImagen,String sAltText,String sToolTipText,Boolean esRelacionado) {
		String sImagenLocation = sNombreImagen + ".gif";
	...
	public static void addImagenMenuItemGeneral(JMenuItem jMenuItem,String sNombreImagen,String sAltText) {
        ...
        //ACTION COMMAND
        jMenuItem.setActionCommand(sAltText);
	}
	...
	public static void setBoldLabel(JLabel jLabel,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {
		...
		if(jInternalFrameBase!=null && !jInternalFrameBase.getConTipoTamanioManual()) {
			...
			*/
			...
			/*
			if(!paraTabla) {
				FuncionesSwing.setBoldComponent(jLabel, sTipoFuente, paraTabla, paraVentanaPrincipal, jInternalFrameBase);
			}		
			*/
		}
	}
	...
	public static void setBoldList(JList jList,String sTipo) {	
		FuncionesSwing.setBoldList(jList,sTipo,false,false,null);
	}
	
	@SuppressWarnings("rawtypes")
	public static void setBoldList(JList jLabel,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {
	...
	public static void setBoldScroll(JScrollPane jList,String sTipo) {	
		FuncionesSwing.setBoldScroll(jList,sTipo,false,false,null);
	}
	
	public static void setBoldScroll(JScrollPane jLabel,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {
	...
	public static void setBoldComponent(JComponent jComponent,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {		
		Font fontLabel = jComponent.getFont();     
		
        Font fontBold = new Font(fontLabel.getFontName(), Font.BOLD, fontLabel.getSize());
        
        jComponent.setFont(fontBold);
	}
	...
	public static void setBoldCheckBox(JCheckBox jCheckBox,String sTipo,String sText,String sToolTip) {		
		FuncionesSwing.setBoldCheckBox(jCheckBox,sTipo,false,false,null,sText,sToolTip);
	}
	...
	public static void setBoldCheckBox(JCheckBox jCheckBox,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {		
		FuncionesSwing.setBoldCheckBox(jCheckBox,sTipo,paraTabla,paraVentanaPrincipal,jInternalFrameBase,"","");
	}
	
	public static void setBoldCheckBox(JCheckBox jCheckBox,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase,String sText,String sToolTip) {
		
		if(sText!=""){
			jCheckBox.setText(sText);
		}
		
		if(sToolTip!=""){
			jCheckBox.setToolTipText(sToolTip);				
		}
	...
	public static void setBoldButtonToolBar(JButton jButton,String sTipo,Boolean paraTabla,Boolean paraVentanaPrincipal,JInternalFrameBase jInternalFrameBase) {
		...
		if(jInternalFrameBase!=null && !jInternalFrameBase.getConTipoTamanioManual()) {
			...
			if(sTipo.equals("NORMAL")) {
				...
				//A LA FINAL NO FUNCIONA, SINO EL TAMANO DE LA IMAGEN COMO TAL
				//jButton.putClientProperty("JComponent.sizeVariant", "small");
				jButton.putClientProperty("JComponent.sizeVariant", "regular");
		...
		*/
		...
		if(jInternalFrameBase!=null && !jInternalFrameBase.getConTipoTamanioManual()) {
			...
			if(sTipo.equals("NORMAL")) {
				...
				//QUEDA MUY PEQUENO CON small
				
				if(ConstantesSwing.CON_UI_TAMANIO_REAL) {
				//if(true) {
					jMenuBar.putClientProperty("JComponent.sizeVariant", "small");
				} else {
					jMenuBar.putClientProperty("JComponent.sizeVariant", "regular");
	...
	public static void addDateListener(JDateChooser jDateChooser,JInternalFrameBase jInternalFrameBase,String sNombreCampo,Boolean esControlTabla){
		Component[] components=jDateChooser.getComponents();
		
		JTextFieldDateEditor jTextFieldDateEditor=(JTextFieldDateEditor)components[1];
		
		jTextFieldDateEditor.addFocusListener(new FormattedTextFieldFocusListener(jInternalFrameBase,sNombreCampo,esControlTabla));
		
		jTextFieldDateEditor.addActionListener (new FormattedTextFieldActionListener(jInternalFrameBase,sNombreCampo,esControlTabla));
	...
	public static String getTipoFuenteDesdeParametroUsuario(String sTipoFuenteDefecto,ParametroGeneralUsuario parametroGeneralUsuario) {
		String sTipoFuente=sTipoFuenteDefecto;
		Integer iTipoFuente=1;//parametroGeneralUsuario.getid_tipo_fuente().intValue();
	...
	public static void cargarLicenciaCliente(DatosCliente datosCliente,JInternalFrameBase jInternalFrameBase) throws Exception {
		Boolean existe=false;
			
		try {
				InputStream reportFile=null;
				
				String sPath=jInternalFrameBase.parametroGeneralUsuario.getpath_exportar()+"erp_bydan/license/license.xml";
				
				reportFile = new FileInputStream(sPath);
				
				Document documentBuilder=null;
				
				if(jInternalFrameBase.constantes2.DOCUMENT_BUILDER==null) {
					documentBuilder=Funciones2.parseXml(reportFile);
				} else {
					documentBuilder=jInternalFrameBase.constantes2.DOCUMENT_BUILDER;
				}
	...
	public static void cargarDatosCliente(JInternalFrameBase jInternalFrameBase) throws Exception {
		...
		jInternalFrameBase.datosCliente=new DatosCliente();
		if(jInternalFrameBase.lIdUsuarioSesion!=null){jInternalFrameBase.datosCliente.setIdUsuario(jInternalFrameBase.lIdUsuarioSesion);}
		
		//SERVIDOR WEB Y TALVEZ SERVIDOR SWING WINDOWS
		jInternalFrameBase.datosCliente.setsUsuarioPCServer(sHostUser);
		jInternalFrameBase.datosCliente.setsNamePCServer(sHostName);
		jInternalFrameBase.datosCliente.setsIPPCServer(sHostIp);
		jInternalFrameBase.datosCliente.setsMacAddressPCServer(sPrimerMacAddress);
			...
			*/
			...
			jInternalFrameBase.datosCliente.setIsClienteWeb(false);
			
			jInternalFrameBase.datosCliente.setsUsuarioPC(sHostUser);
			jInternalFrameBase.datosCliente.setsNamePC(sHostName);
			jInternalFrameBase.datosCliente.setsIPPC(sHostIp);
			jInternalFrameBase.datosCliente.setsMacAddressPC(sPrimerMacAddress);	
			
			
			//jInternalFrameBase.cargarLicenciaCliente(this.datosCliente);
			
	}
	
	//REDUCE FUNCTIONS
	public static void setPanelProp(JPanel jPanel,String sBorder,String sToolTip,String sName) {
		jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(sBorder));
		jPanel.setToolTipText(sToolTip);
		jPanel.setName(sName); 
	}
	
	public static void setTableProp(JTable jTable,Boolean isRowSorter,Integer iRowHeight,Boolean isSelectionAllowed,int iSelectionMode) {
		jTable.setAutoCreateRowSorter(isRowSorter);
		jTable.setRowHeight(iRowHeight);				
		
		//MULTIPLE SELECTION
		jTable.setRowSelectionAllowed(isSelectionAllowed);
		jTable.setSelectionMode(iSelectionMode);
	}
	
	public static void setButtonProp(JButton jButton,String sText,String sToolTip,Boolean isVisible) {
		jButton.setText(sText);
		jButton.setToolTipText(sToolTip);
		jButton.setVisible(isVisible);
	}
	
	public static void setButtonProp(JButton jButton,String sText,String sToolTip) {
		jButton.setText(sText);
		jButton.setToolTipText(sToolTip);		
	}
	
	public static void setLabelProp(JLabel jLabel,String sText,String sToolTip) {
		jLabel.setText(sText);
		jLabel.setToolTipText(sToolTip);		 
	}
	
	public static void setCheckBoxProp(JCheckBox jCheckBox,String sText,String sToolTip) {
		jCheckBox.setText(sText);
		jCheckBox.setToolTipText(sToolTip);		 
	}
	
	public static void setTableColumnProp(TableColumn tableColumn,int iWidth) {
		tableColumn.setPreferredWidth(iWidth); 	 
		tableColumn.setWidth(iWidth); 	 
		tableColumn.setMinWidth(iWidth);
		tableColumn.setMaxWidth(iWidth); 
	}
	
	public static void setTableColumnProp(TableColumn tableColumn,String sIdentifier,String sHeaderValue) {
		tableColumn.setIdentifier(sIdentifier);
		tableColumn.setHeaderValue(sHeaderValue);
	}
	
	public static void setButtonSize(JButton jButton,int w,int h) {
		jButton.setMinimumSize(new Dimension(w,h));
		jButton.setMaximumSize(new Dimension(w,h));
		jButton.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setTextFieldSize(JTextField t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setTextAreaSize(JTextArea t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setLabelSize(JLabel t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setCheckBoxSize(JCheckBox t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setComboBoxSize(JComboBox<?> t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setTableSize(JTable t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setScrollPaneSize(JScrollPane t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	
	public static void setTabbedPaneSize(JTabbedPane t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}	
	
	public static void setComponentSize(JComponent t,int w,int h) {
		t.setMinimumSize(new Dimension(w,h));
		t.setMaximumSize(new Dimension(w,h));
		t.setPreferredSize(new Dimension(w,h));	
	}
	//REDUCE FUNCTIONS-FIN
}
