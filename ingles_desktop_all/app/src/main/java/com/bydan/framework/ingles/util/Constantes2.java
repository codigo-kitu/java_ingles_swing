...
public class Constantes2 
{
	...
	public  static Long L_DEFAULT_COMBO=-99L;
	...
	public static Boolean IS_DEVELOPING_MIGRATION=false;
		//public static Boolean ISDEVELOPING_MIGRATION=false;
	public static Boolean IS_DEVELOPING_VALIDACION_DATOS_TRAER=false;
	...
	final public static Integer I_SWING_ANCHO_CONTROL_LABEL2=200;
	final public static Integer I_SWING_ANCHO_CONTROL_BOTON_ICONO=30;
	
	final public static Integer I_SWING_ALTO_CONTROL_LABEL=22;
	final public static Integer I_SWING_ALTO_CONTROL_LABEL2=27;
	final public static Integer I_SWING_ALTO_CONTROL_BOTON_ICONO=25;
	
	final public static Integer I_SWING_TAMANIO_ANCHO_TABLADATOS_TOTAL=300;
	final public static Integer I_SWING_TAMANIO_ALTO_TABLADATOS_TOTAL=150;
	
	final public static Integer I_SWING_TAMANIO_ANCHO_TABLADATOS_ORDERBY=250;
	final public static Integer I_SWING_TAMANIO_ALTO_TABLADATOS_ORDERBY=330;//250;300
	...
	public  static String S_FONDO_BORDE_IMAGE="fondo_cabecera";
	
	public  static String S_FONDO_CONTROL_COLOR="azul";
