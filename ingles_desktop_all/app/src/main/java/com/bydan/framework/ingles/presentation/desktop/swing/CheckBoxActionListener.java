...
public class CheckBoxActionListener implements ActionListener {
	...
	public CheckBoxActionListener(JInternalFrameBase jInternalFrameBase,String sTipo,Boolean esControlTabla) {
		this.jInternalFrameBase=jInternalFrameBase;
		this.sTipo=sTipo;
	...
	public void actionPerformed(ActionEvent evt) {
		try {
			...
			this.jInternalFrameBase.jCheckBoxActionPerformedGeneral(this.sTipo,evt,this.esControlTabla);
		} catch (Exception e1) { 
			e1.printStackTrace();
		}
	}
