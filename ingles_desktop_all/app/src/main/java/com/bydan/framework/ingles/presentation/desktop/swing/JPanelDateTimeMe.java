...
public class JPanelDateTimeMe extends JPanel{
	...
	*/
	...
	public void inicializar() {
		this.setMinimumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL*2,85),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.setMaximumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL*2,85),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.setPreferredSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL*2,85),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		
		/*
		this.setMinimumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL*2,Constantes.I_SWING_ALTO_CONTROL*2));
		this.setMaximumSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL*2,Constantes.I_SWING_ALTO_CONTROL*2));
		this.setPreferredSize(new Dimension(Constantes.I_SWING_ANCHO_CONTROL*2,Constantes.I_SWING_ALTO_CONTROL*2));
		*/
		
		//FECHA
		this.jDateChooserFecha= new JDateChooser();
		
		this.jDateChooserFecha.setMinimumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.jDateChooserFecha.setMaximumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.jDateChooserFecha.setPreferredSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		...
		this.jSpinnerHora.setMinimumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.jSpinnerHora.setMaximumSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
		this.jSpinnerHora.setPreferredSize(new Dimension(FuncionesSwing.getValorProporcion(Constantes.I_SWING_ANCHO_CONTROL,80),Constantes.I_SWING_ALTO_CONTROL+ Constantes.I_SWING_ALTO_FILA_TABLA_EXTRA_FECHA));
