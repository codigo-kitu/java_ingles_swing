...
public class BooleanRenderer extends DefaultTableCellRenderer implements TableCellRenderer{	
	...
	public BooleanRenderer(Border borderResaltar,Boolean conEnabled,Integer iTotalRow,JInternalFrameBase jInternalFrameBase) {
		this.borderResaltar=borderResaltar;
		this.jcheckBox = new JCheckBox();
		this.sLabel="";
		this.sToolTip="";
	...
	public BooleanRenderer(Border borderResaltar,Boolean conEnabled,JInternalFrameBase jInternalFrameBase) {
		this.borderResaltar=borderResaltar;
		this.jcheckBox = new JCheckBox();
		this.sLabel="";
		this.sToolTip="";
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
	    ...
	    if((this.jInternalFrameBase.conTotales && row != table.getRowCount()-1) || !this.jInternalFrameBase.conTotales) {
	    	this.jcheckBox.setBackground(row % 2 == 0 ? FuncionesSwing.getColorTextFields(Constantes2.S_FONDO_CONTROL_COLOR)  : Funciones2.getColorFilaTabla2());//Funciones2.getColorFilaTabla1()
	    } else {
	    ...
	    if(this.jInternalFrameBase!=null) {
	    	//if(this.jInternalFrameBase.getConTipoTamanioTodo()) {
	    		FuncionesSwing.setBoldCheckBox(this.jcheckBox, this.jInternalFrameBase.sTipoTamanioGeneralTabla,true,false,this.jInternalFrameBase);
	    		FuncionesSwing.setBoldComponent(this.jcheckBox, this.jInternalFrameBase.sTipoTamanioGeneralTabla,true,false,this.jInternalFrameBase);
	    	//}
	    }
